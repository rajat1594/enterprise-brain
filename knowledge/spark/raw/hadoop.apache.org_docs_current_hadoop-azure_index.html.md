...
[ ![Built by Maven](https://hadoop.apache.org/docs/current/hadoop-azure/images/logos/maven-feather.png) ](http://maven.apache.org/ "Built by Maven")
# Hadoop Azure Support: ABFS - Azure Data Lake Storage Gen2
  * [ Introduction](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Introduction)
  * [ Features of the ABFS connector.](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Features_of_the_ABFS_connector.)
  * [Getting started](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Getting_started)
    * [Concepts](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Concepts)
  * [ Hierarchical Namespaces (and WASB Compatibility)](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Hierarchical_Namespaces_.28and_WASB_Compatibility.29)
  * [ Non-Hierarchical Namespaces](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Non-Hierarchical_Namespaces)
    * [ Creating an Azure Storage Account](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Creating_an_Azure_Storage_Account)
      * [Creation through the Azure Portal](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Creation_through_the_Azure_Portal)
    * [ Creating a new container](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Creating_a_new_container)
    * [Listing and examining containers of a Storage Account.](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Listing_and_examining_containers_of_a_Storage_Account.)
  * [ Configuring ABFS](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Configuring_ABFS)
  * [ Authentication](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Authentication)
    * [ AAD Token fetch retries](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#AAD_Token_fetch_retries)
    * [ Default: Shared Key](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Default:_Shared_Key)
    * [ OAuth 2.0 Authentication](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#OAuth_2.0_Authentication)
      * [ Client Credentials](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Client_Credentials)
      * [ Username and Password](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Username_and_Password)
      * [ Refresh Token](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Refresh_Token)
      * [ Azure Managed Identity](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Azure_Managed_Identity)
      * [ Azure Workload Identity](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Azure_Workload_Identity)
    * [Custom OAuth 2.0 Token Provider](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Custom_OAuth_2.0_Token_Provider)
    * [ Delegation Token Provider](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Delegation_Token_Provider)
    * [Shared Access Signature (SAS) Token Provider](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Shared_Access_Signature_.28SAS.29_Token_Provider)
      * [Known Issues With SAS](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Known_Issues_With_SAS)
      * [Using User Delegation SAS with ABFS](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Using_User_Delegation_SAS_with_ABFS)
      * [Using Account/Service SAS with ABFS](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Using_Account.2FService_SAS_with_ABFS)
    * [User-bound SAS](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#User-bound_SAS)
  * [ Technical notes](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Technical_notes)
    * [ Proxy setup](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Proxy_setup)
    * [ Security](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Security)
    * [ Limitations of the ABFS connector](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Limitations_of_the_ABFS_connector)
    * [ Consistency and Concurrency](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Consistency_and_Concurrency)
    * [ Performance and Scalability](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Performance_and_Scalability)
    * [ Extensibility](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Extensibility)
    * [Networking Layer:](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Networking_Layer:)
      * [ApacheHttpClient networking layer configuration Options:](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#ApacheHttpClient_networking_layer_configuration_Options:)
      * [ ApacheHttpClient classpath requirements:](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#ApacheHttpClient_classpath_requirements:)
  * [ Other configuration options](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Other_configuration_options)
    * [ Client Correlation Options](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Client_Correlation_Options)
      * [ 1. Client CorrelationId Option](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#a1._Client_CorrelationId_Option)
      * [ 1. Correlation IDs Display Options](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#a1._Correlation_IDs_Display_Options)
    * [ Flush Options](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Flush_Options)
      * [ 1. Azure Blob File System Flush Options](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#a1._Azure_Blob_File_System_Flush_Options)
      * [ 2. OutputStream Flush Options](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#a2._OutputStream_Flush_Options)
    * [ Hundred Continue Options](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Hundred_Continue_Options)
    * [ Account level throttling Options](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Account_level_throttling_Options)
    * [ HNS Check Options](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#HNS_Check_Options)
    * [ Access Options](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Access_Options)
    * [ Operation Idempotency](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Operation_Idempotency)
    * [ Primary User Group Options](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Primary_User_Group_Options)
    * [ IO Options](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#IO_Options)
    * [ Security Options](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Security_Options)
    * [ Encryption Options](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Encryption_Options)
      * [ Customer-Provided Global Key](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Customer-Provided_Global_Key)
      * [ Encryption Context Provider](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Encryption_Context_Provider)
    * [ Server Options](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Server_Options)
    * [ Throttling Options](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Throttling_Options)
    * [ Rename Options](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Rename_Options)
    * [ Infinite Lease Options](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Infinite_Lease_Options)
    * [ Perf Options](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Perf_Options)
      * [ 1. HTTP Request Tracking Options](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#a1._HTTP_Request_Tracking_Options)
    * [ Driver Metric Options](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Driver_Metric_Options)
  * [ Troubleshooting](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Troubleshooting)
    * [ClassNotFoundException: org.apache.hadoop.fs.azurebfs.AzureBlobFileSystem](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#ClassNotFoundException:_org.apache.hadoop.fs.azurebfs.AzureBlobFileSystem)
    * [ClassNotFoundException: com.microsoft.azure.storage.StorageErrorCode](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#ClassNotFoundException:_com.microsoft.azure.storage.StorageErrorCode)
    * [Server failed to authenticate the request](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Server_failed_to_authenticate_the_request)
    * [Configuration property _something_.dfs.core.windows.net not found](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Configuration_property__something_.dfs.core.windows.net_not_found)
    * [No such file or directory when trying to list a container](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#No_such_file_or_directory_when_trying_to_list_a_container)
    * [“HTTP connection to https://login.microsoftonline.com/something failed for getting token from AzureAD. Http response: 200 OK”](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#a.E2.80.9CHTTP_connection_to_https:.2F.2Flogin.microsoftonline.com.2Fsomething_failed_for_getting_token_from_AzureAD._Http_response:_200_OK.E2.80.9D)
    * [java.io.IOException: The ownership on the staging directory /tmp/hadoop-yarn/staging/user1/.staging is not as expected. It is owned by <principal_id>. The directory must be owned by the submitter user1 or user1](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#java.io.IOException:_The_ownership_on_the_staging_directory_.2Ftmp.2Fhadoop-yarn.2Fstaging.2Fuser1.2F.staging_is_not_as_expected._It_is_owned_by_.3Cprincipal_id.3E._The_directory_must_be_owned_by_the_submitter_user1_or_user1)
  * [ Known Issues](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Known_Issues)
  * [ Testing ABFS](https://hadoop.apache.org/docs/current/hadoop-azure/index.html#Testing_ABFS)


##  Introduction
The `hadoop-azure` module provides support for the Azure Data Lake Storage Gen2 storage layer through the “abfs” connector
To make it part of Apache Hadoop’s default classpath, make sure that `HADOOP_OPTIONAL_TOOLS` environment variable has `hadoop-azure` in the list, _on every machine in the cluster_
...
See also: * [ABFS Driver for FNS (non-HNS) Accounts](https://hadoop.apache.org/docs/current/hadoop-azure/fns_blob.html) * [Deprecated WASB Driver for FNS (non-HNS) Accounts](https://hadoop.apache.org/docs/current/hadoop-azure/wasb.html) * [Testing of ABFS Driver](https://hadoop.apache.org/docs/current/hadoop-azure/testing_azure.html) * [WASB Migration Config Support](https://hadoop.apache.org/docs/current/hadoop-azure/wasbToAbfsMigration.html)
##  Features of the ABFS connector.
  * Supports reading and writing data stored in an Azure Blob Storage account.
  * _Fully Consistent_ view of the storage across all clients.
  * Can read data written through the `deprecated wasb:` connector.
  * Presents a hierarchical file system view by implementing the standard Hadoop [`FileSystem`](https://hadoop.apache.org/docs/current/api/org/apache/hadoop/fs/FileSystem.html) interface.
...
For details on ABFS, consult the following documents:
  * [A closer look at Azure Data Lake Storage Gen2](https://azure.microsoft.com/en-gb/blog/a-closer-look-at-azure-data-lake-storage-gen2/); MSDN Article from June 28, 2018.
...
A key aspect of ADLS Gen 2 is its support for [hierarchical namespaces](https://docs.microsoft.com/en-us/azure/storage/blobs/data-lake-storage-namespace) These are effectively directories and offer high performance rename and delete operations — something which makes a significant improvement in performance in query engines writing data to, including MapReduce, Spark, Hive, as well as DistCp.
...
_**Containers in a storage account with Hierarchical Namespaces are not (currently) readable through the`deprecated wasb:` connector.**_
...
##  Non-Hierarchical Namespaces
The ABFS driver also has support for non-hierarchical namespace (FNS) accounts to help users migrating from the legacy WASB driver. See [FNS-Blob](https://hadoop.apache.org/docs/current/hadoop-azure/fns_blob.html) for more details. The service does not recommend using the DFS endpoint for FNS accounts. DFS endpoint over FNS account has now been **REMOVED**. All requests detected over FNS account are automatically switched to Blob endpoint.
###  Creating an Azure Storage Account
The best documentation on getting started with Azure Datalake Gen2 with the abfs connector is [Using Azure Data Lake Storage Gen2 with Azure HDInsight clusters](https://docs.microsoft.com/en-us/azure/storage/blobs/data-lake-storage-use-hdi-cluster)
It includes instructions to create it from [the Azure command line tool](https://docs.microsoft.com/en-us/cli/azure/install-azure-cli?view=azure-cli-latest), which can be installed on Windows, MacOS (via Homebrew) and Linux (apt or yum).
The [az storage](https://docs.microsoft.com/en-us/cli/azure/storage?view=azure-cli-latest) subcommand handles all storage commands, [az storage account create](https://docs.microsoft.com/en-us/cli/azure/storage/account?view=azure-cli-latest#az-storage-account-create) does the creation.
...
Note: While user-bound SAS Authentication is **only supported** with HNS Enabled accounts, we **recommend** using HNS Enabled accounts with SAS authentication as well.
...
_Note_ : The source of the account key can be changed through a custom key provider; one needs to execute a shell script to retrieve it.
...
The below are the main options of identity configurations for OAuth settings. All of these would have OAuth set as the auth type
...
The specifics of this process is covered in [hadoop-azure-datalake](https://hadoop.apache.org/docs/current/hadoop-azure-datalake/index.html#Configuring_Credentials_and_FileSystem); the key names are slightly different here.
...
####  Refresh Token
With an existing Oauth 2.0 token, make a request to the Active Directory endpoint `https://login.microsoftonline.com/Common/oauth2/token` for this token to be refreshed.
...
There are three types of SAS supported by Azure Storage: - [User Delegation SAS](https://learn.microsoft.com/en-us/rest/api/storageservices/create-user-delegation-sas): SAS-based authentication works with HNS-enabled ADLS Gen2 accounts (recommended for use with ABFS) and is also supported with non-HNS (FNS) Blob accounts. However, it is **NOT SUPPORTED** with FNS-DFS accounts. - [Service SAS](https://learn.microsoft.com/en-us/rest/api/storageservices/create-service-sas): Global and works at container level. - [Account SAS](https://learn.microsoft.com/en-us/rest/api/storageservices/create-account-sas): Global and works at account level.
####  Known Issues With SAS
  * SAS Based Authentication works with HNS Enabled ADLS Gen2 Accounts (which is a recommended account type to be used with ABFS). It is also supported with non-HNS (FNS) Blob accounts. It is **NOT SUPPORTED** with FNS-DFS accounts.
...
```
  ...
  1. Account SAS (Fixed SAS Token at Account Level): `xml <property> <name>fs.azure.sas.fixed.token.ACCOUNT_NAME</name> <value>FIXED_ACCOUNT_SAS_TOKEN</value> </property>`
     * Replace `FIXED_ACCOUNT_SAS_TOKEN` with fixed Account/Service SAS. You can also generate SAS from Azure portal. Account -> Security + Networking -> Shared Access Signature
    1. Service SAS (Fixed SAS Token at Container Level): 
...
```
     ...
     * Replace `FIXED_SERVICE_SAS_TOKEN` with fixed Service SAS. You can also generate SAS from Azure portal. Account -> Data storage -> Containers -> right click on your container and select generate SAS -> Give valid permissions and expiry time -> Click on generate SAS and copy the SAS token.
...
_Note:_ - Preference order for SAS will be: - fs.azure.sas.token.provider.type - fs.azure.sas.fixed.token.CONTAINER_NAME.ACCOUNT_NAME - fs.azure.sas.fixed.token.ACCOUNT_NAME - fs.azure.sas.fixed.token
###  User-bound SAS
  * **Description** : The user-bound SAS auth type allows to track the usage of the SAS token generated- something that was not possible in user-delegation SAS authentication type. Reach out to us at ‘askabfs@microsoft.com’ for more information.
  * To use this authentication type, both custom SAS token provider class as well as OAuth 2.0 provider type need to be specified. 
    ...
    * There are multiple identity configurations for OAuth Token Provider settings. Listing the main ones below: 
      ...
      * Managed Identity
      * Workload Identity
Refer to respective OAuth 2.0 sections above to correctly choose the OAuth provider type - NOTE: User-bound SAS Authentication is **only supported** with HNS Enabled accounts.
  * **Configuration** : To use this method with ABFS Driver, specify the following properties in your `core-site.xml` file:
    1. Authentication Type: 
...
###  [](https://hadoop.apache.org/docs/current/hadoop-azure/networking)Networking Layer:
ABFS Driver can use the following networking libraries: - ApacheHttpClient: - [Library Documentation](https://hc.apache.org/httpcomponents-client-4.5.x/index.html). - JDK networking library: - [Library documentation](https://docs.oracle.com/javase/8/docs/api/java/net/HttpURLConnection.html). - Default networking library.
The networking library can be configured using the configuration `fs.azure.networking.library` while initializing the filesystem. Following are the supported values: - `JDK_HTTP_URL_CONNECTION` : Use JDK networking library - `APACHE_HTTP_CLIENT` : Use Apache HttpClient [Default]
####  [](https://hadoop.apache.org/docs/current/hadoop-azure/ahc_networking_conf)ApacheHttpClient networking layer configuration Options:
Following are the configuration options for ApacheHttpClient networking layer that can be provided at the initialization of the filesystem: 1. `fs.azure.apache.http.client.idle.connection.ttl`: 1. Maximum idle time in milliseconds for a connection to be kept alive in the connection pool. If the connection is not reused within the time limit, the connection shall be closed. 2. Default value: 5000 milliseconds. 2. `fs.azure.apache.http.client.max.cache.connection.size`: 1. Maximum number of connections that can be cached in the connection pool for a filesystem instance. Total number of concurrent connections has no limit. 2. Default value: 5. 3. `fs.azure.apache.http.client.max.io.exception.retries`: 1. Maximum number of times the client will retry on IOExceptions for a single request with ApacheHttpClient networking-layer. Breach of this limit would turn off the future uses of the ApacheHttpClient library in the current JVM instance. 2. Default value: 3.
####  [](https://hadoop.apache.org/docs/current/hadoop-azure/ahc_classpath) ApacheHttpClient classpath requirements:
ApacheHttpClient is a `compile` maven dependency in hadoop-azure and would be included in the hadoop-azure jar. For using hadoop-azure with ApacheHttpClient no additional information is required in the classpath.
##  [](https://hadoop.apache.org/docs/current/hadoop-azure/options) Other configuration options
...
Config `fs.azure.client.correlationid` provides an option to correlate client requests using this client-provided identifier. This Id will be visible in Azure Storage Analytics logs in the `request-id-header` field. Reference: [Storage Analytics log format](https://docs.microsoft.com/en-us/rest/api/storageservices/storage-analytics-log-format)
...
Requests failing due to server timeouts and network failures will be retried. PUT/POST operations are idempotent and need no specific handling.
...
##  Testing ABFS
See the relevant section in [Testing Azure](https://hadoop.apache.org/docs/current/hadoop-azure/testing_azure.html).
* * *
