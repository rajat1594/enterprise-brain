...
# FutureAction[ __](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html "Permalink")
...
Known Subclasses
[ComplexFutureAction](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ComplexFutureAction.html "org.apache.spark.ComplexFutureAction"), [SimpleFutureAction](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SimpleFutureAction.html "org.apache.spark.SimpleFutureAction")
__ __
Ordering
  1. Alphabetic
  2. By Inheritance
...
### Abstract Value Members
  1. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#cancel\(reason:Option\[String\]\):Unit "Permalink") abstract  def cancel(reason: Option[String]): Unit
Cancels the execution of this action with an optional reason.
  2. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#isCancelled:Boolean "Permalink") abstract  def isCancelled: Boolean
Returns whether the action has been cancelled.
  3. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#isCompleted:Boolean "Permalink") abstract  def isCompleted: Boolean
Returns whether the action has already been completed with a value or an exception.
Returns whether the action has already been completed with a value or an exception.  

Definition Classes
     [FutureAction](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html "org.apache.spark.FutureAction") → Future
  4. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#jobIds:Seq\[Int\] "Permalink") abstract  def jobIds: Seq[Int]
...
This returns the current snapshot of the job list. Certain operations may run multiple jobs, so multiple calls to this method may return different lists. 
  5. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#onComplete\[U\]\(func:scala.util.Try\[T\]=>U\)\(implicitexecutor:scala.concurrent.ExecutionContext\):Unit "Permalink") abstract  def onComplete[U](func: (Try[T]) => U)(implicit executor: ExecutionContext): Unit
When this action is completed, either through an exception, or a value, applies the provided function.
When this action is completed, either through an exception, or a value, applies the provided function.  

Definition Classes
     [FutureAction](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html "org.apache.spark.FutureAction") → Future
  6. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#ready\(atMost:scala.concurrent.duration.Duration\)\(implicitpermit:scala.concurrent.CanAwait\):FutureAction.this.type "Permalink") abstract  def ready(atMost: Duration)(implicit permit: CanAwait): [FutureAction](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html "org.apache.spark.FutureAction").this.type
...
Definition Classes
     [FutureAction](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html "org.apache.spark.FutureAction") → Awaitable
  7. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#result\(atMost:scala.concurrent.duration.Duration\)\(implicitpermit:scala.concurrent.CanAwait\):T "Permalink") abstract  def result(atMost: Duration)(implicit permit: CanAwait): T
...
`Exception` exception during action execution
  8. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#transform\[S\]\(f:scala.util.Try\[T\]=>scala.util.Try\[S\]\)\(implicitexecutor:scala.concurrent.ExecutionContext\):scala.concurrent.Future\[S\] "Permalink") abstract  def transform[S](f: (Try[T]) => Try[S])(implicit executor: ExecutionContext): Future[S] 

Definition Classes
    Future
  9. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#transformWith\[S\]\(f:scala.util.Try\[T\]=>scala.concurrent.Future\[S\]\)\(implicitexecutor:scala.concurrent.ExecutionContext\):scala.concurrent.Future\[S\] "Permalink") abstract  def transformWith[S](f: (Try[T]) => Future[S])(implicit executor: ExecutionContext): Future[S] 

Definition Classes
    Future
  10. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#value:Option\[scala.util.Try\[T\]\] "Permalink") abstract  def value: Option[Try[T]]
...
### Concrete Value Members
  1. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#!=\(x$1:Any\):Boolean "Permalink") final  def !=(arg0: Any): Boolean 

Definition Classes
    AnyRef → Any
  2. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html###:Int "Permalink") final  def ##: Int 

Definition Classes
    AnyRef → Any
  3. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#==\(x$1:Any\):Boolean "Permalink") final  def ==(arg0: Any): Boolean 

Definition Classes
    AnyRef → Any
  4. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#andThen\[U\]\(pf:PartialFunction\[scala.util.Try\[T\],U\]\)\(implicitexecutor:scala.concurrent.ExecutionContext\):scala.concurrent.Future\[T\] "Permalink") def andThen[U](pf: PartialFunction[Try[T], U])(implicit executor: ExecutionContext): Future[T] 

Definition Classes
    Future
  5. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#asInstanceOf\[T0\]:T0 "Permalink") final  def asInstanceOf[T0]: T0 

Definition Classes
    Any
  6. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#cancel\(\):Unit "Permalink") def cancel(): Unit
Cancels the execution of this action.
  7. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#clone\(\):Object "Permalink") def clone(): AnyRef 
...
Annotations
  ...
  8. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#collect\[S\]\(pf:PartialFunction\[T,S\]\)\(implicitexecutor:scala.concurrent.ExecutionContext\):scala.concurrent.Future\[S\] "Permalink") def collect[S](pf: PartialFunction[T, S])(implicit executor: ExecutionContext): Future[S] 

Definition Classes
    Future
  9. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#eq\(x$1:AnyRef\):Boolean "Permalink") final  def eq(arg0: AnyRef): Boolean 

Definition Classes
    AnyRef
  10. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#equals\(x$1:Object\):Boolean "Permalink") def equals(arg0: AnyRef): Boolean 

Definition Classes
    AnyRef → Any
  11. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#failed:scala.concurrent.Future\[Throwable\] "Permalink") def failed: Future[Throwable] 

Definition Classes
    Future
  12. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#fallbackTo\[U>:T\]\(that:scala.concurrent.Future\[U\]\):scala.concurrent.Future\[U\] "Permalink") def fallbackTo[U >: T](that: Future[U]): Future[U] 

Definition Classes
    Future
  13. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#filter\(p:T=>Boolean\)\(implicitexecutor:scala.concurrent.ExecutionContext\):scala.concurrent.Future\[T\] "Permalink") def filter(p: (T) => Boolean)(implicit executor: ExecutionContext): Future[T] 

Definition Classes
    Future
  14. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#flatMap\[S\]\(f:T=>scala.concurrent.Future\[S\]\)\(implicitexecutor:scala.concurrent.ExecutionContext\):scala.concurrent.Future\[S\] "Permalink") def flatMap[S](f: (T) => Future[S])(implicit executor: ExecutionContext): Future[S] 

Definition Classes
    Future
  15. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#flatten\[S\]\(implicitev:T<:<scala.concurrent.Future\[S\]\):scala.concurrent.Future\[S\] "Permalink") def flatten[S](implicit ev: <:<[T, Future[S]]): Future[S] 

Definition Classes
    Future
  16. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#foreach\[U\]\(f:T=>U\)\(implicitexecutor:scala.concurrent.ExecutionContext\):Unit "Permalink") def foreach[U](f: (T) => U)(implicit executor: ExecutionContext): Unit 

Definition Classes
    Future
  17. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#get\(\):T "Permalink") def get(): T
Blocks and returns the result of this job.
Blocks and returns the result of this job.  

Annotations
     @throws(classOf[SparkException])
  18. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#getClass\(\):Class\[_\] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Class.html#java.lang.Class "java.lang.Class")[_ <: AnyRef] 
...
Annotations
  ...
  19. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#hashCode\(\):Int "Permalink") def hashCode(): Int 
...
Annotations
     @IntrinsicCandidate() @native()
  20. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#isInstanceOf\[T0\]:Boolean "Permalink") final  def isInstanceOf[T0]: Boolean 

Definition Classes
    Any
  21. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#map\[S\]\(f:T=>S\)\(implicitexecutor:scala.concurrent.ExecutionContext\):scala.concurrent.Future\[S\] "Permalink") def map[S](f: (T) => S)(implicit executor: ExecutionContext): Future[S] 

Definition Classes
    Future
  22. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#mapTo\[S\]\(implicittag:scala.reflect.ClassTag\[S\]\):scala.concurrent.Future\[S\] "Permalink") def mapTo[S](implicit tag: ClassTag[S]): Future[S] 

Definition Classes
    Future
  23. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#ne\(x$1:AnyRef\):Boolean "Permalink") final  def ne(arg0: AnyRef): Boolean 

Definition Classes
    AnyRef
  24. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#notify\(\):Unit "Permalink") final  def notify(): Unit 
...
Annotations
     @IntrinsicCandidate() @native()
  25. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#notifyAll\(\):Unit "Permalink") final  def notifyAll(): Unit 
...
Annotations
     @IntrinsicCandidate() @native()
  26. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#recover\[U>:T\]\(pf:PartialFunction\[Throwable,U\]\)\(implicitexecutor:scala.concurrent.ExecutionContext\):scala.concurrent.Future\[U\] "Permalink") def recover[U >: T](pf: PartialFunction[Throwable, U])(implicit executor: ExecutionContext): Future[U] 

Definition Classes
    Future
  27. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#recoverWith\[U>:T\]\(pf:PartialFunction\[Throwable,scala.concurrent.Future\[U\]\]\)\(implicitexecutor:scala.concurrent.ExecutionContext\):scala.concurrent.Future\[U\] "Permalink") def recoverWith[U >: T](pf: PartialFunction[Throwable, Future[U]])(implicit executor: ExecutionContext): Future[U] 

Definition Classes
    Future
  28. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#synchronized\[T0\]\(x$1:=>T0\):T0 "Permalink") final  def synchronized[T0](arg0: => T0): T0 

Definition Classes
    AnyRef
  29. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#toString\(\):String "Permalink") def toString(): [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html#java.lang.String "java.lang.String") 

Definition Classes
    AnyRef → Any
  30. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#transform\[S\]\(s:T=>S,f:Throwable=>Throwable\)\(implicitexecutor:scala.concurrent.ExecutionContext\):scala.concurrent.Future\[S\] "Permalink") def transform[S](s: (T) => S, f: (Throwable) => Throwable)(implicit executor: ExecutionContext): Future[S] 

Definition Classes
    Future
  31. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#wait\(x$1:Long,x$2:Int\):Unit "Permalink") final  def wait(arg0: Long, arg1: Int): Unit 
...
Annotations
  ...
  32. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#wait\(x$1:Long\):Unit "Permalink") final  def wait(arg0: Long): Unit 
...
Annotations
  ...
  33. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#wait\(\):Unit "Permalink") final  def wait(): Unit 
...
Annotations
     @throws(classOf[java.lang.InterruptedException])
  34. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#withFilter\(p:T=>Boolean\)\(implicitexecutor:scala.concurrent.ExecutionContext\):scala.concurrent.Future\[T\] "Permalink") final  def withFilter(p: (T) => Boolean)(implicit executor: ExecutionContext): Future[T] 

Definition Classes
    Future
  35. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#zip\[U\]\(that:scala.concurrent.Future\[U\]\):scala.concurrent.Future\[\(T,U\)\] "Permalink") def zip[U](that: Future[U]): Future[(T, U)] 

Definition Classes
    Future
  36. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#zipWith\[U,R\]\(that:scala.concurrent.Future\[U\]\)\(f:\(T,U\)=>R\)\(implicitexecutor:scala.concurrent.ExecutionContext\):scala.concurrent.Future\[R\] "Permalink") def zipWith[U, R](that: Future[U])(f: (T, U) => R)(implicit executor: ExecutionContext): Future[R] 
...
### Deprecated Value Members
  1. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#finalize\(\):Unit "Permalink") def finalize(): Unit 
...
Definition Classes
    Future
  4. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#collect\[S\]\(pf:PartialFunction\[T,S\]\)\(implicitexecutor:scala.concurrent.ExecutionContext\):scala.concurrent.Future\[S\] "Permalink") def collect[S](pf: PartialFunction[T, S])(implicit executor: ExecutionContext): Future[S] 

Definition Classes
    Future
  5. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#failed:scala.concurrent.Future\[Throwable\] "Permalink") def failed: Future[Throwable] 

Definition Classes
    Future
  6. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#fallbackTo\[U>:T\]\(that:scala.concurrent.Future\[U\]\):scala.concurrent.Future\[U\] "Permalink") def fallbackTo[U >: T](that: Future[U]): Future[U] 

Definition Classes
    Future
  7. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#filter\(p:T=>Boolean\)\(implicitexecutor:scala.concurrent.ExecutionContext\):scala.concurrent.Future\[T\] "Permalink") def filter(p: (T) => Boolean)(implicit executor: ExecutionContext): Future[T] 

Definition Classes
    Future
  8. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#flatMap\[S\]\(f:T=>scala.concurrent.Future\[S\]\)\(implicitexecutor:scala.concurrent.ExecutionContext\):scala.concurrent.Future\[S\] "Permalink") def flatMap[S](f: (T) => Future[S])(implicit executor: ExecutionContext): Future[S] 

Definition Classes
    Future
  9. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#flatten\[S\]\(implicitev:T<:<scala.concurrent.Future\[S\]\):scala.concurrent.Future\[S\] "Permalink") def flatten[S](implicit ev: <:<[T, Future[S]]): Future[S] 

Definition Classes
    Future
  10. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#foreach\[U\]\(f:T=>U\)\(implicitexecutor:scala.concurrent.ExecutionContext\):Unit "Permalink") def foreach[U](f: (T) => U)(implicit executor: ExecutionContext): Unit 

Definition Classes
    Future
  11. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#map\[S\]\(f:T=>S\)\(implicitexecutor:scala.concurrent.ExecutionContext\):scala.concurrent.Future\[S\] "Permalink") def map[S](f: (T) => S)(implicit executor: ExecutionContext): Future[S] 

Definition Classes
    Future
  12. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#mapTo\[S\]\(implicittag:scala.reflect.ClassTag\[S\]\):scala.concurrent.Future\[S\] "Permalink") def mapTo[S](implicit tag: ClassTag[S]): Future[S] 
...
Definition Classes
    Future
  16. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#withFilter\(p:T=>Boolean\)\(implicitexecutor:scala.concurrent.ExecutionContext\):scala.concurrent.Future\[T\] "Permalink") final  def withFilter(p: (T) => Boolean)(implicit executor: ExecutionContext): Future[T] 

Definition Classes
    Future
  17. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#zip\[U\]\(that:scala.concurrent.Future\[U\]\):scala.concurrent.Future\[\(T,U\)\] "Permalink") def zip[U](that: Future[U]): Future[(T, U)] 
...
Definition Classes
    AnyRef → Any
  4. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#clone\(\):Object "Permalink") def clone(): AnyRef 
...
Annotations
     @throws(classOf[java.lang.CloneNotSupportedException]) @IntrinsicCandidate() @native()
  5. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#eq\(x$1:AnyRef\):Boolean "Permalink") final  def eq(arg0: AnyRef): Boolean 

Definition Classes
    AnyRef
  6. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#equals\(x$1:Object\):Boolean "Permalink") def equals(arg0: AnyRef): Boolean 

Definition Classes
    AnyRef → Any
  7. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#getClass\(\):Class\[_\] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Class.html#java.lang.Class "java.lang.Class")[_ <: AnyRef] 
...
Annotations
     @IntrinsicCandidate() @native()
  8. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#hashCode\(\):Int "Permalink") def hashCode(): Int 
...
Annotations
     @IntrinsicCandidate() @native()
  9. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#ne\(x$1:AnyRef\):Boolean "Permalink") final  def ne(arg0: AnyRef): Boolean 

Definition Classes
    AnyRef
  10. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#notify\(\):Unit "Permalink") final  def notify(): Unit 
...
Annotations
     @IntrinsicCandidate() @native()
  11. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#notifyAll\(\):Unit "Permalink") final  def notifyAll(): Unit 
...
Annotations
     @IntrinsicCandidate() @native()
  12. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#synchronized\[T0\]\(x$1:=>T0\):T0 "Permalink") final  def synchronized[T0](arg0: => T0): T0 

Definition Classes
    AnyRef
  13. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#toString\(\):String "Permalink") def toString(): [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html#java.lang.String "java.lang.String") 

Definition Classes
    AnyRef → Any
  14. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#wait\(x$1:Long,x$2:Int\):Unit "Permalink") final  def wait(arg0: Long, arg1: Int): Unit 
...
Annotations
     @throws(classOf[java.lang.InterruptedException])
  15. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#wait\(x$1:Long\):Unit "Permalink") final  def wait(arg0: Long): Unit 
...
Annotations
     @throws(classOf[java.lang.InterruptedException]) @native()
  16. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#wait\(\):Unit "Permalink") final  def wait(): Unit 
...
Annotations
     @throws(classOf[java.lang.InterruptedException])
  17. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#finalize\(\):Unit "Permalink") def finalize(): Unit 
...
### Inherited from Any
### Value Members
  1. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#asInstanceOf\[T0\]:T0 "Permalink") final  def asInstanceOf[T0]: T0 

Definition Classes
    Any
  2. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#isInstanceOf\[T0\]:Boolean "Permalink") final  def isInstanceOf[T0]: Boolean 
...
Definition Classes
     [FutureAction](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html "org.apache.spark.FutureAction") → Future
  11. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#!=\(x$1:Any\):Boolean "Permalink") final  def !=(arg0: Any): Boolean 

Definition Classes
    AnyRef → Any
  12. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html###:Int "Permalink") final  def ##: Int 

Definition Classes
    AnyRef → Any
  13. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#==\(x$1:Any\):Boolean "Permalink") final  def ==(arg0: Any): Boolean 
...
Definition Classes
    Future
  15. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#asInstanceOf\[T0\]:T0 "Permalink") final  def asInstanceOf[T0]: T0 

Definition Classes
    Any
  16. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#cancel\(\):Unit "Permalink") def cancel(): Unit
Cancels the execution of this action.
  17. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#clone\(\):Object "Permalink") def clone(): AnyRef 
...
Annotations
     @throws(classOf[java.lang.CloneNotSupportedException]) @IntrinsicCandidate() @native()
  18. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#collect\[S\]\(pf:PartialFunction\[T,S\]\)\(implicitexecutor:scala.concurrent.ExecutionContext\):scala.concurrent.Future\[S\] "Permalink") def collect[S](pf: PartialFunction[T, S])(implicit executor: ExecutionContext): Future[S] 

Definition Classes
    Future
  19. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#eq\(x$1:AnyRef\):Boolean "Permalink") final  def eq(arg0: AnyRef): Boolean 

Definition Classes
    AnyRef
  20. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#equals\(x$1:Object\):Boolean "Permalink") def equals(arg0: AnyRef): Boolean 

Definition Classes
    AnyRef → Any
  21. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#failed:scala.concurrent.Future\[Throwable\] "Permalink") def failed: Future[Throwable] 

Definition Classes
    Future
  22. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#fallbackTo\[U>:T\]\(that:scala.concurrent.Future\[U\]\):scala.concurrent.Future\[U\] "Permalink") def fallbackTo[U >: T](that: Future[U]): Future[U] 

Definition Classes
    Future
  23. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#filter\(p:T=>Boolean\)\(implicitexecutor:scala.concurrent.ExecutionContext\):scala.concurrent.Future\[T\] "Permalink") def filter(p: (T) => Boolean)(implicit executor: ExecutionContext): Future[T] 

Definition Classes
    Future
  24. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#flatMap\[S\]\(f:T=>scala.concurrent.Future\[S\]\)\(implicitexecutor:scala.concurrent.ExecutionContext\):scala.concurrent.Future\[S\] "Permalink") def flatMap[S](f: (T) => Future[S])(implicit executor: ExecutionContext): Future[S] 

Definition Classes
    Future
  25. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#flatten\[S\]\(implicitev:T<:<scala.concurrent.Future\[S\]\):scala.concurrent.Future\[S\] "Permalink") def flatten[S](implicit ev: <:<[T, Future[S]]): Future[S] 

Definition Classes
    Future
  26. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#foreach\[U\]\(f:T=>U\)\(implicitexecutor:scala.concurrent.ExecutionContext\):Unit "Permalink") def foreach[U](f: (T) => U)(implicit executor: ExecutionContext): Unit 

Definition Classes
    Future
  27. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#get\(\):T "Permalink") def get(): T
Blocks and returns the result of this job.
Blocks and returns the result of this job.  

Annotations
     @throws(classOf[SparkException])
  28. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#getClass\(\):Class\[_\] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Class.html#java.lang.Class "java.lang.Class")[_ <: AnyRef] 
...
Annotations
     @IntrinsicCandidate() @native()
  29. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#hashCode\(\):Int "Permalink") def hashCode(): Int 
...
Annotations
     @IntrinsicCandidate() @native()
  30. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#isInstanceOf\[T0\]:Boolean "Permalink") final  def isInstanceOf[T0]: Boolean 

Definition Classes
    Any
  31. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#map\[S\]\(f:T=>S\)\(implicitexecutor:scala.concurrent.ExecutionContext\):scala.concurrent.Future\[S\] "Permalink") def map[S](f: (T) => S)(implicit executor: ExecutionContext): Future[S] 

Definition Classes
    Future
  32. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#mapTo\[S\]\(implicittag:scala.reflect.ClassTag\[S\]\):scala.concurrent.Future\[S\] "Permalink") def mapTo[S](implicit tag: ClassTag[S]): Future[S] 

Definition Classes
    Future
  33. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#ne\(x$1:AnyRef\):Boolean "Permalink") final  def ne(arg0: AnyRef): Boolean 

Definition Classes
    AnyRef
  34. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#notify\(\):Unit "Permalink") final  def notify(): Unit 
...
Annotations
     @IntrinsicCandidate() @native()
  35. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#notifyAll\(\):Unit "Permalink") final  def notifyAll(): Unit 
...
Definition Classes
    Future
  38. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#synchronized\[T0\]\(x$1:=>T0\):T0 "Permalink") final  def synchronized[T0](arg0: => T0): T0 

Definition Classes
    AnyRef
  39. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#toString\(\):String "Permalink") def toString(): [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html#java.lang.String "java.lang.String") 
...
Definition Classes
    Future
  41. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#wait\(x$1:Long,x$2:Int\):Unit "Permalink") final  def wait(arg0: Long, arg1: Int): Unit 
...
Annotations
     @throws(classOf[java.lang.InterruptedException])
  42. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#wait\(x$1:Long\):Unit "Permalink") final  def wait(arg0: Long): Unit 
...
Annotations
     @throws(classOf[java.lang.InterruptedException]) @native()
  43. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#wait\(\):Unit "Permalink") final  def wait(): Unit 
...
Annotations
     @throws(classOf[java.lang.InterruptedException])
  44. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#withFilter\(p:T=>Boolean\)\(implicitexecutor:scala.concurrent.ExecutionContext\):scala.concurrent.Future\[T\] "Permalink") final  def withFilter(p: (T) => Boolean)(implicit executor: ExecutionContext): Future[T] 

Definition Classes
    Future
  45. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#zip\[U\]\(that:scala.concurrent.Future\[U\]\):scala.concurrent.Future\[\(T,U\)\] "Permalink") def zip[U](that: Future[U]): Future[(T, U)] 
...
Definition Classes
    Future
  47. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/FutureAction.html#finalize\(\):Unit "Permalink") def finalize(): Unit 
