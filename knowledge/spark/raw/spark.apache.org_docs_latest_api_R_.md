[Skip to contents](https://spark.apache.org/docs/latest/api/R/#main)
[ ![](https://spark.apache.org/images/spark-logo-rev.svg)](https://spark.apache.org/) [SparkR](https://spark.apache.org/docs/latest/api/R/index.html) 4.1.2
  ...
  * [Articles](https://spark.apache.org/docs/latest/api/R/)
[SparkR - Practical Guide](https://spark.apache.org/docs/latest/api/R/articles/sparkr-vignettes.html)


  * 

# R on Spark (deprecated)[](https://spark.apache.org/docs/latest/api/R/#r-on-spark-deprecated)
SparkR is an R package that provides a light-weight frontend to use Spark from R.
### Installing sparkR[](https://spark.apache.org/docs/latest/api/R/#installing-sparkr)
...
```
[](https://spark.apache.org/docs/latest/api/R/#cb1-1)# where /home/username/R is where R is installed and /home/username/R/bin contains the files R and RScript
[](https://spark.apache.org/docs/latest/api/R/#cb1-2)export R_HOME=/home/username/R
[](https://spark.apache.org/docs/latest/api/R/#cb1-3)./install-dev.sh
```

### SparkR development[](https://spark.apache.org/docs/latest/api/R/#sparkr-development)
#### Build Spark[](https://spark.apache.org/docs/latest/api/R/#build-spark)
...
```
[](https://spark.apache.org/docs/latest/api/R/#cb2-1)# Maven
[](https://spark.apache.org/docs/latest/api/R/#cb2-2)./build/mvn -DskipTests -Psparkr package
[](https://spark.apache.org/docs/latest/api/R/#cb2-3)
[](https://spark.apache.org/docs/latest/api/R/#cb2-4)# SBT
[](https://spark.apache.org/docs/latest/api/R/#cb2-5)./build/sbt -Psparkr package
```

#### Running sparkR[](https://spark.apache.org/docs/latest/api/R/#running-sparkr)
You can start using SparkR by launching the SparkR shell with

```
[](https://spark.apache.org/docs/latest/api/R/#cb3-1)./bin/sparkR
```
...
```
[](https://spark.apache.org/docs/latest/api/R/#cb4-1)./bin/sparkR --master "local[2]"
```
...
#### Using SparkR from RStudio[](https://spark.apache.org/docs/latest/api/R/#using-sparkr-from-rstudio)
...
#### Making changes to SparkR[](https://spark.apache.org/docs/latest/api/R/#making-changes-to-sparkr)
...
#### Generating documentation[](https://spark.apache.org/docs/latest/api/R/#generating-documentation)
...
### Examples, Unit tests[](https://spark.apache.org/docs/latest/api/R/#examples-unit-tests)
...
```
[](https://spark.apache.org/docs/latest/api/R/#cb5-1)./bin/spark-submit examples/src/main/r/dataframe.R
```
...
### Running on YARN[](https://spark.apache.org/docs/latest/api/R/#running-on-yarn)
...
```
[](https://spark.apache.org/docs/latest/api/R/#cb6-1)export YARN_CONF_DIR=/etc/hadoop/conf
[](https://spark.apache.org/docs/latest/api/R/#cb6-2)./bin/spark-submit --master yarn examples/src/main/r/dataframe.R
```
