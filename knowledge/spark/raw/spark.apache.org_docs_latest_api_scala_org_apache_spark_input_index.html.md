...
Definition Classes
    [spark](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/index.html "org.apache.spark")
  * [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/input/index.html "Permalink") package input 

Definition Classes
    [spark](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/index.html "org.apache.spark")
  * [](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/input/PortableDataStream.html "A class that allows DataStreams to be serialized and moved around by not creating them until they need to be read")[PortableDataStream](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/input/PortableDataStream.html "A class that allows DataStreams to be serialized and moved around by not creating them until they need to be read")
...
# input[ __](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/input/index.html "Permalink")
####  package input
### Type Members
  1. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/input/PortableDataStream.html "Permalink") class [PortableDataStream](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/input/PortableDataStream.html "A class that allows DataStreams to be serialized and moved around by not creating them until they need to be read") extends Serializable
