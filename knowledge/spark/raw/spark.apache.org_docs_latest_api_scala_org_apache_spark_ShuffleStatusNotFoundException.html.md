...
# ShuffleStatusNotFoundException[ __](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html "Permalink")
####  case class ShuffleStatusNotFoundException(shuffleId: Int, methodName: String) extends [SparkException](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkException.html "org.apache.spark.SparkException") with Product with Serializable 

Source
    [MapOutputTracker.scala](https://github.com/apache/spark/tree/v4.1.2/core/src/main/scala/org/apache/spark/MapOutputTracker.scala)
Linear Supertypes
Product, Equals, [SparkException](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkException.html "org.apache.spark.SparkException"), [SparkThrowable](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkThrowable.html "org.apache.spark.SparkThrowable"), [Exception](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Exception.html#java.lang.Exception "java.lang.Exception"), [Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html#java.lang.Throwable "java.lang.Throwable"), [Serializable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/io/Serializable.html#java.io.Serializable "java.io.Serializable"), AnyRef, Any
__ __
Ordering
  1. Alphabetic
  2. By Inheritance
...
Inherited  
  ...
  1. ShuffleStatusNotFoundException
  2. Product
  3. Equals
  4. SparkException
  5. SparkThrowable
...
### Instance Constructors
  1. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#<init>\(shuffleId:Int,methodName:String\):org.apache.spark.ShuffleStatusNotFoundException "Permalink") new ShuffleStatusNotFoundException(shuffleId: Int, methodName: String)


### Value Members
  1. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#!=\(x$1:Any\):Boolean "Permalink") final  def !=(arg0: Any): Boolean 

Definition Classes
    AnyRef → Any
  2. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html###:Int "Permalink") final  def ##: Int 

Definition Classes
    AnyRef → Any
  3. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#==\(x$1:Any\):Boolean "Permalink") final  def ==(arg0: Any): Boolean 

Definition Classes
    AnyRef → Any
  4. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#addSuppressed\(x$1:Throwable\):Unit "Permalink") final  def addSuppressed(arg0: [Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html#java.lang.Throwable "java.lang.Throwable")): Unit 

Definition Classes
    Throwable
  5. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#asInstanceOf\[T0\]:T0 "Permalink") final  def asInstanceOf[T0]: T0 

Definition Classes
    Any
  6. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#clone\(\):Object "Permalink") def clone(): AnyRef 
...
Annotations
  ...
  7. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#eq\(x$1:AnyRef\):Boolean "Permalink") final  def eq(arg0: AnyRef): Boolean 

Definition Classes
    AnyRef
  8. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#fillInStackTrace\(\):Throwable "Permalink") def fillInStackTrace(): [Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html#java.lang.Throwable "java.lang.Throwable") 

Definition Classes
    Throwable
  9. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#getBreakingChangeInfo\(\):org.apache.spark.BreakingChangeInfo "Permalink") def getBreakingChangeInfo(): [BreakingChangeInfo](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/BreakingChangeInfo.html "org.apache.spark.BreakingChangeInfo") 

Definition Classes
    [SparkThrowable](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkThrowable.html "org.apache.spark.SparkThrowable")
  10. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#getCause\(\):Throwable "Permalink") def getCause(): [Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html#java.lang.Throwable "java.lang.Throwable") 

Definition Classes
    Throwable
  11. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#getClass\(\):Class\[_\] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Class.html#java.lang.Class "java.lang.Class")[_ <: AnyRef] 
...
Annotations
  ...
  12. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#getCondition\(\):String "Permalink") def getCondition(): String
...
Definition Classes
     [SparkException](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkException.html "org.apache.spark.SparkException") → [SparkThrowable](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkThrowable.html "org.apache.spark.SparkThrowable")
  13. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#getDefaultMessageTemplate\(\):String "Permalink") def getDefaultMessageTemplate(): [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html#java.lang.String "java.lang.String")
...
Definition Classes
    [SparkThrowable](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkThrowable.html "org.apache.spark.SparkThrowable")
  14. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#getLocalizedMessage\(\):String "Permalink") def getLocalizedMessage(): [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html#java.lang.String "java.lang.String") 

Definition Classes
    Throwable
  15. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#getMessage\(\):String "Permalink") def getMessage(): [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html#java.lang.String "java.lang.String") 

Definition Classes
    Throwable
  16. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#getMessageParameters\(\):java.util.Map\[String,String\] "Permalink") def getMessageParameters(): [Map](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/Map.html#java.util.Map "java.util.Map")[String, String] 

Definition Classes
     [SparkException](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkException.html "org.apache.spark.SparkException") → [SparkThrowable](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkThrowable.html "org.apache.spark.SparkThrowable")
  17. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#getQueryContext\(\):Array\[org.apache.spark.QueryContext\] "Permalink") def getQueryContext(): Array[[QueryContext](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/QueryContext.html "org.apache.spark.QueryContext")] 

Definition Classes
     [SparkException](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkException.html "org.apache.spark.SparkException") → [SparkThrowable](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkThrowable.html "org.apache.spark.SparkThrowable")
  18. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#getSqlState\(\):String "Permalink") def getSqlState(): [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html#java.lang.String "java.lang.String") 

Definition Classes
    [SparkThrowable](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkThrowable.html "org.apache.spark.SparkThrowable")
  19. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#getStackTrace\(\):Array\[StackTraceElement\] "Permalink") def getStackTrace(): Array[[StackTraceElement](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/StackTraceElement.html#java.lang.StackTraceElement "java.lang.StackTraceElement")] 

Definition Classes
    Throwable
  20. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#getSuppressed\(\):Array\[Throwable\] "Permalink") final  def getSuppressed(): Array[[Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html#java.lang.Throwable "java.lang.Throwable")] 

Definition Classes
    Throwable
  21. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#initCause\(x$1:Throwable\):Throwable "Permalink") def initCause(arg0: [Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html#java.lang.Throwable "java.lang.Throwable")): [Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html#java.lang.Throwable "java.lang.Throwable") 

Definition Classes
    Throwable
  22. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#isInstanceOf\[T0\]:Boolean "Permalink") final  def isInstanceOf[T0]: Boolean 

Definition Classes
    Any
  23. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#isInternalError\(\):Boolean "Permalink") def isInternalError(): Boolean 

Definition Classes
    [SparkThrowable](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkThrowable.html "org.apache.spark.SparkThrowable")
  24. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#methodName:String "Permalink") val methodName: String
  25. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#ne\(x$1:AnyRef\):Boolean "Permalink") final  def ne(arg0: AnyRef): Boolean 

Definition Classes
    AnyRef
  26. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#notify\(\):Unit "Permalink") final  def notify(): Unit 
...
Annotations
     @IntrinsicCandidate() @native()
  27. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#notifyAll\(\):Unit "Permalink") final  def notifyAll(): Unit 
...
Annotations
     @IntrinsicCandidate() @native()
  28. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#printStackTrace\(x$1:java.io.PrintWriter\):Unit "Permalink") def printStackTrace(arg0: [PrintWriter](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/io/PrintWriter.html#java.io.PrintWriter "java.io.PrintWriter")): Unit 

Definition Classes
    Throwable
  29. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#printStackTrace\(x$1:java.io.PrintStream\):Unit "Permalink") def printStackTrace(arg0: [PrintStream](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/io/PrintStream.html#java.io.PrintStream "java.io.PrintStream")): Unit 

Definition Classes
    Throwable
  30. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#printStackTrace\(\):Unit "Permalink") def printStackTrace(): Unit 

Definition Classes
    Throwable
  31. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#productElementNames:Iterator\[String\] "Permalink") def productElementNames: Iterator[String] 

Definition Classes
    Product
  32. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#setStackTrace\(x$1:Array\[StackTraceElement\]\):Unit "Permalink") def setStackTrace(arg0: Array[[StackTraceElement](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/StackTraceElement.html#java.lang.StackTraceElement "java.lang.StackTraceElement")]): Unit 

Definition Classes
    Throwable
  33. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#shuffleId:Int "Permalink") val shuffleId: Int
  34. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#synchronized\[T0\]\(x$1:=>T0\):T0 "Permalink") final  def synchronized[T0](arg0: => T0): T0 

Definition Classes
    AnyRef
  35. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#toString\(\):String "Permalink") def toString(): [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html#java.lang.String "java.lang.String") 

Definition Classes
    Throwable → AnyRef → Any
  36. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#wait\(x$1:Long,x$2:Int\):Unit "Permalink") final  def wait(arg0: Long, arg1: Int): Unit 
...
Annotations
  ...
  37. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#wait\(x$1:Long\):Unit "Permalink") final  def wait(arg0: Long): Unit 
...
Annotations
  ...
  38. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#wait\(\):Unit "Permalink") final  def wait(): Unit 
...
### Deprecated Value Members
  1. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#finalize\(\):Unit "Permalink") def finalize(): Unit 
...
_(Since version 9)_
  2. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#getErrorClass\(\):String "Permalink") def getErrorClass(): [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html#java.lang.String "java.lang.String")
...
### Value Members
  1. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#productElementNames:Iterator\[String\] "Permalink") def productElementNames: Iterator[String] 

Definition Classes
    Product


### Inherited from [SparkException](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkException.html "org.apache.spark.SparkException")
### Value Members
  1. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#getCondition\(\):String "Permalink") def getCondition(): String
Succinct, human-readable, unique, and consistent representation of the error condition.
Succinct, human-readable, unique, and consistent representation of the error condition. If null, error condition is not set.  
...
### Inherited from [SparkThrowable](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkThrowable.html "org.apache.spark.SparkThrowable")
### Value Members
  1. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#getBreakingChangeInfo\(\):org.apache.spark.BreakingChangeInfo "Permalink") def getBreakingChangeInfo(): [BreakingChangeInfo](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/BreakingChangeInfo.html "org.apache.spark.BreakingChangeInfo") 

Definition Classes
    [SparkThrowable](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkThrowable.html "org.apache.spark.SparkThrowable")
  2. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#getDefaultMessageTemplate\(\):String "Permalink") def getDefaultMessageTemplate(): [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html#java.lang.String "java.lang.String")
Returns the default message template for this error.
Returns the default message template for this error.
The template is a machine-readable string with placeholders to be filled by `getMessageParameters()`.
This is the default template known to Spark, but clients are free to generate their own messages (e.g., translations, alternate formats) using the provided error metadata.  
...
Definition Classes
    [SparkThrowable](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkThrowable.html "org.apache.spark.SparkThrowable")
  3. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#getSqlState\(\):String "Permalink") def getSqlState(): [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html#java.lang.String "java.lang.String") 

Definition Classes
    [SparkThrowable](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkThrowable.html "org.apache.spark.SparkThrowable")
  4. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#isInternalError\(\):Boolean "Permalink") def isInternalError(): Boolean 

Definition Classes
    [SparkThrowable](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkThrowable.html "org.apache.spark.SparkThrowable")
  5. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#getErrorClass\(\):String "Permalink") def getErrorClass(): [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html#java.lang.String "java.lang.String")
Succinct, human-readable, unique, and consistent representation of the error category.
Succinct, human-readable, unique, and consistent representation of the error category. If null, error class is not set. 
...
### Inherited from [Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html#java.lang.Throwable "java.lang.Throwable")
### Value Members
  1. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#addSuppressed\(x$1:Throwable\):Unit "Permalink") final  def addSuppressed(arg0: [Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html#java.lang.Throwable "java.lang.Throwable")): Unit 

Definition Classes
    Throwable
  2. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#fillInStackTrace\(\):Throwable "Permalink") def fillInStackTrace(): [Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html#java.lang.Throwable "java.lang.Throwable") 

Definition Classes
    Throwable
  3. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#getCause\(\):Throwable "Permalink") def getCause(): [Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html#java.lang.Throwable "java.lang.Throwable") 

Definition Classes
    Throwable
  4. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#getLocalizedMessage\(\):String "Permalink") def getLocalizedMessage(): [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html#java.lang.String "java.lang.String") 

Definition Classes
    Throwable
  5. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#getMessage\(\):String "Permalink") def getMessage(): [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html#java.lang.String "java.lang.String") 
...
Definition Classes
    Throwable
  11. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#printStackTrace\(\):Unit "Permalink") def printStackTrace(): Unit 
...
Definition Classes
    Throwable
  13. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#toString\(\):String "Permalink") def toString(): [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html#java.lang.String "java.lang.String") 
...
Definition Classes
    AnyRef → Any
  4. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#clone\(\):Object "Permalink") def clone(): AnyRef 
...
Annotations
     @throws(classOf[java.lang.CloneNotSupportedException]) @IntrinsicCandidate() @native()
  5. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#eq\(x$1:AnyRef\):Boolean "Permalink") final  def eq(arg0: AnyRef): Boolean 

Definition Classes
    AnyRef
  6. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#getClass\(\):Class\[_\] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Class.html#java.lang.Class "java.lang.Class")[_ <: AnyRef] 
...
Annotations
     @IntrinsicCandidate() @native()
  7. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#ne\(x$1:AnyRef\):Boolean "Permalink") final  def ne(arg0: AnyRef): Boolean 

Definition Classes
    AnyRef
  8. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#notify\(\):Unit "Permalink") final  def notify(): Unit 
...
Annotations
     @IntrinsicCandidate() @native()
  9. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#notifyAll\(\):Unit "Permalink") final  def notifyAll(): Unit 
...
Annotations
     @IntrinsicCandidate() @native()
  10. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#synchronized\[T0\]\(x$1:=>T0\):T0 "Permalink") final  def synchronized[T0](arg0: => T0): T0 

Definition Classes
    AnyRef
  11. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#wait\(x$1:Long,x$2:Int\):Unit "Permalink") final  def wait(arg0: Long, arg1: Int): Unit 
...
Annotations
     @throws(classOf[java.lang.InterruptedException])
  12. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#wait\(x$1:Long\):Unit "Permalink") final  def wait(arg0: Long): Unit 
...
Annotations
     @throws(classOf[java.lang.InterruptedException]) @native()
  13. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#wait\(\):Unit "Permalink") final  def wait(): Unit 
...
Annotations
     @throws(classOf[java.lang.InterruptedException])
  14. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#finalize\(\):Unit "Permalink") def finalize(): Unit 
...
### Inherited from Any
### Value Members
  1. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#asInstanceOf\[T0\]:T0 "Permalink") final  def asInstanceOf[T0]: T0 

Definition Classes
    Any
  2. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#isInstanceOf\[T0\]:Boolean "Permalink") final  def isInstanceOf[T0]: Boolean 
...
Annotations
     @throws(classOf[java.lang.InterruptedException])
  39. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#finalize\(\):Unit "Permalink") def finalize(): Unit 
...
_(Since version 9)_
  40. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ShuffleStatusNotFoundException.html#getErrorClass\(\):String "Permalink") def getErrorClass(): [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html#java.lang.String "java.lang.String")
Succinct, human-readable, unique, and consistent representation of the error category.
Succinct, human-readable, unique, and consistent representation of the error category. If null, error class is not set. 
