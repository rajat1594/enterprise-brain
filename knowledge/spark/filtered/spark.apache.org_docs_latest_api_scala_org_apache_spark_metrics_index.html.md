...
Definition Classes
    [spark](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/index.html "org.apache.spark")
  * [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/index.html "Permalink") package metrics 

Definition Classes
    [spark](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/index.html "org.apache.spark")
  * [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/source/index.html "Permalink") package [source](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/source/index.html "Sources used in Spark's metrics system.")
Sources used in Spark's metrics system.
  * [](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/DirectPoolMemory$.html)[DirectPoolMemory](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/DirectPoolMemory$.html)
  * [](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/ExecutorMetricType.html "Executor metric types for executor-level metrics stored in ExecutorMetrics.")[ExecutorMetricType](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/ExecutorMetricType.html "Executor metric types for executor-level metrics stored in ExecutorMetrics.")
  * [](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/GarbageCollectionMetrics$.html)[GarbageCollectionMetrics](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/GarbageCollectionMetrics$.html)
  * [](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/JVMHeapMemory$.html)[JVMHeapMemory](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/JVMHeapMemory$.html)
  * [](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/JVMOffHeapMemory$.html)[JVMOffHeapMemory](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/JVMOffHeapMemory$.html)
  * [](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/MappedPoolMemory$.html)[MappedPoolMemory](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/MappedPoolMemory$.html)
  * [](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/OffHeapExecutionMemory$.html)[OffHeapExecutionMemory](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/OffHeapExecutionMemory$.html)
  * [](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/OffHeapStorageMemory$.html)[OffHeapStorageMemory](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/OffHeapStorageMemory$.html)
  * [](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/OffHeapUnifiedMemory$.html)[OffHeapUnifiedMemory](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/OffHeapUnifiedMemory$.html)
  * [](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/OnHeapExecutionMemory$.html)[OnHeapExecutionMemory](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/OnHeapExecutionMemory$.html)
  * [](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/OnHeapStorageMemory$.html)[OnHeapStorageMemory](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/OnHeapStorageMemory$.html)
  * [](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/OnHeapUnifiedMemory$.html)[OnHeapUnifiedMemory](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/OnHeapUnifiedMemory$.html)
  * [](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/ProcessTreeMetrics$.html)[ProcessTreeMetrics](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/ProcessTreeMetrics$.html)
  * [](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/SingleValueExecutorMetricType.html)[SingleValueExecutorMetricType](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/SingleValueExecutorMetricType.html)
...
# metrics[ __](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/index.html "Permalink")
####  package metrics
__ __
Ordering
  1. Alphabetic
...
### Package Members
  1. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/source/index.html "Permalink") package [source](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/source/index.html "Sources used in Spark's metrics system.")
Sources used in Spark's metrics system.


### Type Members
  1. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/ExecutorMetricType.html "Permalink") sealed  trait [ExecutorMetricType](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/ExecutorMetricType.html "Executor metric types for executor-level metrics stored in ExecutorMetrics.") extends AnyRef
Executor metric types for executor-level metrics stored in ExecutorMetrics.
  2. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/SingleValueExecutorMetricType.html "Permalink") sealed  trait [SingleValueExecutorMetricType](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/SingleValueExecutorMetricType.html) extends [ExecutorMetricType](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/ExecutorMetricType.html "org.apache.spark.metrics.ExecutorMetricType")


### Value Members
  1. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/DirectPoolMemory$.html "Permalink") case object [DirectPoolMemory](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/DirectPoolMemory$.html) extends MBeanExecutorMetricType with Product with Serializable
  2. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/GarbageCollectionMetrics$.html "Permalink") case object [GarbageCollectionMetrics](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/GarbageCollectionMetrics$.html) extends [ExecutorMetricType](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/ExecutorMetricType.html "org.apache.spark.metrics.ExecutorMetricType") with Logging with Product with Serializable
  3. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/JVMHeapMemory$.html "Permalink") case object [JVMHeapMemory](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/JVMHeapMemory$.html) extends [SingleValueExecutorMetricType](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/SingleValueExecutorMetricType.html "org.apache.spark.metrics.SingleValueExecutorMetricType") with Product with Serializable
  4. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/JVMOffHeapMemory$.html "Permalink") case object [JVMOffHeapMemory](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/JVMOffHeapMemory$.html) extends [SingleValueExecutorMetricType](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/SingleValueExecutorMetricType.html "org.apache.spark.metrics.SingleValueExecutorMetricType") with Product with Serializable
  5. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/MappedPoolMemory$.html "Permalink") case object [MappedPoolMemory](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/MappedPoolMemory$.html) extends MBeanExecutorMetricType with Product with Serializable
  6. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/OffHeapExecutionMemory$.html "Permalink") case object [OffHeapExecutionMemory](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/OffHeapExecutionMemory$.html) extends MemoryManagerExecutorMetricType with Product with Serializable
  7. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/OffHeapStorageMemory$.html "Permalink") case object [OffHeapStorageMemory](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/OffHeapStorageMemory$.html) extends MemoryManagerExecutorMetricType with Product with Serializable
  8. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/OffHeapUnifiedMemory$.html "Permalink") case object [OffHeapUnifiedMemory](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/OffHeapUnifiedMemory$.html) extends MemoryManagerExecutorMetricType with Product with Serializable
  9. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/OnHeapExecutionMemory$.html "Permalink") case object [OnHeapExecutionMemory](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/OnHeapExecutionMemory$.html) extends MemoryManagerExecutorMetricType with Product with Serializable
  10. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/OnHeapStorageMemory$.html "Permalink") case object [OnHeapStorageMemory](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/OnHeapStorageMemory$.html) extends MemoryManagerExecutorMetricType with Product with Serializable
  11. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/OnHeapUnifiedMemory$.html "Permalink") case object [OnHeapUnifiedMemory](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/OnHeapUnifiedMemory$.html) extends MemoryManagerExecutorMetricType with Product with Serializable
  12. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/ProcessTreeMetrics$.html "Permalink") case object [ProcessTreeMetrics](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/ProcessTreeMetrics$.html) extends [ExecutorMetricType](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/metrics/ExecutorMetricType.html "org.apache.spark.metrics.ExecutorMetricType") with Product with Serializable
