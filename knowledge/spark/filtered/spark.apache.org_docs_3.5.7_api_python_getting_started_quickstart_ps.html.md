[ ![logo](https://spark.apache.org/docs/3.5.7/api/python/_static/spark-logo-reverse.png) ](https://spark.apache.org/docs/3.5.7/api/python/index.html)
  * [ Overview ](https://spark.apache.org/docs/3.5.7/api/python/index.html)
  * [ Getting Started ](https://spark.apache.org/docs/3.5.7/api/python/getting_started/index.html)
  * [ User Guides ](https://spark.apache.org/docs/3.5.7/api/python/user_guide/index.html)
  * [ API Reference ](https://spark.apache.org/docs/3.5.7/api/python/reference/index.html)
  * [ Development ](https://spark.apache.org/docs/3.5.7/api/python/development/index.html)
  * [ Migration Guides ](https://spark.apache.org/docs/3.5.7/api/python/migration_guide/index.html)
...
[4.0.1](https://spark.apache.org/docs/4.0.1/api/python/index.html)[4.0.0](https://spark.apache.org/docs/4.0.0/api/python/index.html)[3.5.7](https://spark.apache.org/docs/3.5.7/api/python/index.html)[3.5.5](https://spark.apache.org/docs/3.5.5/api/python/index.html)[3.5.4](https://spark.apache.org/docs/3.5.4/api/python/index.html)[3.5.3](https://spark.apache.org/docs/3.5.3/api/python/index.html)[3.5.2](https://spark.apache.org/docs/3.5.2/api/python/index.html)[3.5.1](https://spark.apache.org/docs/3.5.1/api/python/index.html)[3.5.0](https://spark.apache.org/docs/3.5.0/api/python/index.html)[3.4.4](https://spark.apache.org/docs/3.4.4/api/python/index.html)[3.4.3](https://spark.apache.org/docs/3.4.3/api/python/index.html)[3.4.2](https://spark.apache.org/docs/3.4.2/api/python/index.html)[3.4.1](https://spark.apache.org/docs/3.4.1/api/python/index.html)[3.4.0](https://spark.apache.org/docs/3.4.0/api/python/index.html)[3.3.4](https://spark.apache.org/docs/3.3.4/api/python/index.html)[3.3.3](https://spark.apache.org/docs/3.3.3/api/python/index.html)[3.3.2](https://spark.apache.org/docs/3.3.2/api/python/index.html)[3.3.1](https://spark.apache.org/docs/3.3.1/api/python/index.html)[3.3.0](https://spark.apache.org/docs/3.3.0/api/python/index.html)
  * [ Installation ](https://spark.apache.org/docs/3.5.7/api/python/getting_started/install.html)
  * [ Quickstart: DataFrame ](https://spark.apache.org/docs/3.5.7/api/python/getting_started/quickstart_df.html)
  * [ Quickstart: Spark Connect ](https://spark.apache.org/docs/3.5.7/api/python/getting_started/quickstart_connect.html)
  * [ Quickstart: Pandas API on Spark ](https://spark.apache.org/docs/3.5.7/api/python/getting_started/quickstart_ps.html)
  * [ Testing PySpark ](https://spark.apache.org/docs/3.5.7/api/python/getting_started/testing_pyspark.html)


On this page 
  * [ Object Creation ](https://spark.apache.org/docs/3.5.7/api/python/getting_started/quickstart_ps.html#Object-Creation)
  * [ Missing Data ](https://spark.apache.org/docs/3.5.7/api/python/getting_started/quickstart_ps.html#Missing-Data)
  * [ Operations ](https://spark.apache.org/docs/3.5.7/api/python/getting_started/quickstart_ps.html#Operations)
    * [ Stats ](https://spark.apache.org/docs/3.5.7/api/python/getting_started/quickstart_ps.html#Stats)
    * [ Spark Configurations ](https://spark.apache.org/docs/3.5.7/api/python/getting_started/quickstart_ps.html#Spark-Configurations)
  * [ Grouping ](https://spark.apache.org/docs/3.5.7/api/python/getting_started/quickstart_ps.html#Grouping)
  * [ Plotting ](https://spark.apache.org/docs/3.5.7/api/python/getting_started/quickstart_ps.html#Plotting)
  * [ Getting data in/out ](https://spark.apache.org/docs/3.5.7/api/python/getting_started/quickstart_ps.html#Getting-data-in/out)
    * [ CSV ](https://spark.apache.org/docs/3.5.7/api/python/getting_started/quickstart_ps.html#CSV)
    * [ Parquet ](https://spark.apache.org/docs/3.5.7/api/python/getting_started/quickstart_ps.html#Parquet)
    * [ Spark IO ](https://spark.apache.org/docs/3.5.7/api/python/getting_started/quickstart_ps.html#Spark-IO)


# Quickstart: Pandas API on Spark[¶](https://spark.apache.org/docs/3.5.7/api/python/getting_started/quickstart_ps.html#Quickstart:-Pandas-API-on-Spark "Permalink to this headline")
...
```
Copy to clipboard
## Object Creation[¶](https://spark.apache.org/docs/3.5.7/api/python/getting_started/quickstart_ps.html#Object-Creation "Permalink to this headline")
...
| 0  | 0.912558  | -0.795645  | -0.289115  | 0.187606  |  
| 5  | 1.485582  | -0.709306  | -0.202637  | -0.248766  |  
## Missing Data[¶](https://spark.apache.org/docs/3.5.7/api/python/getting_started/quickstart_ps.html#Missing-Data "Permalink to this headline")
...
## Operations[¶](https://spark.apache.org/docs/3.5.7/api/python/getting_started/quickstart_ps.html#Operations "Permalink to this headline")
### Stats[¶](https://spark.apache.org/docs/3.5.7/api/python/getting_started/quickstart_ps.html#Stats "Permalink to this headline")
...
```
Copy to clipboard
### Spark Configurations[¶](https://spark.apache.org/docs/3.5.7/api/python/getting_started/quickstart_ps.html#Spark-Configurations "Permalink to this headline")
...
```
Copy to clipboard
## Grouping[¶](https://spark.apache.org/docs/3.5.7/api/python/getting_started/quickstart_ps.html#Grouping "Permalink to this headline")
...
## Plotting[¶](https://spark.apache.org/docs/3.5.7/api/python/getting_started/quickstart_ps.html#Plotting "Permalink to this headline")
...
## Getting data in/out[¶](https://spark.apache.org/docs/3.5.7/api/python/getting_started/quickstart_ps.html#Getting-data-in/out "Permalink to this headline")
### CSV[¶](https://spark.apache.org/docs/3.5.7/api/python/getting_started/quickstart_ps.html#CSV "Permalink to this headline")
...
### Parquet[¶](https://spark.apache.org/docs/3.5.7/api/python/getting_started/quickstart_ps.html#Parquet "Permalink to this headline")
...
| 8  | 2.755738  | 1.069183  | 1.395642  | 1.045868  |  
| 9  | 2.755738  | 1.508732  | 1.395642  | 1.556933  |  
### Spark IO[¶](https://spark.apache.org/docs/3.5.7/api/python/getting_started/quickstart_ps.html#Spark-IO "Permalink to this headline")
...
[ previous Quickstart: Spark Connect ](https://spark.apache.org/docs/3.5.7/api/python/getting_started/quickstart_connect.html "previous page") [ next Testing PySpark ](https://spark.apache.org/docs/3.5.7/api/python/getting_started/testing_pyspark.html "next page")
© Copyright .  
