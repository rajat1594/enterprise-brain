...
Definition Classes
    [spark](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/index.html "org.apache.spark")
  * [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/index.html "Permalink") package mllib
...
[SPARK-4591](https://issues.apache.org/jira/browse/SPARK-4591) to track the progress of feature parity
  * [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/classification/index.html "Permalink") package [classification](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/classification/index.html)
  * [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/clustering/index.html "Permalink") package [clustering](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/clustering/index.html)
  * [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/evaluation/index.html "Permalink") package [evaluation](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/evaluation/index.html)
  * [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/feature/index.html "Permalink") package [feature](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/feature/index.html)
  * [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/fpm/index.html "Permalink") package [fpm](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/fpm/index.html)
  * [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/linalg/index.html "Permalink") package [linalg](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/linalg/index.html)
  * [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/optimization/index.html "Permalink") package [optimization](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/optimization/index.html)
  * [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/pmml/index.html "Permalink") package [pmml](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/pmml/index.html)
  * [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/random/index.html "Permalink") package [random](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/random/index.html)
  * [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/rdd/index.html "Permalink") package [rdd](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/rdd/index.html)
  * [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/recommendation/index.html "Permalink") package [recommendation](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/recommendation/index.html)
  * [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/regression/index.html "Permalink") package [regression](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/regression/index.html)
  * [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/stat/index.html "Permalink") package [stat](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/stat/index.html)
  * [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/tree/index.html "Permalink") package [tree](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/tree/index.html "This package contains the default implementation of the decision tree algorithm, which supports:")
...
This package contains the default implementation of the decision tree algorithm, which supports:
  ...
  * [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/util/index.html "Permalink") package [util](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/util/index.html)
  * [](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/JavaPackage.html "A dummy class as a workaround to show the package doc of spark.mllib in generated Java API docs.")[JavaPackage](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/JavaPackage.html "A dummy class as a workaround to show the package doc of spark.mllib in generated Java API docs.")
...
# mllib[ __](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/index.html "Permalink")
####  package mllib
RDD-based machine learning APIs (in maintenance mode).
The `spark.mllib` package is in maintenance mode as of the Spark 2.0.0 release to encourage migration to the DataFrame-based APIs under the [org.apache.spark.ml](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/ml/index.html "org.apache.spark.ml") package. While in maintenance mode,
  * no new features in the RDD-based `spark.mllib` package will be accepted, unless they block implementing new features in the DataFrame-based `spark.ml` package;
...
Source
    [package.scala](https://github.com/apache/spark/tree/v4.1.2/mllib/src/main/scala/org/apache/spark/mllib/package.scala) 
...
AnyRef, Any
### Package Members
  1. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/classification/index.html "Permalink") package [classification](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/classification/index.html)
  2. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/clustering/index.html "Permalink") package [clustering](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/clustering/index.html)
  3. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/evaluation/index.html "Permalink") package [evaluation](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/evaluation/index.html)
  4. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/feature/index.html "Permalink") package [feature](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/feature/index.html)
  5. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/fpm/index.html "Permalink") package [fpm](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/fpm/index.html)
  6. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/linalg/index.html "Permalink") package [linalg](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/linalg/index.html)
  7. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/optimization/index.html "Permalink") package [optimization](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/optimization/index.html)
  8. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/pmml/index.html "Permalink") package [pmml](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/pmml/index.html)
  9. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/random/index.html "Permalink") package [random](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/random/index.html)
  10. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/rdd/index.html "Permalink") package [rdd](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/rdd/index.html)
  11. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/recommendation/index.html "Permalink") package [recommendation](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/recommendation/index.html)
  12. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/regression/index.html "Permalink") package [regression](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/regression/index.html)
  13. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/stat/index.html "Permalink") package [stat](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/stat/index.html)
  14. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/tree/index.html "Permalink") package [tree](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/tree/index.html "This package contains the default implementation of the decision tree algorithm, which supports:")
This package contains the default implementation of the decision tree algorithm, which supports:
This package contains the default implementation of the decision tree algorithm, which supports:
     * binary classification,
     * regression,
     * information loss calculation with entropy and Gini for classification and variance for regression,
     * both continuous and categorical features. 
  15. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/util/index.html "Permalink") package [util](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/util/index.html)


### Type Members
  1. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/JavaPackage.html "Permalink") class [JavaPackage](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/mllib/JavaPackage.html "A dummy class as a workaround to show the package doc of spark.mllib in generated Java API docs.") extends AnyRef
...
[ JDK-4492654](http://bugs.java.com/bugdatabase/view_bug.do?bug_id=4492654)
