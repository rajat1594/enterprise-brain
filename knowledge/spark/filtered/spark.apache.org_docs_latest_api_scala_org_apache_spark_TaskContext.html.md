...
[o](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext.html "See companion class")
...
#  [TaskContext](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext.html "See companion class")[ __](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html "Permalink")
### 
Companion [class TaskContext](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext.html "See companion class")
####  object TaskContext extends [Serializable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/io/Serializable.html#java.io.Serializable "java.io.Serializable") 

Source
    [TaskContext.scala](https://github.com/apache/spark/tree/v4.1.2/core/src/main/scala/org/apache/spark/TaskContext.scala)
Linear Supertypes
...
### Value Members
  1. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#!=\(x$1:Any\):Boolean "Permalink") final  def !=(arg0: Any): Boolean 

Definition Classes
    AnyRef → Any
  2. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html###:Int "Permalink") final  def ##: Int 

Definition Classes
    AnyRef → Any
  3. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#==\(x$1:Any\):Boolean "Permalink") final  def ==(arg0: Any): Boolean 

Definition Classes
    AnyRef → Any
  4. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#asInstanceOf\[T0\]:T0 "Permalink") final  def asInstanceOf[T0]: T0 

Definition Classes
    Any
  5. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#clone\(\):Object "Permalink") def clone(): AnyRef 
...
Annotations
  ...
  6. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#eq\(x$1:AnyRef\):Boolean "Permalink") final  def eq(arg0: AnyRef): Boolean 

Definition Classes
    AnyRef
  7. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#equals\(x$1:Object\):Boolean "Permalink") def equals(arg0: AnyRef): Boolean 

Definition Classes
    AnyRef → Any
  8. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#get\(\):org.apache.spark.TaskContext "Permalink") def get(): [TaskContext](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext.html "org.apache.spark.TaskContext")
...
Return the currently active TaskContext. This can be called inside of user functions to access contextual information about running tasks. 
  9. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#getClass\(\):Class\[_\] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Class.html#java.lang.Class "java.lang.Class")[_ <: AnyRef] 
...
Annotations
  ...
  10. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#getPartitionId\(\):Int "Permalink") def getPartitionId(): Int
...
Returns the partition id of currently active TaskContext. It will return 0 if there is no active TaskContext for cases like local execution. 
  11. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#hashCode\(\):Int "Permalink") def hashCode(): Int 
...
Annotations
     @IntrinsicCandidate() @native()
  12. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#isInstanceOf\[T0\]:Boolean "Permalink") final  def isInstanceOf[T0]: Boolean 

Definition Classes
    Any
  13. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#ne\(x$1:AnyRef\):Boolean "Permalink") final  def ne(arg0: AnyRef): Boolean 

Definition Classes
    AnyRef
  14. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#notify\(\):Unit "Permalink") final  def notify(): Unit 
...
Annotations
     @IntrinsicCandidate() @native()
  15. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#notifyAll\(\):Unit "Permalink") final  def notifyAll(): Unit 
...
Annotations
     @IntrinsicCandidate() @native()
  16. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#setTaskContext\(tc:org.apache.spark.TaskContext\):Unit "Permalink") def setTaskContext(tc: [TaskContext](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext.html "org.apache.spark.TaskContext")): Unit
...
Attributes
  ...
  17. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#synchronized\[T0\]\(x$1:=>T0\):T0 "Permalink") final  def synchronized[T0](arg0: => T0): T0 

Definition Classes
    AnyRef
  18. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#toString\(\):String "Permalink") def toString(): [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html#java.lang.String "java.lang.String") 

Definition Classes
    AnyRef → Any
  19. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#unset\(\):Unit "Permalink") def unset(): Unit
Unset the thread local TaskContext.
Unset the thread local TaskContext. Internal to Spark.  

Attributes
    protected[[spark](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/index.html "org.apache.spark")] 
  20. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#wait\(x$1:Long,x$2:Int\):Unit "Permalink") final  def wait(arg0: Long, arg1: Int): Unit 
...
Annotations
  ...
  21. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#wait\(x$1:Long\):Unit "Permalink") final  def wait(arg0: Long): Unit 
...
Annotations
  ...
  22. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#wait\(\):Unit "Permalink") final  def wait(): Unit 
...
Annotations
     @throws(classOf[java.lang.InterruptedException])
  23. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#withTaskContext\[T\]\(context:org.apache.spark.TaskContext\)\(task:=>T\):T "Permalink") def withTaskContext[T](context: [TaskContext](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext.html "org.apache.spark.TaskContext"))(task: => T): T


### Deprecated Value Members
  1. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#finalize\(\):Unit "Permalink") def finalize(): Unit 
...
Definition Classes
    AnyRef → Any
  4. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#clone\(\):Object "Permalink") def clone(): AnyRef 
...
Annotations
     @throws(classOf[java.lang.CloneNotSupportedException]) @IntrinsicCandidate() @native()
  5. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#eq\(x$1:AnyRef\):Boolean "Permalink") final  def eq(arg0: AnyRef): Boolean 

Definition Classes
    AnyRef
  6. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#equals\(x$1:Object\):Boolean "Permalink") def equals(arg0: AnyRef): Boolean 

Definition Classes
    AnyRef → Any
  7. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#getClass\(\):Class\[_\] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Class.html#java.lang.Class "java.lang.Class")[_ <: AnyRef] 
...
Annotations
     @IntrinsicCandidate() @native()
  8. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#hashCode\(\):Int "Permalink") def hashCode(): Int 
...
Annotations
     @IntrinsicCandidate() @native()
  9. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#ne\(x$1:AnyRef\):Boolean "Permalink") final  def ne(arg0: AnyRef): Boolean 

Definition Classes
    AnyRef
  10. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#notify\(\):Unit "Permalink") final  def notify(): Unit 
...
Annotations
     @IntrinsicCandidate() @native()
  11. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#notifyAll\(\):Unit "Permalink") final  def notifyAll(): Unit 
...
Annotations
     @IntrinsicCandidate() @native()
  12. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#synchronized\[T0\]\(x$1:=>T0\):T0 "Permalink") final  def synchronized[T0](arg0: => T0): T0 

Definition Classes
    AnyRef
  13. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#toString\(\):String "Permalink") def toString(): [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html#java.lang.String "java.lang.String") 

Definition Classes
    AnyRef → Any
  14. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#wait\(x$1:Long,x$2:Int\):Unit "Permalink") final  def wait(arg0: Long, arg1: Int): Unit 
...
Annotations
     @throws(classOf[java.lang.InterruptedException])
  15. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#wait\(x$1:Long\):Unit "Permalink") final  def wait(arg0: Long): Unit 
...
Annotations
     @throws(classOf[java.lang.InterruptedException]) @native()
  16. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#wait\(\):Unit "Permalink") final  def wait(): Unit 
...
Annotations
     @throws(classOf[java.lang.InterruptedException])
  17. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#finalize\(\):Unit "Permalink") def finalize(): Unit 
...
### Inherited from Any
### Value Members
  1. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#asInstanceOf\[T0\]:T0 "Permalink") final  def asInstanceOf[T0]: T0 

Definition Classes
    Any
  2. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#isInstanceOf\[T0\]:Boolean "Permalink") final  def isInstanceOf[T0]: Boolean 
...
Annotations
     @throws(classOf[java.lang.InterruptedException])
  23. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#withTaskContext\[T\]\(context:org.apache.spark.TaskContext\)\(task:=>T\):T "Permalink") def withTaskContext[T](context: [TaskContext](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext.html "org.apache.spark.TaskContext"))(task: => T): T
  24. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/TaskContext$.html#finalize\(\):Unit "Permalink") def finalize(): Unit 
