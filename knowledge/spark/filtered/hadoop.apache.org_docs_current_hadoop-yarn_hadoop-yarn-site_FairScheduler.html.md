...
[ ![Built by Maven](https://hadoop.apache.org/docs/current/hadoop-yarn/hadoop-yarn-site/images/logos/maven-feather.png) ](http://maven.apache.org/ "Built by Maven")
# Hadoop: Fair Scheduler
  * [Purpose](https://hadoop.apache.org/docs/current/hadoop-yarn/hadoop-yarn-site/FairScheduler.html#Purpose)
  * [Introduction](https://hadoop.apache.org/docs/current/hadoop-yarn/hadoop-yarn-site/FairScheduler.html#Introduction)
  * [Hierarchical queues with pluggable policies](https://hadoop.apache.org/docs/current/hadoop-yarn/hadoop-yarn-site/FairScheduler.html#Hierarchical_queues_with_pluggable_policies)
  * [Automatically placing applications in queues](https://hadoop.apache.org/docs/current/hadoop-yarn/hadoop-yarn-site/FairScheduler.html#Automatically_placing_applications_in_queues)
  * [Installation](https://hadoop.apache.org/docs/current/hadoop-yarn/hadoop-yarn-site/FairScheduler.html#Installation)
  * [Configuration](https://hadoop.apache.org/docs/current/hadoop-yarn/hadoop-yarn-site/FairScheduler.html#Configuration)
    * [Properties that can be placed in yarn-site.xml](https://hadoop.apache.org/docs/current/hadoop-yarn/hadoop-yarn-site/FairScheduler.html#Properties_that_can_be_placed_in_yarn-site.xml)
    * [Allocation file format](https://hadoop.apache.org/docs/current/hadoop-yarn/hadoop-yarn-site/FairScheduler.html#Allocation_file_format)
    ...
    * [Reservation Access Control Lists](https://hadoop.apache.org/docs/current/hadoop-yarn/hadoop-yarn-site/FairScheduler.html#Reservation_Access_Control_Lists)
    * [Configuring ReservationSystem](https://hadoop.apache.org/docs/current/hadoop-yarn/hadoop-yarn-site/FairScheduler.html#Configuring_ReservationSystem)
  * [Administration](https://hadoop.apache.org/docs/current/hadoop-yarn/hadoop-yarn-site/FairScheduler.html#Administration)
    * [Modifying configuration at runtime](https://hadoop.apache.org/docs/current/hadoop-yarn/hadoop-yarn-site/FairScheduler.html#Modifying_configuration_at_runtime)
    * [Monitoring through web UI](https://hadoop.apache.org/docs/current/hadoop-yarn/hadoop-yarn-site/FairScheduler.html#Monitoring_through_web_UI)
    * [Moving applications between queues](https://hadoop.apache.org/docs/current/hadoop-yarn/hadoop-yarn-site/FairScheduler.html#Moving_applications_between_queues)
    * [Dumping Fair Scheduler state](https://hadoop.apache.org/docs/current/hadoop-yarn/hadoop-yarn-site/FairScheduler.html#Dumping_Fair_Scheduler_state)
...
|  `yarn.scheduler.fair.allow-undeclared-pools`  |  If this is true, new queues can be created at application submission time, whether because they are specified as the application’s queue by the submitter or because they are placed there by the user-as-default-queue property. If this is false, any time an app would be placed in a queue that is not specified in the allocations file, it is placed in the “default” queue instead. Defaults to true. **Note:** If this is set to false, the “default” queue also needs to be declared in the allocations file. If a queue placement policy is given in the allocations file, this property is ignored.   |  
...
|  Property   |  Description   |  
| --- | --- |  
|  `yarn.resourcemanager.reservation-system.enable`  |  _Mandatory_ parameter: to enable the `ReservationSystem` in the **ResourceManager**. Boolean value expected. The default value is _false_ , i.e. `ReservationSystem` is not enabled by default.   |  
|  `yarn.resourcemanager.reservation-system.class`  |  _Optional_ parameter: the class name of the `ReservationSystem`. The default value is picked based on the configured Scheduler, i.e. if `FairScheduler` is configured, then it is `FairReservationSystem`.   |  
|  `yarn.resourcemanager.reservation-system.plan.follower`  |  _Optional_ parameter: the class name of the `PlanFollower` that runs on a timer, and synchronizes the `FairScheduler` with the `Plan` and vice versa. The default value is picked based on the configured Scheduler, i.e. if `FairScheduler` is configured, then it is `FairSchedulerPlanFollower`.   |  
|  `yarn.resourcemanager.reservation-system.planfollower.time-step`  |  _Optional_ parameter: the frequency in milliseconds of the `PlanFollower` timer. Long value expected. The default value is _1000_.   |  
