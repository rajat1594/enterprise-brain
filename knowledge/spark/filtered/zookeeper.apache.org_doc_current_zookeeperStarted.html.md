[Apache](http://www.apache.org/) > [ZooKeeper](http://zookeeper.apache.org/)
[![ZooKeeper](https://zookeeper.apache.org/doc/current/images/zookeeper_small.gif)](http://zookeeper.apache.org/)
  * [Project](http://zookeeper.apache.org/)
  * [Wiki](https://cwiki.apache.org/confluence/display/ZOOKEEPER/)
  * [ZooKeeper 3.9 Documentation](https://zookeeper.apache.org/doc/current/index.html)


Last Published: 03/07/2026 02:01:24 
Overview
[Welcome](https://zookeeper.apache.org/doc/current/index.html)
...
[Release Notes](https://zookeeper.apache.org/doc/current/releasenotes.html)
Developer
[API Docs](https://zookeeper.apache.org/doc/current/apidocs/zookeeper-server/index.html)
[Programmer's Guide](https://zookeeper.apache.org/doc/current/zookeeperProgrammers.html)
[Use Cases](https://zookeeper.apache.org/doc/current/zookeeperUseCases.html)
[Java Example](https://zookeeper.apache.org/doc/current/javaExample.html)
[Barrier and Queue Tutorial](https://zookeeper.apache.org/doc/current/zookeeperTutorial.html)
[Recipes](https://zookeeper.apache.org/doc/current/recipes.html)
Admin & Ops
[Administrator's Guide](https://zookeeper.apache.org/doc/current/zookeeperAdmin.html)
[Quota Guide](https://zookeeper.apache.org/doc/current/zookeeperQuotas.html)
...
[Hierarchical Quorums](https://zookeeper.apache.org/doc/current/zookeeperHierarchicalQuorums.html)
[Oracle Quorum](https://zookeeper.apache.org/doc/current/zookeeperOracleQuorums.html)
...
[ZooKeeper Tools](https://zookeeper.apache.org/doc/current/zookeeperTools.html)
[ZooKeeper Monitor](https://zookeeper.apache.org/doc/current/zookeeperMonitor.html)
[Audit Logs](https://zookeeper.apache.org/doc/current/zookeeperAuditLogs.html)
Contributor
...
[Mailing Lists](http://zookeeper.apache.org/mailing_lists.html)
...
ZooKeeper logs messages using _logback_ -- more detail available in the [Logging](https://zookeeper.apache.org/doc/current/zookeeperProgrammers.html#Logging) section of the Programmer's Guide. You will see log messages coming to the console (default) and/or a log file depending on the logback configuration.
...
###### Note
> If you want to test multiple servers on a single machine, specify the servername as _localhost_ with unique quorum & leader election ports (i.e. 2888:3888, 2889:3889, 2890:3890 in the example above) for each server.X in that server's config file. Of course separate _dataDir_s and distinct _clientPort_s are also necessary (in the above replicated example, running on a single _localhost_ , you would still have three config files).
> Please be aware that setting up multiple servers on a single machine will not create any redundancy. If something were to happen which caused the machine to die, all of the zookeeper servers would be offline. Full redundancy requires that each server have its own machine. It must be a completely separate physical server. Multiple virtual machines on the same physical host are still vulnerable to the complete failure of that host.
> If you have multiple network interfaces in your ZooKeeper machines, you can also instruct ZooKeeper to bind on all of your interfaces and automatically switch to a healthy interface in case of a network failure. For details, see the [Configuration Parameters](https://zookeeper.apache.org/doc/current/zookeeperAdmin.html#id_multi_address).
### Other Optimizations
...
Last Published: 03/07/2026 02:01:24 
Copyright © [The Apache Software Foundation.](http://www.apache.org/licenses/)
