[ Spark SQL, Built-in Functions ](https://spark.apache.org/docs/latest/api/sql/)
  * [Functions](https://spark.apache.org/docs/latest/api/sql/index.html)
    ...
    * [>>](https://spark.apache.org/docs/latest/api/sql/index.html#_17)
    * [>>>](https://spark.apache.org/docs/latest/api/sql/index.html#_18)
    * [^](https://spark.apache.org/docs/latest/api/sql/index.html#_19)
    ...
    * [any_value](https://spark.apache.org/docs/latest/api/sql/index.html#any_value)
    * [approx_count_distinct](https://spark.apache.org/docs/latest/api/sql/index.html#approx_count_distinct)
    * [approx_percentile](https://spark.apache.org/docs/latest/api/sql/index.html#approx_percentile)
    * [approx_top_k](https://spark.apache.org/docs/latest/api/sql/index.html#approx_top_k)
    * [approx_top_k_accumulate](https://spark.apache.org/docs/latest/api/sql/index.html#approx_top_k_accumulate)
    * [approx_top_k_combine](https://spark.apache.org/docs/latest/api/sql/index.html#approx_top_k_combine)
    * [approx_top_k_estimate](https://spark.apache.org/docs/latest/api/sql/index.html#approx_top_k_estimate)
    ...
    * [array_compact](https://spark.apache.org/docs/latest/api/sql/index.html#array_compact)
    * [array_contains](https://spark.apache.org/docs/latest/api/sql/index.html#array_contains)
    * [array_distinct](https://spark.apache.org/docs/latest/api/sql/index.html#array_distinct)
    * [array_except](https://spark.apache.org/docs/latest/api/sql/index.html#array_except)
    * [array_insert](https://spark.apache.org/docs/latest/api/sql/index.html#array_insert)
    ...
    * [array_prepend](https://spark.apache.org/docs/latest/api/sql/index.html#array_prepend)
    ...
    * [bit_get](https://spark.apache.org/docs/latest/api/sql/index.html#bit_get)
    * [bit_length](https://spark.apache.org/docs/latest/api/sql/index.html#bit_length)
    * [bit_or](https://spark.apache.org/docs/latest/api/sql/index.html#bit_or)
    * [bit_xor](https://spark.apache.org/docs/latest/api/sql/index.html#bit_xor)
    * [bitmap_and_agg](https://spark.apache.org/docs/latest/api/sql/index.html#bitmap_and_agg)
    * [bitmap_bit_position](https://spark.apache.org/docs/latest/api/sql/index.html#bitmap_bit_position)
    * [bitmap_bucket_number](https://spark.apache.org/docs/latest/api/sql/index.html#bitmap_bucket_number)
    * [bitmap_construct_agg](https://spark.apache.org/docs/latest/api/sql/index.html#bitmap_construct_agg)
    * [bitmap_count](https://spark.apache.org/docs/latest/api/sql/index.html#bitmap_count)
    * [bitmap_or_agg](https://spark.apache.org/docs/latest/api/sql/index.html#bitmap_or_agg)
    * [bool_and](https://spark.apache.org/docs/latest/api/sql/index.html#bool_and)
    * [bool_or](https://spark.apache.org/docs/latest/api/sql/index.html#bool_or)
    * [boolean](https://spark.apache.org/docs/latest/api/sql/index.html#boolean)
    * [bround](https://spark.apache.org/docs/latest/api/sql/index.html#bround)
    * [btrim](https://spark.apache.org/docs/latest/api/sql/index.html#btrim)
    * [cardinality](https://spark.apache.org/docs/latest/api/sql/index.html#cardinality)
    * [case](https://spark.apache.org/docs/latest/api/sql/index.html#case)
    * [cast](https://spark.apache.org/docs/latest/api/sql/index.html#cast)
    * [cbrt](https://spark.apache.org/docs/latest/api/sql/index.html#cbrt)
    * [ceil](https://spark.apache.org/docs/latest/api/sql/index.html#ceil)
    * [ceiling](https://spark.apache.org/docs/latest/api/sql/index.html#ceiling)
    ...
    * [collate](https://spark.apache.org/docs/latest/api/sql/index.html#collate)
    * [collation](https://spark.apache.org/docs/latest/api/sql/index.html#collation)
    * [collations](https://spark.apache.org/docs/latest/api/sql/index.html#collations)
    ...
    * [conv](https://spark.apache.org/docs/latest/api/sql/index.html#conv)
    * [convert_timezone](https://spark.apache.org/docs/latest/api/sql/index.html#convert_timezone)
    * [corr](https://spark.apache.org/docs/latest/api/sql/index.html#corr)
    * [cos](https://spark.apache.org/docs/latest/api/sql/index.html#cos)
    * [cosh](https://spark.apache.org/docs/latest/api/sql/index.html#cosh)
    * [cot](https://spark.apache.org/docs/latest/api/sql/index.html#cot)
    * [count](https://spark.apache.org/docs/latest/api/sql/index.html#count)
    * [count_if](https://spark.apache.org/docs/latest/api/sql/index.html#count_if)
    * [count_min_sketch](https://spark.apache.org/docs/latest/api/sql/index.html#count_min_sketch)
    * [covar_pop](https://spark.apache.org/docs/latest/api/sql/index.html#covar_pop)
    * [covar_samp](https://spark.apache.org/docs/latest/api/sql/index.html#covar_samp)
    * [crc32](https://spark.apache.org/docs/latest/api/sql/index.html#crc32)
    * [csc](https://spark.apache.org/docs/latest/api/sql/index.html#csc)
    * [cume_dist](https://spark.apache.org/docs/latest/api/sql/index.html#cume_dist)
    * [curdate](https://spark.apache.org/docs/latest/api/sql/index.html#curdate)
    * [current_catalog](https://spark.apache.org/docs/latest/api/sql/index.html#current_catalog)
    * [current_database](https://spark.apache.org/docs/latest/api/sql/index.html#current_database)
    * [current_date](https://spark.apache.org/docs/latest/api/sql/index.html#current_date)
    * [current_schema](https://spark.apache.org/docs/latest/api/sql/index.html#current_schema)
    * [current_time](https://spark.apache.org/docs/latest/api/sql/index.html#current_time)
    * [current_timestamp](https://spark.apache.org/docs/latest/api/sql/index.html#current_timestamp)
    * [current_timezone](https://spark.apache.org/docs/latest/api/sql/index.html#current_timezone)
    * [current_user](https://spark.apache.org/docs/latest/api/sql/index.html#current_user)
    * [date](https://spark.apache.org/docs/latest/api/sql/index.html#date)
    * [date_add](https://spark.apache.org/docs/latest/api/sql/index.html#date_add)
    * [date_diff](https://spark.apache.org/docs/latest/api/sql/index.html#date_diff)
    * [date_format](https://spark.apache.org/docs/latest/api/sql/index.html#date_format)
    * [date_from_unix_date](https://spark.apache.org/docs/latest/api/sql/index.html#date_from_unix_date)
    * [date_part](https://spark.apache.org/docs/latest/api/sql/index.html#date_part)
    * [date_sub](https://spark.apache.org/docs/latest/api/sql/index.html#date_sub)
    * [date_trunc](https://spark.apache.org/docs/latest/api/sql/index.html#date_trunc)
    * [dateadd](https://spark.apache.org/docs/latest/api/sql/index.html#dateadd)
    * [datediff](https://spark.apache.org/docs/latest/api/sql/index.html#datediff)
    * [datepart](https://spark.apache.org/docs/latest/api/sql/index.html#datepart)
    * [day](https://spark.apache.org/docs/latest/api/sql/index.html#day)
    * [dayname](https://spark.apache.org/docs/latest/api/sql/index.html#dayname)
    * [dayofmonth](https://spark.apache.org/docs/latest/api/sql/index.html#dayofmonth)
    * [dayofweek](https://spark.apache.org/docs/latest/api/sql/index.html#dayofweek)
    * [dayofyear](https://spark.apache.org/docs/latest/api/sql/index.html#dayofyear)
    * [decimal](https://spark.apache.org/docs/latest/api/sql/index.html#decimal)
    * [decode](https://spark.apache.org/docs/latest/api/sql/index.html#decode)
    * [degrees](https://spark.apache.org/docs/latest/api/sql/index.html#degrees)
    * [dense_rank](https://spark.apache.org/docs/latest/api/sql/index.html#dense_rank)
    * [div](https://spark.apache.org/docs/latest/api/sql/index.html#div)
    * [double](https://spark.apache.org/docs/latest/api/sql/index.html#double)
    * [e](https://spark.apache.org/docs/latest/api/sql/index.html#e)
    * [element_at](https://spark.apache.org/docs/latest/api/sql/index.html#element_at)
    * [elt](https://spark.apache.org/docs/latest/api/sql/index.html#elt)
    * [encode](https://spark.apache.org/docs/latest/api/sql/index.html#encode)
    * [endswith](https://spark.apache.org/docs/latest/api/sql/index.html#endswith)
    * [equal_null](https://spark.apache.org/docs/latest/api/sql/index.html#equal_null)
    * [every](https://spark.apache.org/docs/latest/api/sql/index.html#every)
    * [exists](https://spark.apache.org/docs/latest/api/sql/index.html#exists)
    * [exp](https://spark.apache.org/docs/latest/api/sql/index.html#exp)
    ...
    * [expm1](https://spark.apache.org/docs/latest/api/sql/index.html#expm1)
    * [extract](https://spark.apache.org/docs/latest/api/sql/index.html#extract)
    * [factorial](https://spark.apache.org/docs/latest/api/sql/index.html#factorial)
    * [filter](https://spark.apache.org/docs/latest/api/sql/index.html#filter)
    * [find_in_set](https://spark.apache.org/docs/latest/api/sql/index.html#find_in_set)
    * [first](https://spark.apache.org/docs/latest/api/sql/index.html#first)
    * [first_value](https://spark.apache.org/docs/latest/api/sql/index.html#first_value)
    * [flatten](https://spark.apache.org/docs/latest/api/sql/index.html#flatten)
    * [float](https://spark.apache.org/docs/latest/api/sql/index.html#float)
    * [floor](https://spark.apache.org/docs/latest/api/sql/index.html#floor)
    * [forall](https://spark.apache.org/docs/latest/api/sql/index.html#forall)
    * [format_number](https://spark.apache.org/docs/latest/api/sql/index.html#format_number)
    * [format_string](https://spark.apache.org/docs/latest/api/sql/index.html#format_string)
    * [from_avro](https://spark.apache.org/docs/latest/api/sql/index.html#from_avro)
    * [from_csv](https://spark.apache.org/docs/latest/api/sql/index.html#from_csv)
    * [from_json](https://spark.apache.org/docs/latest/api/sql/index.html#from_json)
    * [from_protobuf](https://spark.apache.org/docs/latest/api/sql/index.html#from_protobuf)
    * [from_unixtime](https://spark.apache.org/docs/latest/api/sql/index.html#from_unixtime)
    * [from_utc_timestamp](https://spark.apache.org/docs/latest/api/sql/index.html#from_utc_timestamp)
    * [from_xml](https://spark.apache.org/docs/latest/api/sql/index.html#from_xml)
    * [get](https://spark.apache.org/docs/latest/api/sql/index.html#get)
    * [get_json_object](https://spark.apache.org/docs/latest/api/sql/index.html#get_json_object)
    * [getbit](https://spark.apache.org/docs/latest/api/sql/index.html#getbit)
    * [greatest](https://spark.apache.org/docs/latest/api/sql/index.html#greatest)
    * [grouping](https://spark.apache.org/docs/latest/api/sql/index.html#grouping)
    * [grouping_id](https://spark.apache.org/docs/latest/api/sql/index.html#grouping_id)
    ...
    * [histogram_numeric](https://spark.apache.org/docs/latest/api/sql/index.html#histogram_numeric)
    * [hll_sketch_agg](https://spark.apache.org/docs/latest/api/sql/index.html#hll_sketch_agg)
    * [hll_sketch_estimate](https://spark.apache.org/docs/latest/api/sql/index.html#hll_sketch_estimate)
    * [hll_union](https://spark.apache.org/docs/latest/api/sql/index.html#hll_union)
    * [hll_union_agg](https://spark.apache.org/docs/latest/api/sql/index.html#hll_union_agg)
    * [hour](https://spark.apache.org/docs/latest/api/sql/index.html#hour)
    * [hypot](https://spark.apache.org/docs/latest/api/sql/index.html#hypot)
    * [if](https://spark.apache.org/docs/latest/api/sql/index.html#if)
    * [ifnull](https://spark.apache.org/docs/latest/api/sql/index.html#ifnull)
    * [ilike](https://spark.apache.org/docs/latest/api/sql/index.html#ilike)
    * [in](https://spark.apache.org/docs/latest/api/sql/index.html#in)
    * [initcap](https://spark.apache.org/docs/latest/api/sql/index.html#initcap)
    * [inline](https://spark.apache.org/docs/latest/api/sql/index.html#inline)
    * [inline_outer](https://spark.apache.org/docs/latest/api/sql/index.html#inline_outer)
    * [input_file_block_length](https://spark.apache.org/docs/latest/api/sql/index.html#input_file_block_length)
    * [input_file_block_start](https://spark.apache.org/docs/latest/api/sql/index.html#input_file_block_start)
    ...
    * [int](https://spark.apache.org/docs/latest/api/sql/index.html#int)
    * [is_valid_utf8](https://spark.apache.org/docs/latest/api/sql/index.html#is_valid_utf8)
    * [is_variant_null](https://spark.apache.org/docs/latest/api/sql/index.html#is_variant_null)
    * [isnan](https://spark.apache.org/docs/latest/api/sql/index.html#isnan)
    * [isnotnull](https://spark.apache.org/docs/latest/api/sql/index.html#isnotnull)
    ...
    * [json_array_length](https://spark.apache.org/docs/latest/api/sql/index.html#json_array_length)
    * [json_object_keys](https://spark.apache.org/docs/latest/api/sql/index.html#json_object_keys)
    * [json_tuple](https://spark.apache.org/docs/latest/api/sql/index.html#json_tuple)
    * [kll_merge_agg_bigint](https://spark.apache.org/docs/latest/api/sql/index.html#kll_merge_agg_bigint)
    * [kll_merge_agg_double](https://spark.apache.org/docs/latest/api/sql/index.html#kll_merge_agg_double)
    * [kll_merge_agg_float](https://spark.apache.org/docs/latest/api/sql/index.html#kll_merge_agg_float)
    * [kll_sketch_agg_bigint](https://spark.apache.org/docs/latest/api/sql/index.html#kll_sketch_agg_bigint)
    * [kll_sketch_agg_double](https://spark.apache.org/docs/latest/api/sql/index.html#kll_sketch_agg_double)
    * [kll_sketch_agg_float](https://spark.apache.org/docs/latest/api/sql/index.html#kll_sketch_agg_float)
    * [kll_sketch_get_n_bigint](https://spark.apache.org/docs/latest/api/sql/index.html#kll_sketch_get_n_bigint)
    * [kll_sketch_get_n_double](https://spark.apache.org/docs/latest/api/sql/index.html#kll_sketch_get_n_double)
    * [kll_sketch_get_n_float](https://spark.apache.org/docs/latest/api/sql/index.html#kll_sketch_get_n_float)
    * [kll_sketch_get_quantile_bigint](https://spark.apache.org/docs/latest/api/sql/index.html#kll_sketch_get_quantile_bigint)
    * [kll_sketch_get_quantile_double](https://spark.apache.org/docs/latest/api/sql/index.html#kll_sketch_get_quantile_double)
    * [kll_sketch_get_quantile_float](https://spark.apache.org/docs/latest/api/sql/index.html#kll_sketch_get_quantile_float)
    * [kll_sketch_get_rank_bigint](https://spark.apache.org/docs/latest/api/sql/index.html#kll_sketch_get_rank_bigint)
    * [kll_sketch_get_rank_double](https://spark.apache.org/docs/latest/api/sql/index.html#kll_sketch_get_rank_double)
    * [kll_sketch_get_rank_float](https://spark.apache.org/docs/latest/api/sql/index.html#kll_sketch_get_rank_float)
    * [kll_sketch_merge_bigint](https://spark.apache.org/docs/latest/api/sql/index.html#kll_sketch_merge_bigint)
    * [kll_sketch_merge_double](https://spark.apache.org/docs/latest/api/sql/index.html#kll_sketch_merge_double)
    * [kll_sketch_merge_float](https://spark.apache.org/docs/latest/api/sql/index.html#kll_sketch_merge_float)
    * [kll_sketch_to_string_bigint](https://spark.apache.org/docs/latest/api/sql/index.html#kll_sketch_to_string_bigint)
    * [kll_sketch_to_string_double](https://spark.apache.org/docs/latest/api/sql/index.html#kll_sketch_to_string_double)
    * [kll_sketch_to_string_float](https://spark.apache.org/docs/latest/api/sql/index.html#kll_sketch_to_string_float)
    * [kurtosis](https://spark.apache.org/docs/latest/api/sql/index.html#kurtosis)
    * [lag](https://spark.apache.org/docs/latest/api/sql/index.html#lag)
    * [last](https://spark.apache.org/docs/latest/api/sql/index.html#last)
    * [last_day](https://spark.apache.org/docs/latest/api/sql/index.html#last_day)
    * [last_value](https://spark.apache.org/docs/latest/api/sql/index.html#last_value)
    ...
    * [least](https://spark.apache.org/docs/latest/api/sql/index.html#least)
    * [left](https://spark.apache.org/docs/latest/api/sql/index.html#left)
    * [len](https://spark.apache.org/docs/latest/api/sql/index.html#len)
    * [length](https://spark.apache.org/docs/latest/api/sql/index.html#length)
    * [levenshtein](https://spark.apache.org/docs/latest/api/sql/index.html#levenshtein)
    * [like](https://spark.apache.org/docs/latest/api/sql/index.html#like)
    * [listagg](https://spark.apache.org/docs/latest/api/sql/index.html#listagg)
    * [ln](https://spark.apache.org/docs/latest/api/sql/index.html#ln)
    * [localtimestamp](https://spark.apache.org/docs/latest/api/sql/index.html#localtimestamp)
    * [locate](https://spark.apache.org/docs/latest/api/sql/index.html#locate)
    * [log](https://spark.apache.org/docs/latest/api/sql/index.html#log)
    * [log10](https://spark.apache.org/docs/latest/api/sql/index.html#log10)
    * [log1p](https://spark.apache.org/docs/latest/api/sql/index.html#log1p)
    * [log2](https://spark.apache.org/docs/latest/api/sql/index.html#log2)
    * [lower](https://spark.apache.org/docs/latest/api/sql/index.html#lower)
    ...
    * [luhn_check](https://spark.apache.org/docs/latest/api/sql/index.html#luhn_check)
    * [make_date](https://spark.apache.org/docs/latest/api/sql/index.html#make_date)
    * [make_dt_interval](https://spark.apache.org/docs/latest/api/sql/index.html#make_dt_interval)
    * [make_interval](https://spark.apache.org/docs/latest/api/sql/index.html#make_interval)
    * [make_time](https://spark.apache.org/docs/latest/api/sql/index.html#make_time)
    * [make_timestamp](https://spark.apache.org/docs/latest/api/sql/index.html#make_timestamp)
    * [make_timestamp_ltz](https://spark.apache.org/docs/latest/api/sql/index.html#make_timestamp_ltz)
    * [make_timestamp_ntz](https://spark.apache.org/docs/latest/api/sql/index.html#make_timestamp_ntz)
    * [make_valid_utf8](https://spark.apache.org/docs/latest/api/sql/index.html#make_valid_utf8)
    * [make_ym_interval](https://spark.apache.org/docs/latest/api/sql/index.html#make_ym_interval)
    * [map](https://spark.apache.org/docs/latest/api/sql/index.html#map)
    * [map_concat](https://spark.apache.org/docs/latest/api/sql/index.html#map_concat)
    * [map_contains_key](https://spark.apache.org/docs/latest/api/sql/index.html#map_contains_key)
    * [map_entries](https://spark.apache.org/docs/latest/api/sql/index.html#map_entries)
    * [map_filter](https://spark.apache.org/docs/latest/api/sql/index.html#map_filter)
    * [map_from_arrays](https://spark.apache.org/docs/latest/api/sql/index.html#map_from_arrays)
    * [map_from_entries](https://spark.apache.org/docs/latest/api/sql/index.html#map_from_entries)
    * [map_keys](https://spark.apache.org/docs/latest/api/sql/index.html#map_keys)
    * [map_values](https://spark.apache.org/docs/latest/api/sql/index.html#map_values)
    * [map_zip_with](https://spark.apache.org/docs/latest/api/sql/index.html#map_zip_with)
    * [mask](https://spark.apache.org/docs/latest/api/sql/index.html#mask)
    * [max](https://spark.apache.org/docs/latest/api/sql/index.html#max)
    * [max_by](https://spark.apache.org/docs/latest/api/sql/index.html#max_by)
    ...
    * [median](https://spark.apache.org/docs/latest/api/sql/index.html#median)
    * [min](https://spark.apache.org/docs/latest/api/sql/index.html#min)
    * [min_by](https://spark.apache.org/docs/latest/api/sql/index.html#min_by)
    * [minute](https://spark.apache.org/docs/latest/api/sql/index.html#minute)
    * [mod](https://spark.apache.org/docs/latest/api/sql/index.html#mod)
    * [mode](https://spark.apache.org/docs/latest/api/sql/index.html#mode)
    * [monotonically_increasing_id](https://spark.apache.org/docs/latest/api/sql/index.html#monotonically_increasing_id)
    * [month](https://spark.apache.org/docs/latest/api/sql/index.html#month)
    * [monthname](https://spark.apache.org/docs/latest/api/sql/index.html#monthname)
    * [months_between](https://spark.apache.org/docs/latest/api/sql/index.html#months_between)
    * [named_struct](https://spark.apache.org/docs/latest/api/sql/index.html#named_struct)
    * [nanvl](https://spark.apache.org/docs/latest/api/sql/index.html#nanvl)
    * [negative](https://spark.apache.org/docs/latest/api/sql/index.html#negative)
    * [next_day](https://spark.apache.org/docs/latest/api/sql/index.html#next_day)
    * [not](https://spark.apache.org/docs/latest/api/sql/index.html#not)
    * [now](https://spark.apache.org/docs/latest/api/sql/index.html#now)
    * [nth_value](https://spark.apache.org/docs/latest/api/sql/index.html#nth_value)
    * [ntile](https://spark.apache.org/docs/latest/api/sql/index.html#ntile)
    * [nullif](https://spark.apache.org/docs/latest/api/sql/index.html#nullif)
    * [nullifzero](https://spark.apache.org/docs/latest/api/sql/index.html#nullifzero)
    * [nvl](https://spark.apache.org/docs/latest/api/sql/index.html#nvl)
    * [nvl2](https://spark.apache.org/docs/latest/api/sql/index.html#nvl2)
    * [octet_length](https://spark.apache.org/docs/latest/api/sql/index.html#octet_length)
    * [or](https://spark.apache.org/docs/latest/api/sql/index.html#or)
    * [overlay](https://spark.apache.org/docs/latest/api/sql/index.html#overlay)
    * [parse_json](https://spark.apache.org/docs/latest/api/sql/index.html#parse_json)
    * [parse_url](https://spark.apache.org/docs/latest/api/sql/index.html#parse_url)
    * [percent_rank](https://spark.apache.org/docs/latest/api/sql/index.html#percent_rank)
    * [percentile](https://spark.apache.org/docs/latest/api/sql/index.html#percentile)
    * [percentile_approx](https://spark.apache.org/docs/latest/api/sql/index.html#percentile_approx)
    * [percentile_cont](https://spark.apache.org/docs/latest/api/sql/index.html#percentile_cont)
    * [percentile_disc](https://spark.apache.org/docs/latest/api/sql/index.html#percentile_disc)
    * [pi](https://spark.apache.org/docs/latest/api/sql/index.html#pi)
    * [pmod](https://spark.apache.org/docs/latest/api/sql/index.html#pmod)
    * [posexplode](https://spark.apache.org/docs/latest/api/sql/index.html#posexplode)
    * [posexplode_outer](https://spark.apache.org/docs/latest/api/sql/index.html#posexplode_outer)
    * [position](https://spark.apache.org/docs/latest/api/sql/index.html#position)
    * [positive](https://spark.apache.org/docs/latest/api/sql/index.html#positive)
    * [pow](https://spark.apache.org/docs/latest/api/sql/index.html#pow)
    * [power](https://spark.apache.org/docs/latest/api/sql/index.html#power)
    * [printf](https://spark.apache.org/docs/latest/api/sql/index.html#printf)
    * [python_worker_logs](https://spark.apache.org/docs/latest/api/sql/index.html#python_worker_logs)
    * [quarter](https://spark.apache.org/docs/latest/api/sql/index.html#quarter)
    * [quote](https://spark.apache.org/docs/latest/api/sql/index.html#quote)
    * [radians](https://spark.apache.org/docs/latest/api/sql/index.html#radians)
    * [raise_error](https://spark.apache.org/docs/latest/api/sql/index.html#raise_error)
    * [rand](https://spark.apache.org/docs/latest/api/sql/index.html#rand)
    * [randn](https://spark.apache.org/docs/latest/api/sql/index.html#randn)
    * [random](https://spark.apache.org/docs/latest/api/sql/index.html#random)
    * [randstr](https://spark.apache.org/docs/latest/api/sql/index.html#randstr)
    * [range](https://spark.apache.org/docs/latest/api/sql/index.html#range)
    * [rank](https://spark.apache.org/docs/latest/api/sql/index.html#rank)
    * [reduce](https://spark.apache.org/docs/latest/api/sql/index.html#reduce)
    ...
    * [regexp_count](https://spark.apache.org/docs/latest/api/sql/index.html#regexp_count)
    * [regexp_extract](https://spark.apache.org/docs/latest/api/sql/index.html#regexp_extract)
    * [regexp_extract_all](https://spark.apache.org/docs/latest/api/sql/index.html#regexp_extract_all)
    * [regexp_instr](https://spark.apache.org/docs/latest/api/sql/index.html#regexp_instr)
    ...
    * [regexp_substr](https://spark.apache.org/docs/latest/api/sql/index.html#regexp_substr)
    * [regr_avgx](https://spark.apache.org/docs/latest/api/sql/index.html#regr_avgx)
    * [regr_avgy](https://spark.apache.org/docs/latest/api/sql/index.html#regr_avgy)
    * [regr_count](https://spark.apache.org/docs/latest/api/sql/index.html#regr_count)
    * [regr_intercept](https://spark.apache.org/docs/latest/api/sql/index.html#regr_intercept)
    * [regr_r2](https://spark.apache.org/docs/latest/api/sql/index.html#regr_r2)
    * [regr_slope](https://spark.apache.org/docs/latest/api/sql/index.html#regr_slope)
    * [regr_sxx](https://spark.apache.org/docs/latest/api/sql/index.html#regr_sxx)
    * [regr_sxy](https://spark.apache.org/docs/latest/api/sql/index.html#regr_sxy)
    * [regr_syy](https://spark.apache.org/docs/latest/api/sql/index.html#regr_syy)
    ...
    * [rint](https://spark.apache.org/docs/latest/api/sql/index.html#rint)
    ...
    * [row_number](https://spark.apache.org/docs/latest/api/sql/index.html#row_number)
    ...
    * [schema_of_avro](https://spark.apache.org/docs/latest/api/sql/index.html#schema_of_avro)
    * [schema_of_csv](https://spark.apache.org/docs/latest/api/sql/index.html#schema_of_csv)
    * [schema_of_json](https://spark.apache.org/docs/latest/api/sql/index.html#schema_of_json)
    * [schema_of_variant](https://spark.apache.org/docs/latest/api/sql/index.html#schema_of_variant)
    * [schema_of_variant_agg](https://spark.apache.org/docs/latest/api/sql/index.html#schema_of_variant_agg)
    * [schema_of_xml](https://spark.apache.org/docs/latest/api/sql/index.html#schema_of_xml)
    * [sec](https://spark.apache.org/docs/latest/api/sql/index.html#sec)
    * [second](https://spark.apache.org/docs/latest/api/sql/index.html#second)
    * [sentences](https://spark.apache.org/docs/latest/api/sql/index.html#sentences)
    * [sequence](https://spark.apache.org/docs/latest/api/sql/index.html#sequence)
    * [session_user](https://spark.apache.org/docs/latest/api/sql/index.html#session_user)
    * [session_window](https://spark.apache.org/docs/latest/api/sql/index.html#session_window)
    ...
    * [shiftleft](https://spark.apache.org/docs/latest/api/sql/index.html#shiftleft)
    * [shiftright](https://spark.apache.org/docs/latest/api/sql/index.html#shiftright)
    * [shiftrightunsigned](https://spark.apache.org/docs/latest/api/sql/index.html#shiftrightunsigned)
    * [shuffle](https://spark.apache.org/docs/latest/api/sql/index.html#shuffle)
    * [sign](https://spark.apache.org/docs/latest/api/sql/index.html#sign)
    * [signum](https://spark.apache.org/docs/latest/api/sql/index.html#signum)
    * [sin](https://spark.apache.org/docs/latest/api/sql/index.html#sin)
    * [sinh](https://spark.apache.org/docs/latest/api/sql/index.html#sinh)
    * [size](https://spark.apache.org/docs/latest/api/sql/index.html#size)
    * [skewness](https://spark.apache.org/docs/latest/api/sql/index.html#skewness)
    * [slice](https://spark.apache.org/docs/latest/api/sql/index.html#slice)
    * [smallint](https://spark.apache.org/docs/latest/api/sql/index.html#smallint)
    * [some](https://spark.apache.org/docs/latest/api/sql/index.html#some)
    * [sort_array](https://spark.apache.org/docs/latest/api/sql/index.html#sort_array)
    * [soundex](https://spark.apache.org/docs/latest/api/sql/index.html#soundex)
    * [space](https://spark.apache.org/docs/latest/api/sql/index.html#space)
    ...
    * [split_part](https://spark.apache.org/docs/latest/api/sql/index.html#split_part)
    * [sql_keywords](https://spark.apache.org/docs/latest/api/sql/index.html#sql_keywords)
    * [sqrt](https://spark.apache.org/docs/latest/api/sql/index.html#sqrt)
    * [st_asbinary](https://spark.apache.org/docs/latest/api/sql/index.html#st_asbinary)
    * [st_geogfromwkb](https://spark.apache.org/docs/latest/api/sql/index.html#st_geogfromwkb)
    * [st_geomfromwkb](https://spark.apache.org/docs/latest/api/sql/index.html#st_geomfromwkb)
    * [st_setsrid](https://spark.apache.org/docs/latest/api/sql/index.html#st_setsrid)
    * [st_srid](https://spark.apache.org/docs/latest/api/sql/index.html#st_srid)
    * [stack](https://spark.apache.org/docs/latest/api/sql/index.html#stack)
    * [startswith](https://spark.apache.org/docs/latest/api/sql/index.html#startswith)
    * [std](https://spark.apache.org/docs/latest/api/sql/index.html#std)
    * [stddev](https://spark.apache.org/docs/latest/api/sql/index.html#stddev)
    * [stddev_pop](https://spark.apache.org/docs/latest/api/sql/index.html#stddev_pop)
    * [stddev_samp](https://spark.apache.org/docs/latest/api/sql/index.html#stddev_samp)
    * [str_to_map](https://spark.apache.org/docs/latest/api/sql/index.html#str_to_map)
    * [string](https://spark.apache.org/docs/latest/api/sql/index.html#string)
    * [string_agg](https://spark.apache.org/docs/latest/api/sql/index.html#string_agg)
    ...
    * [tanh](https://spark.apache.org/docs/latest/api/sql/index.html#tanh)
    * [theta_difference](https://spark.apache.org/docs/latest/api/sql/index.html#theta_difference)
    * [theta_intersection](https://spark.apache.org/docs/latest/api/sql/index.html#theta_intersection)
    * [theta_intersection_agg](https://spark.apache.org/docs/latest/api/sql/index.html#theta_intersection_agg)
    * [theta_sketch_agg](https://spark.apache.org/docs/latest/api/sql/index.html#theta_sketch_agg)
    * [theta_sketch_estimate](https://spark.apache.org/docs/latest/api/sql/index.html#theta_sketch_estimate)
    * [theta_union](https://spark.apache.org/docs/latest/api/sql/index.html#theta_union)
    * [theta_union_agg](https://spark.apache.org/docs/latest/api/sql/index.html#theta_union_agg)
    * [time](https://spark.apache.org/docs/latest/api/sql/index.html#time)
    * [time_diff](https://spark.apache.org/docs/latest/api/sql/index.html#time_diff)
    * [time_trunc](https://spark.apache.org/docs/latest/api/sql/index.html#time_trunc)
    * [timestamp](https://spark.apache.org/docs/latest/api/sql/index.html#timestamp)
    * [timestamp_micros](https://spark.apache.org/docs/latest/api/sql/index.html#timestamp_micros)
    * [timestamp_millis](https://spark.apache.org/docs/latest/api/sql/index.html#timestamp_millis)
    * [timestamp_seconds](https://spark.apache.org/docs/latest/api/sql/index.html#timestamp_seconds)
    * [tinyint](https://spark.apache.org/docs/latest/api/sql/index.html#tinyint)
    * [to_avro](https://spark.apache.org/docs/latest/api/sql/index.html#to_avro)
    * [to_binary](https://spark.apache.org/docs/latest/api/sql/index.html#to_binary)
    * [to_char](https://spark.apache.org/docs/latest/api/sql/index.html#to_char)
    * [to_csv](https://spark.apache.org/docs/latest/api/sql/index.html#to_csv)
    ...
    * [to_number](https://spark.apache.org/docs/latest/api/sql/index.html#to_number)
    * [to_protobuf](https://spark.apache.org/docs/latest/api/sql/index.html#to_protobuf)
    * [to_time](https://spark.apache.org/docs/latest/api/sql/index.html#to_time)
    * [to_timestamp](https://spark.apache.org/docs/latest/api/sql/index.html#to_timestamp)
    * [to_timestamp_ltz](https://spark.apache.org/docs/latest/api/sql/index.html#to_timestamp_ltz)
    * [to_timestamp_ntz](https://spark.apache.org/docs/latest/api/sql/index.html#to_timestamp_ntz)
    * [to_unix_timestamp](https://spark.apache.org/docs/latest/api/sql/index.html#to_unix_timestamp)
    * [to_utc_timestamp](https://spark.apache.org/docs/latest/api/sql/index.html#to_utc_timestamp)
    * [to_varchar](https://spark.apache.org/docs/latest/api/sql/index.html#to_varchar)
    * [to_variant_object](https://spark.apache.org/docs/latest/api/sql/index.html#to_variant_object)
    * [to_xml](https://spark.apache.org/docs/latest/api/sql/index.html#to_xml)
    * [transform](https://spark.apache.org/docs/latest/api/sql/index.html#transform)
    * [transform_keys](https://spark.apache.org/docs/latest/api/sql/index.html#transform_keys)
    * [transform_values](https://spark.apache.org/docs/latest/api/sql/index.html#transform_values)
    ...
    * [try_add](https://spark.apache.org/docs/latest/api/sql/index.html#try_add)
    * [try_aes_decrypt](https://spark.apache.org/docs/latest/api/sql/index.html#try_aes_decrypt)
    * [try_avg](https://spark.apache.org/docs/latest/api/sql/index.html#try_avg)
    * [try_divide](https://spark.apache.org/docs/latest/api/sql/index.html#try_divide)
    * [try_element_at](https://spark.apache.org/docs/latest/api/sql/index.html#try_element_at)
    * [try_make_interval](https://spark.apache.org/docs/latest/api/sql/index.html#try_make_interval)
    * [try_make_timestamp](https://spark.apache.org/docs/latest/api/sql/index.html#try_make_timestamp)
    * [try_make_timestamp_ltz](https://spark.apache.org/docs/latest/api/sql/index.html#try_make_timestamp_ltz)
    * [try_make_timestamp_ntz](https://spark.apache.org/docs/latest/api/sql/index.html#try_make_timestamp_ntz)
    * [try_mod](https://spark.apache.org/docs/latest/api/sql/index.html#try_mod)
    * [try_multiply](https://spark.apache.org/docs/latest/api/sql/index.html#try_multiply)
    * [try_parse_json](https://spark.apache.org/docs/latest/api/sql/index.html#try_parse_json)
    * [try_parse_url](https://spark.apache.org/docs/latest/api/sql/index.html#try_parse_url)
    * [try_reflect](https://spark.apache.org/docs/latest/api/sql/index.html#try_reflect)
    * [try_subtract](https://spark.apache.org/docs/latest/api/sql/index.html#try_subtract)
    * [try_sum](https://spark.apache.org/docs/latest/api/sql/index.html#try_sum)
    * [try_to_binary](https://spark.apache.org/docs/latest/api/sql/index.html#try_to_binary)
    * [try_to_date](https://spark.apache.org/docs/latest/api/sql/index.html#try_to_date)
    * [try_to_number](https://spark.apache.org/docs/latest/api/sql/index.html#try_to_number)
    * [try_to_time](https://spark.apache.org/docs/latest/api/sql/index.html#try_to_time)
    * [try_to_timestamp](https://spark.apache.org/docs/latest/api/sql/index.html#try_to_timestamp)
    * [try_url_decode](https://spark.apache.org/docs/latest/api/sql/index.html#try_url_decode)
    * [try_validate_utf8](https://spark.apache.org/docs/latest/api/sql/index.html#try_validate_utf8)
    * [try_variant_get](https://spark.apache.org/docs/latest/api/sql/index.html#try_variant_get)
    * [typeof](https://spark.apache.org/docs/latest/api/sql/index.html#typeof)
    ...
    * [uniform](https://spark.apache.org/docs/latest/api/sql/index.html#uniform)
    * [unix_date](https://spark.apache.org/docs/latest/api/sql/index.html#unix_date)
    * [unix_micros](https://spark.apache.org/docs/latest/api/sql/index.html#unix_micros)
    * [unix_millis](https://spark.apache.org/docs/latest/api/sql/index.html#unix_millis)
    * [unix_seconds](https://spark.apache.org/docs/latest/api/sql/index.html#unix_seconds)
    * [unix_timestamp](https://spark.apache.org/docs/latest/api/sql/index.html#unix_timestamp)
    * [upper](https://spark.apache.org/docs/latest/api/sql/index.html#upper)
    * [url_decode](https://spark.apache.org/docs/latest/api/sql/index.html#url_decode)
    * [url_encode](https://spark.apache.org/docs/latest/api/sql/index.html#url_encode)
    * [user](https://spark.apache.org/docs/latest/api/sql/index.html#user)
    * [uuid](https://spark.apache.org/docs/latest/api/sql/index.html#uuid)
    * [validate_utf8](https://spark.apache.org/docs/latest/api/sql/index.html#validate_utf8)
    * [var_pop](https://spark.apache.org/docs/latest/api/sql/index.html#var_pop)
    * [var_samp](https://spark.apache.org/docs/latest/api/sql/index.html#var_samp)
    * [variance](https://spark.apache.org/docs/latest/api/sql/index.html#variance)
    * [variant_explode](https://spark.apache.org/docs/latest/api/sql/index.html#variant_explode)
    * [variant_explode_outer](https://spark.apache.org/docs/latest/api/sql/index.html#variant_explode_outer)
    * [variant_get](https://spark.apache.org/docs/latest/api/sql/index.html#variant_get)
    * [version](https://spark.apache.org/docs/latest/api/sql/index.html#version)
    * [weekday](https://spark.apache.org/docs/latest/api/sql/index.html#weekday)
    * [weekofyear](https://spark.apache.org/docs/latest/api/sql/index.html#weekofyear)
    * [when](https://spark.apache.org/docs/latest/api/sql/index.html#when)
    * [width_bucket](https://spark.apache.org/docs/latest/api/sql/index.html#width_bucket)
    * [window](https://spark.apache.org/docs/latest/api/sql/index.html#window)
    * [window_time](https://spark.apache.org/docs/latest/api/sql/index.html#window_time)
    * [xpath](https://spark.apache.org/docs/latest/api/sql/index.html#xpath)
    * [xpath_boolean](https://spark.apache.org/docs/latest/api/sql/index.html#xpath_boolean)
    * [xpath_double](https://spark.apache.org/docs/latest/api/sql/index.html#xpath_double)
    * [xpath_float](https://spark.apache.org/docs/latest/api/sql/index.html#xpath_float)
    * [xpath_int](https://spark.apache.org/docs/latest/api/sql/index.html#xpath_int)
    * [xpath_long](https://spark.apache.org/docs/latest/api/sql/index.html#xpath_long)
    * [xpath_number](https://spark.apache.org/docs/latest/api/sql/index.html#xpath_number)
    * [xpath_short](https://spark.apache.org/docs/latest/api/sql/index.html#xpath_short)
    * [xpath_string](https://spark.apache.org/docs/latest/api/sql/index.html#xpath_string)
    * [xxhash64](https://spark.apache.org/docs/latest/api/sql/index.html#xxhash64)
    * [year](https://spark.apache.org/docs/latest/api/sql/index.html#year)
    * [zeroifnull](https://spark.apache.org/docs/latest/api/sql/index.html#zeroifnull)
    * [zip_with](https://spark.apache.org/docs/latest/api/sql/index.html#zip_with)
    * [|](https://spark.apache.org/docs/latest/api/sql/index.html#_20)
    * [||](https://spark.apache.org/docs/latest/api/sql/index.html#_21)
    * [~](https://spark.apache.org/docs/latest/api/sql/index.html#_22)
