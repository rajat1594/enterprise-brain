...
* * *
##### General
  * [Overview](https://hadoop.apache.org/docs/current3/index.html)
  * [Single Node Setup](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-common/SingleCluster.html)
  * [Cluster Setup](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-common/ClusterSetup.html)
  * [Commands Reference](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-common/CommandsManual.html)
  * [FileSystem Shell](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-common/FileSystemShell.html)
  * [Compatibility Specification](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-common/Compatibility.html)
  * [Downstream Developer's Guide](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-common/DownstreamDev.html)
  * [Admin Compatibility Guide](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-common/AdminCompatibilityGuide.html)
  * [Interface Classification](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-common/InterfaceClassification.html)
  * [FileSystem Specification](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-common/filesystem/index.html)

##### Common
  * [CLI Mini Cluster](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-common/CLIMiniCluster.html)
  * [Fair Call Queue](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-common/FairCallQueue.html)
  * [Native Libraries](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-common/NativeLibraries.html)
  * [Proxy User](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-common/Superusers.html)
  * [Rack Awareness](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-common/RackAwareness.html)
  * [Secure Mode](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-common/SecureMode.html)
  * [Service Level Authorization](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-common/ServiceLevelAuth.html)
  * [HTTP Authentication](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-common/HttpAuthentication.html)
  * [Credential Provider API](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-common/CredentialProviderAPI.html)
  * [Hadoop KMS](https://hadoop.apache.org/docs/current3/hadoop-kms/index.html)
  * [Tracing](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-common/Tracing.html)
  * [Unix Shell Guide](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-common/UnixShellGuide.html)
  * [Registry](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-common/registry/index.html)
  * [Async Profiler](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-common/AsyncProfilerServlet.html)

##### HDFS
  * [Architecture](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-hdfs/HdfsDesign.html)
  * [User Guide](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-hdfs/HdfsUserGuide.html)
  * [Commands Reference](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-hdfs/HDFSCommands.html)
  * [NameNode HA With QJM](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-hdfs/HDFSHighAvailabilityWithQJM.html)
  * [NameNode HA With NFS](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-hdfs/HDFSHighAvailabilityWithNFS.html)
  * [Observer NameNode](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-hdfs/ObserverNameNode.html)
  * [Federation](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-hdfs/Federation.html)
  * [ViewFs](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-hdfs/ViewFs.html)
  * [ViewFsOverloadScheme](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-hdfs/ViewFsOverloadScheme.html)
  * [Snapshots](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-hdfs/HdfsSnapshots.html)
  * [Edits Viewer](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-hdfs/HdfsEditsViewer.html)
  * [Image Viewer](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-hdfs/HdfsImageViewer.html)
  * [Permissions and HDFS](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-hdfs/HdfsPermissionsGuide.html)
  * [Quotas and HDFS](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-hdfs/HdfsQuotaAdminGuide.html)
  * [libhdfs (C API)](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-hdfs/LibHdfs.html)
  * [WebHDFS (REST API)](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-hdfs/WebHDFS.html)
  * [HttpFS](https://hadoop.apache.org/docs/current3/hadoop-hdfs-httpfs/index.html)
  * [Short Circuit Local Reads](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-hdfs/ShortCircuitLocalReads.html)
  * [Centralized Cache Management](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-hdfs/CentralizedCacheManagement.html)
  * [NFS Gateway](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-hdfs/HdfsNfsGateway.html)
  * [Rolling Upgrade](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-hdfs/HdfsRollingUpgrade.html)
  * [Extended Attributes](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-hdfs/ExtendedAttributes.html)
  * [Transparent Encryption](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-hdfs/TransparentEncryption.html)
  * [Multihoming](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-hdfs/HdfsMultihoming.html)
  * [Storage Policies](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-hdfs/ArchivalStorage.html)
  * [Memory Storage Support](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-hdfs/MemoryStorage.html)
  * [Synthetic Load Generator](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-hdfs/SLGUserGuide.html)
  * [Erasure Coding](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-hdfs/HDFSErasureCoding.html)
  * [Disk Balancer](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-hdfs/HDFSDiskbalancer.html)
  * [Upgrade Domain](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-hdfs/HdfsUpgradeDomain.html)
  * [DataNode Admin](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-hdfs/HdfsDataNodeAdminGuide.html)
  * [Router Federation](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-hdfs-rbf/HDFSRouterFederation.html)
  * [Provided Storage](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-hdfs/HdfsProvidedStorage.html)

##### MapReduce
  * [Tutorial](https://hadoop.apache.org/docs/current3/hadoop-mapreduce-client/hadoop-mapreduce-client-core/MapReduceTutorial.html)
  * [Commands Reference](https://hadoop.apache.org/docs/current3/hadoop-mapreduce-client/hadoop-mapreduce-client-core/MapredCommands.html)
  * [Encrypted Shuffle](https://hadoop.apache.org/docs/current3/hadoop-mapreduce-client/hadoop-mapreduce-client-core/EncryptedShuffle.html)
  * [Pluggable Shuffle/Sort](https://hadoop.apache.org/docs/current3/hadoop-mapreduce-client/hadoop-mapreduce-client-core/PluggableShuffleAndPluggableSort.html)
  * [Distributed Cache Deploy](https://hadoop.apache.org/docs/current3/hadoop-mapreduce-client/hadoop-mapreduce-client-core/DistributedCacheDeploy.html)
  * [Support for YARN Shared Cache](https://hadoop.apache.org/docs/current3/hadoop-mapreduce-client/hadoop-mapreduce-client-core/SharedCacheSupport.html)

##### MapReduce REST APIs
  * [MR Application Master](https://hadoop.apache.org/docs/current3/hadoop-mapreduce-client/hadoop-mapreduce-client-core/MapredAppMasterRest.html)
  * [MR History Server](https://hadoop.apache.org/docs/current3/hadoop-mapreduce-client/hadoop-mapreduce-client-hs/HistoryServerRest.html)

##### YARN
  * [Architecture](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-site/YARN.html)
  * [Commands Reference](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-site/YarnCommands.html)
  * [Capacity Scheduler](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-site/CapacityScheduler.html)
  * [Fair Scheduler](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-site/FairScheduler.html)
  * [ResourceManager Restart](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-site/ResourceManagerRestart.html)
  * [ResourceManager HA](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-site/ResourceManagerHA.html)
  * [Resource Model](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-site/ResourceModel.html)
  * [Node Labels](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-site/NodeLabel.html)
  * [Node Attributes](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-site/NodeAttributes.html)
  * [Web Application Proxy](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-site/WebApplicationProxy.html)
  * [Timeline Server](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-site/TimelineServer.html)
  * [Timeline Service V.2](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-site/TimelineServiceV2.html)
  * [Writing YARN Applications](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-site/WritingYarnApplications.html)
  * [YARN Application Security](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-site/YarnApplicationSecurity.html)
  * [NodeManager](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-site/NodeManager.html)
  * [Running Applications in Docker Containers](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-site/DockerContainers.html)
  * [Running Applications in runC Containers](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-site/RuncContainers.html)
  * [Using CGroups](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-site/NodeManagerCgroups.html)
  * [Secure Containers](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-site/SecureContainer.html)
  * [Reservation System](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-site/ReservationSystem.html)
  * [Graceful Decommission](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-site/GracefulDecommission.html)
  * [Opportunistic Containers](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-site/OpportunisticContainers.html)
  * [YARN Federation](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-site/Federation.html)
  * [Shared Cache](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-site/SharedCache.html)
  * [Using GPU](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-site/UsingGpus.html)
  * [Using FPGA](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-site/UsingFPGA.html)
  * [Placement Constraints](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-site/PlacementConstraints.html)
  * [YARN UI2](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-site/YarnUI2.html)

##### YARN REST APIs
  * [Introduction](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-site/WebServicesIntro.html)
  * [Resource Manager](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-site/ResourceManagerRest.html)
  * [Node Manager](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-site/NodeManagerRest.html)
  * [Timeline Server](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-site/TimelineServer.html#Timeline_Server_REST_API_v1)
  * [Timeline Service V.2](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-site/TimelineServiceV2.html#Timeline_Service_v.2_REST_API)

##### YARN Service
  * [Overview](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-site/yarn-service/Overview.html)
  * [QuickStart](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-site/yarn-service/QuickStart.html)
  * [Concepts](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-site/yarn-service/Concepts.html)
  * [Yarn Service API](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-site/yarn-service/YarnServiceAPI.html)
  * [Service Discovery](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-site/yarn-service/ServiceDiscovery.html)
  * [System Services](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-site/yarn-service/SystemServices.html)

##### Hadoop Compatible File Systems
  * [Aliyun OSS](https://hadoop.apache.org/docs/current3/hadoop-aliyun/tools/hadoop-aliyun/index.html)
  * [Amazon S3](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html)
  * [Azure Blob Storage](https://hadoop.apache.org/docs/current3/hadoop-azure/index.html)
  * [Azure Data Lake Storage](https://hadoop.apache.org/docs/current3/hadoop-azure-datalake/index.html)
  * [Tencent COS](https://hadoop.apache.org/docs/current3/hadoop-cos/cloud-storage/index.html)
  * [Huaweicloud OBS](https://hadoop.apache.org/docs/current3/hadoop-huaweicloud/index.html)
  * [VolcanoEngine TOS](https://hadoop.apache.org/docs/current3/hadoop-tos/cloud-storage/index.html)

##### Auth
  * [Overview](https://hadoop.apache.org/docs/current3/hadoop-auth/index.html)
  * [Examples](https://hadoop.apache.org/docs/current3/hadoop-auth/Examples.html)
  * [Configuration](https://hadoop.apache.org/docs/current3/hadoop-auth/Configuration.html)
  * [Building](https://hadoop.apache.org/docs/current3/hadoop-auth/BuildingIt.html)

##### Tools
  * [Hadoop Streaming](https://hadoop.apache.org/docs/current3/hadoop-streaming/HadoopStreaming.html)
  * [Hadoop Archives](https://hadoop.apache.org/docs/current3/hadoop-archives/HadoopArchives.html)
  * [Hadoop Archive Logs](https://hadoop.apache.org/docs/current3/hadoop-archive-logs/HadoopArchiveLogs.html)
  * [DistCp](https://hadoop.apache.org/docs/current3/hadoop-distcp/DistCp.html)
  * [HDFS Federation Balance](https://hadoop.apache.org/docs/current3/hadoop-federation-balance/HDFSFederationBalance.html)
  * [GridMix](https://hadoop.apache.org/docs/current3/hadoop-gridmix/GridMix.html)
  * [Rumen](https://hadoop.apache.org/docs/current3/hadoop-rumen/Rumen.html)
  * [Resource Estimator Service](https://hadoop.apache.org/docs/current3/hadoop-resourceestimator/ResourceEstimator.html)
  * [Scheduler Load Simulator](https://hadoop.apache.org/docs/current3/hadoop-sls/SchedulerLoadSimulator.html)
  * [Hadoop Benchmarking](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-common/Benchmarking.html)
  * [Dynamometer](https://hadoop.apache.org/docs/current3/hadoop-dynamometer/Dynamometer.html)

##### Reference
  * [Changelog and Release Notes](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-common/release/)
  * [Java API docs](https://hadoop.apache.org/docs/current3/api/index.html)
  * [Unix Shell API](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-common/UnixShellAPI.html)
  * [Metrics](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-common/Metrics.html)

##### Configuration
  * [core-default.xml](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-common/core-default.xml)
  * [hdfs-default.xml](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-hdfs/hdfs-default.xml)
  * [hdfs-rbf-default.xml](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-hdfs-rbf/hdfs-rbf-default.xml)
  * [mapred-default.xml](https://hadoop.apache.org/docs/current3/hadoop-mapreduce-client/hadoop-mapreduce-client-core/mapred-default.xml)
  * [yarn-default.xml](https://hadoop.apache.org/docs/current3/hadoop-yarn/hadoop-yarn-common/yarn-default.xml)
  * [kms-default.xml](https://hadoop.apache.org/docs/current3/hadoop-kms/kms-default.html)
  * [httpfs-default.xml](https://hadoop.apache.org/docs/current3/hadoop-hdfs-httpfs/httpfs-default.html)
  * [Deprecated Properties](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-common/DeprecatedProperties.html)

[ ![Built by Maven](https://hadoop.apache.org/docs/current3/hadoop-aws/images/logos/maven-feather.png) ](http://maven.apache.org/ "Built by Maven")
# Hadoop-AWS module: Integration with Amazon Web Services
  * [ Compatibility](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Compatibility)
    * [ Directory Marker Compatibility](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Directory_Marker_Compatibility)
  * [ Documents](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Documents)
  * [ Overview](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Overview)
  * [ Introducing the Hadoop S3A client.](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Introducing_the_Hadoop_S3A_client.)
    * [Other S3 Connectors](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Other_S3_Connectors)
  * [ Getting Started](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Getting_Started)
  * [ Warnings](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Warnings)
    * [Warning #1: Directories are mimicked](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Warning_.231:_Directories_are_mimicked)
    * [Warning #2: Object stores have different authorization models](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Warning_.232:_Object_stores_have_different_authorization_models)
    * [Warning #4: Your AWS credentials are very, very valuable](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Warning_.234:_Your_AWS_credentials_are_very.2C_very_valuable)
  * [Connecting to Amazon S3 or a third-party store](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Connecting_to_Amazon_S3_or_a_third-party_store)
  * [ Authenticating with S3](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Authenticating_with_S3)
  * [Storing secrets with Hadoop Credential Providers](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Storing_secrets_with_Hadoop_Credential_Providers)
    * [Step 1: Create a credential file](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Step_1:_Create_a_credential_file)
    * [Step 2: Configure the hadoop.security.credential.provider.path property](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Step_2:_Configure_the_hadoop.security.credential.provider.path_property)
    * [Using secrets from credential providers](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Using_secrets_from_credential_providers)
  * [General S3A Client configuration](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#General_S3A_Client_configuration)
    * [Configuring Custom Headers for AWS Service Clients](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Configuring_Custom_Headers_for_AWS_Service_Clients)
  * [Retry and Recovery](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Retry_and_Recovery)
    * [Unrecoverable Problems: Fail Fast](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Unrecoverable_Problems:_Fail_Fast)
    * [Possibly Recoverable Problems: Retry](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Possibly_Recoverable_Problems:_Retry)
    * [Only retriable on idempotent operations](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Only_retriable_on_idempotent_operations)
    * [Throttled requests from S3](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Throttled_requests_from_S3)
  * [Handling Read-During-Overwrite](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Handling_Read-During-Overwrite)
    * [Change detection with S3 Versions.](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Change_detection_with_S3_Versions.)
    * [Change Detection Modes.](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Change_Detection_Modes.)
  * [Configuring different S3 buckets with Per-Bucket Configuration](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Configuring_different_S3_buckets_with_Per-Bucket_Configuration)
    * [per-bucket configuration and deprecated configuration options](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#per-bucket_configuration_and_deprecated_configuration_options)
  * [Requester Pays buckets](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Requester_Pays_buckets)
  * [Storage Classes](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Storage_Classes)
  * [Configuring S3A for S3 on Outposts](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Configuring_S3A_for_S3_on_Outposts)
  * [How S3A writes data to S3](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#How_S3A_writes_data_to_S3)
    * [Buffering upload data on disk fs.s3a.fast.upload.buffer=disk](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Buffering_upload_data_on_disk_fs.s3a.fast.upload.buffer.3Ddisk)
    * [Buffering upload data in ByteBuffers: fs.s3a.fast.upload.buffer=bytebuffer](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Buffering_upload_data_in_ByteBuffers:_fs.s3a.fast.upload.buffer.3Dbytebuffer)
    * [Buffering upload data in byte arrays: fs.s3a.fast.upload.buffer=array](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Buffering_upload_data_in_byte_arrays:_fs.s3a.fast.upload.buffer.3Darray)
    * [Upload Thread Tuning](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Upload_Thread_Tuning)
    * [Cleaning up after partial Upload Failures](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Cleaning_up_after_partial_Upload_Failures)
  * [Metrics](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Metrics)
  * [Checksums](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Checksums)
    * [Content-MD5 Header on requests: fs.s3a.request.md5.header](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Content-MD5_Header_on_requests:_fs.s3a.request.md5.header)
    * [Request checksum generation: fs.s3a.checksum.generation](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Request_checksum_generation:_fs.s3a.checksum.generation)
    * [Checksum validation fs.s3a.checksum.validation](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Checksum_validation_fs.s3a.checksum.validation)
    * [Creation checksum fs.s3a.create.checksum.algorithm](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Creation_checksum_fs.s3a.create.checksum.algorithm)
  * [ Other Topics](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Other_Topics)
    * [ Copying Data with distcp](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Copying_Data_with_distcp)
    * [ Advanced - Custom Signers](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#Advanced_-_Custom_Signers)

##  Compatibility
###  Directory Marker Compatibility
This release never delete directory markers when creating files or directories underneath. This is incompatible with versions of the Hadoop S3A client released before 2021.
Consult [S3A and Directory Markers](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/directory_markers.html) for full details.
##  Documents
  * [Connecting](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/connecting.html)
  * [Encryption](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/encryption.html)
  * [Performance](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/performance.html)
  * [The upgrade to AWS Java SDK V2](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/aws_sdk_upgrade.html)
  * [Working with Third-party S3 Stores](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/third_party_stores.html)
  * [Troubleshooting](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/troubleshooting_s3a.html)
  * [Prefetching](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/prefetching.html)
  * [S3A and Directory Markers](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/directory_markers.html).
  * [Auditing](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/auditing.html).
  * [Committing work to S3 with the “S3A Committers”](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/committers.html)
  * [S3A Committers Architecture](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/committer_architecture.html)
  * [Working with IAM Assumed Roles](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/assumed_roles.html)
  * [S3A Delegation Token Support](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/delegation_tokens.html)
  * [S3A Delegation Token Architecture](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/delegation_token_architecture.html).
  * [Auditing Architecture](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/auditing_architecture.html).
  * [Testing](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/testing.html)
  * [S3Guard](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/s3guard.html)
...
To include the S3A client in Apache Hadoop’s default classpath:
  1. Make sure that`HADOOP_OPTIONAL_TOOLS` in `hadoop-env.sh` includes `hadoop-aws` in its list of optional modules to add in the classpath.
...
Hadoop’s “S3A” client offers high-performance IO against Amazon S3 object store and compatible implementations.
  ...
  * Uses Amazon’s Java V2 SDK with support for latest S3 features and authentication schemes.
  ...
  * Supports S3 “Server Side Encryption” for both reading and writing: SSE-S3, SSE-KMS and SSE-C.
...
There other Hadoop connectors to S3. Only S3A is actively maintained by the Hadoop project itself.
  1. Amazon EMR’s `s3://` client. This is from the Amazon EMR team, who actively maintain it.
...
The `hadoop-aws` JAR _does not_ declare any dependencies other than that dependencies unique to it, the AWS SDK JAR. This is simplify excluding/tuning Hadoop dependency JARs in downstream applications. The `hadoop-client` or `hadoop-common` dependency must be declared
...
For further discussion on these topics, please consult [The Hadoop FileSystem API Definition](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-common/filesystem/index.html).
###  Warning #1: Directories are mimicked
The S3A clients mimics directories by:
  1. Creating a stub entry after a `mkdirs` call, deleting it when a file is added anywhere underneath
  2. When listing a directory, searching for all objects whose path starts with the directory path, and returning them as the listing.
  3. When renaming a directory, taking such a listing and asking S3 to copying the individual objects to new objects with the destination filenames.
  4. When deleting a directory, taking such a listing and deleting the entries in batches.
  5. When renaming or deleting directories, taking such a listing and working on the individual files.

Here are some of the consequences:
  * Directories may lack modification times. Parts of Hadoop relying on this can have unexpected behaviour. E.g. the `AggregatedLogDeletionService` of YARN will not remove the appropriate logfiles.
  * Directory listing can be slow. Use `listFiles(path, recursive)` for high performance recursive listings whenever possible.
  * It is possible to create files under files if the caller tries hard.
  * The time to rename a directory is proportional to the number of files underneath it (directory or indirectly) and the size of the files. (The copy is executed inside the S3 storage, so the time is independent of the bandwidth from client to S3).
...
The [S3A committers](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/committers.html) are the sole mechanism available to safely save the output of queries directly into S3 object stores through the S3A filesystem when the filesystem structure is how the table is represented.
...
Do not inadvertently share these credentials through means such as:
  ...
  3. Including the secrets in bug reports.
  4. Logging the `AWS_` environment variables.

If you do any of these: change your credentials immediately!
##  Connecting to Amazon S3 or a third-party store
See [Connecting to an Amazon S3 Bucket through the S3A Connector](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/connecting.html).
Also, please check [S3 endpoint and region settings in detail](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/connecting.html#s3_endpoint_region_details).
##  Authenticating with S3
See [Authenticating with S3](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/authentication.html).
...
The S3A configuration options with sensitive data (`fs.s3a.secret.key`, `fs.s3a.access.key`, `fs.s3a.session.token` and `fs.s3a.encryption.key`) can have their data saved to a binary file stored, with the values being read in when the S3A filesystem URL is used for data access. The reference to this credential provider then declared in the Hadoop configuration.
For additional reading on the Hadoop Credential Provider API see: [Credential Provider API](https://hadoop.apache.org/docs/current3/hadoop-project-dist/hadoop-common/CredentialProviderAPI.html).
The following configuration options can be stored in Hadoop Credential Provider stores.
...
The first three are for authentication; the final two for [encryption](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/encryption.html). Of the latter, only the encryption key can be considered “sensitive”. However, being able to include the algorithm in the credentials allows for a JCECKS file to contain all the options needed to encrypt new data written to S3.
...
The client supports [Per-bucket configuration](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#per_bucket_configuration) to allow different buckets to override the shared settings. This is commonly used to change the endpoint, encryption and authentication mechanisms of buckets. and various minor options.
Here are some the S3A properties for use in production.
  * See [Performance](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/performance.html) for performance related settings including thread and network pool options.
  * Testing-related options are covered in [Testing](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/testing.html).
...
**Configuration Properties:** - `fs.s3a.client.s3.custom.headers`: Custom headers for S3 service requests. - `fs.s3a.client.sts.custom.headers`: Sets custom headers for all requests to AWS STS.
**Header Format:** Custom headers should be specified as key-value pairs, separated by `=`. Multiple values for a single header can be separated by `;`. Multiple headers can be separated by `,`.
...
These failures will be retried with an exponential sleep interval set in `fs.s3a.retry.interval`, up to the limit set in `fs.s3a.retry.limit`.
_Important_ : DELETE is considered idempotent, hence: `FileSystem.delete()` and `FileSystem.rename()` will retry their delete requests on any of these failures.
...
Because S3 is eventually consistent _and_ doesn’t support an atomic create-no-overwrite operation, the choice is more ambiguous.
...
Notes
  ...
  3. Amazon KMS may throttle a customer based on the total rate of uses of KMS _across all user accounts and applications_.
...
In the default configuration, S3 object eTags are used to detect changes. When the filesystem retrieves a file from S3 using [Get Object](https://docs.aws.amazon.com/AmazonS3/latest/API/RESTObjectGET.html), it captures the eTag and uses that eTag in an `If-Match` condition on each subsequent request. If a concurrent writer has overwritten the file, the ‘If-Match’ condition will fail and a `RemoteFileChangedException` will be thrown.
...
##  Storage Classes
Amazon S3 offers a range of [Storage Classes](https://aws.amazon.com/s3/storage-classes/) that you can choose from based on behavior of your applications. By using the right storage class, you can reduce the cost of your bucket.
...
The “fast” output stream
  ...
  5. Uses any checksum set in `fs.s3a.create.checksum.algorithm` to calculate an upload checksum on data written; this is included in the file/part upload and verified on the store. This can be a source of third-party store compatibility issues.
  6. When buffering data to disk, uses the directory/directories listed in `fs.s3a.buffer.dir`. The size of data which can be buffered is limited to the available disk space.
  7. Generates output statistics as metrics on the filesystem, including statistics of active and pending block uploads.
  8. Has the time to `close()` set by the amount of remaining data to upload, rather than the total size of the file.
...
When `fs.s3a.fast.upload.buffer` is set to `bytebuffer`, all data is buffered in “Direct” ByteBuffers prior to upload. This _may_ be faster than buffering to disk, and, if disk space is small (for example, tiny EC2 VMs), there may not be much disk space to buffer with.
...
The slower the upload bandwidth to S3, the greater the risk of running out of memory —and so the more care is needed in [tuning the upload settings](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#upload_thread_tuning).
...
When `fs.s3a.fast.upload.buffer` is set to `array`, all data is buffered in byte arrays in the JVM’s heap prior to upload. This _may_ be faster than buffering to disk.
The amount of data which can be buffered is limited by the available size of the JVM heap. The slower the write bandwidth to S3, the greater the risk of heap overflows. This risk can be mitigated by [tuning the upload settings](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#upload_thread_tuning).
...
Both the [Array](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#upload_array) and [Byte buffer](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#upload_bytebuffer) buffer mechanisms can consume very large amounts of memory, on-heap or off-heap respectively. The [disk buffer](https://hadoop.apache.org/docs/current3/hadoop-aws/tools/hadoop-aws/index.html#upload_disk) mechanism does not use much memory up, but will consume hard disk capacity.
...
There are a number parameters which can be tuned:
  1. The total number of threads available in the filesystem for data uploads _or any other queued filesystem operation_. This is set in `fs.s3a.threads.max`
  2. The number of operations which can be queued for execution:, _awaiting a thread_ : `fs.s3a.max.total.tasks`
...
If an S3A client is instantiated with `fs.s3a.multipart.purge=true`, it will delete all out of date uploads _in the entire bucket_. That is: it will affect all multipart uploads to that bucket, from all applications.
...
Turning on checksum generation and validation may seem like obvious actions, but consider this: you are communicating with an S3 store over an HTTPS channels, which includes cryptographically strong HMAC checksums of every block transmitted. These are far more robust than the CRC* algorithms, and the computational cost is already being paid for: so why add more?
With TLS ensuring the network traffic isn’t altered from the moment it is encrypted to when it is decrypted, all extra checksum generation/validation does is ensure that there’s no accidental corruption between the data being generated and uploaded, or between being downloaded and read.
This could potentially deal with memory/buffering/bus issues on the servers. However this is what ECC RAM is for. If you do suspect requests being corrupted during writing or reading, the options may be worth considering. As it is, they are off by default to avoid compatibility problems.
Note: if you have a real example of where these checksum options have identified memory corruption, please let us know.
...
Should checksums be generated for all requests made to the store?
  ...
  * If `true` then multipart upload (i.e. large file upload) may fail if `fs.s3a.create.checksum.algorithm` is not set to a valid algorithm (i.e. something other than `NONE`).
...
This is only possible through the FileSystem multipart API; normal data writes including those through the magic committer will not encounter it,
##  Other Topics
...
Distcp addresses this by comparing file checksums on the source and destination filesystems, which it tries to do _even if the filesystems have incompatible checksum algorithms_.
