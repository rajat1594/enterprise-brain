[ ![](https://spark.apache.org/images/spark-logo-rev.svg)](https://spark.apache.org/docs/latest/index.html)4.1.2
  ...
  * [Programming Guides](https://spark.apache.org/docs/latest/sql-migration-guide.html)
[Quick Start](https://spark.apache.org/docs/latest/quick-start.html) [RDDs, Accumulators, Broadcasts Vars](https://spark.apache.org/docs/latest/rdd-programming-guide.html) [SQL, DataFrames, and Datasets](https://spark.apache.org/docs/latest/sql-programming-guide.html) [Structured Streaming](https://spark.apache.org/docs/latest/streaming/index.html) [Spark Streaming (DStreams)](https://spark.apache.org/docs/latest/streaming-programming-guide.html) [MLlib (Machine Learning)](https://spark.apache.org/docs/latest/ml-guide.html) [GraphX (Graph Processing)](https://spark.apache.org/docs/latest/graphx-programming-guide.html) [SparkR (R on Spark)](https://spark.apache.org/docs/latest/sparkr.html) [PySpark (Python on Spark)](https://spark.apache.org/docs/latest/api/python/getting_started/index.html) [Declarative Pipelines](https://spark.apache.org/docs/latest/declarative-pipelines-programming-guide.html)
  * [API Docs](https://spark.apache.org/docs/latest/sql-migration-guide.html)
[Python](https://spark.apache.org/docs/latest/api/python/index.html) [Scala](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/index.html) [Java](https://spark.apache.org/docs/latest/api/java/index.html) [R](https://spark.apache.org/docs/latest/api/R/index.html) [SQL, Built-in Functions](https://spark.apache.org/docs/latest/api/sql/index.html)
  * [Deploying](https://spark.apache.org/docs/latest/sql-migration-guide.html)
[Overview](https://spark.apache.org/docs/latest/cluster-overview.html) [Submitting Applications](https://spark.apache.org/docs/latest/submitting-applications.html) [Spark Standalone](https://spark.apache.org/docs/latest/spark-standalone.html) [YARN](https://spark.apache.org/docs/latest/running-on-yarn.html) [Kubernetes](https://spark.apache.org/docs/latest/running-on-kubernetes.html)
  * [More](https://spark.apache.org/docs/latest/sql-migration-guide.html)
...
###  [Spark SQL Guide](https://spark.apache.org/docs/latest/sql-programming-guide.html)[](https://spark.apache.org/docs/latest/sql-migration-guide.html#spark-sql-guide)
...
# Migration Guide: SQL, Datasets and DataFrame[](https://spark.apache.org/docs/latest/sql-migration-guide.html#migration-guide-sql-datasets-and-dataframe)
  * [Upgrading from Spark SQL 4.0 to 4.1](https://spark.apache.org/docs/latest/sql-migration-guide.html#upgrading-from-spark-sql-40-to-41)
  * [Upgrading from Spark SQL 3.5 to 4.0](https://spark.apache.org/docs/latest/sql-migration-guide.html#upgrading-from-spark-sql-35-to-40)
  * [Upgrading from Spark SQL 3.5.3 to 3.5.4](https://spark.apache.org/docs/latest/sql-migration-guide.html#upgrading-from-spark-sql-353-to-354)
  * [Upgrading from Spark SQL 3.5.1 to 3.5.2](https://spark.apache.org/docs/latest/sql-migration-guide.html#upgrading-from-spark-sql-351-to-352)
  * [Upgrading from Spark SQL 3.5.0 to 3.5.1](https://spark.apache.org/docs/latest/sql-migration-guide.html#upgrading-from-spark-sql-350-to-351)
  * [Upgrading from Spark SQL 3.4 to 3.5](https://spark.apache.org/docs/latest/sql-migration-guide.html#upgrading-from-spark-sql-34-to-35)
  * [Upgrading from Spark SQL 3.3 to 3.4](https://spark.apache.org/docs/latest/sql-migration-guide.html#upgrading-from-spark-sql-33-to-34)
  ...
  * [Upgrading from Spark SQL 3.0.1 to 3.0.2](https://spark.apache.org/docs/latest/sql-migration-guide.html#upgrading-from-spark-sql-301-to-302)
  * [Upgrading from Spark SQL 3.0 to 3.0.1](https://spark.apache.org/docs/latest/sql-migration-guide.html#upgrading-from-spark-sql-30-to-301)
  * [Upgrading from Spark SQL 2.4 to 3.0](https://spark.apache.org/docs/latest/sql-migration-guide.html#upgrading-from-spark-sql-24-to-30)
    * [Dataset/DataFrame APIs](https://spark.apache.org/docs/latest/sql-migration-guide.html#datasetdataframe-apis)
    * [DDL Statements](https://spark.apache.org/docs/latest/sql-migration-guide.html#ddl-statements)
    * [UDFs and Built-in Functions](https://spark.apache.org/docs/latest/sql-migration-guide.html#udfs-and-built-in-functions)
    * [Query Engine](https://spark.apache.org/docs/latest/sql-migration-guide.html#query-engine)
    * [Data Sources](https://spark.apache.org/docs/latest/sql-migration-guide.html#data-sources)
    * [Others](https://spark.apache.org/docs/latest/sql-migration-guide.html#others)
  * [Upgrading from Spark SQL 2.4.7 to 2.4.8](https://spark.apache.org/docs/latest/sql-migration-guide.html#upgrading-from-spark-sql-247-to-248)
  * [Upgrading from Spark SQL 2.4.5 to 2.4.6](https://spark.apache.org/docs/latest/sql-migration-guide.html#upgrading-from-spark-sql-245-to-246)
  * [Upgrading from Spark SQL 2.4.4 to 2.4.5](https://spark.apache.org/docs/latest/sql-migration-guide.html#upgrading-from-spark-sql-244-to-245)
  * [Upgrading from Spark SQL 2.4.3 to 2.4.4](https://spark.apache.org/docs/latest/sql-migration-guide.html#upgrading-from-spark-sql-243-to-244)
  * [Upgrading from Spark SQL 2.4 to 2.4.1](https://spark.apache.org/docs/latest/sql-migration-guide.html#upgrading-from-spark-sql-24-to-241)
  ...
  * [Upgrading from Spark SQL 2.1 to 2.2](https://spark.apache.org/docs/latest/sql-migration-guide.html#upgrading-from-spark-sql-21-to-22)
  * [Upgrading from Spark SQL 2.0 to 2.1](https://spark.apache.org/docs/latest/sql-migration-guide.html#upgrading-from-spark-sql-20-to-21)
  * [Upgrading from Spark SQL 1.6 to 2.0](https://spark.apache.org/docs/latest/sql-migration-guide.html#upgrading-from-spark-sql-16-to-20)
  * [Upgrading from Spark SQL 1.5 to 1.6](https://spark.apache.org/docs/latest/sql-migration-guide.html#upgrading-from-spark-sql-15-to-16)
  * [Upgrading from Spark SQL 1.4 to 1.5](https://spark.apache.org/docs/latest/sql-migration-guide.html#upgrading-from-spark-sql-14-to-15)
  * [Upgrading from Spark SQL 1.3 to 1.4](https://spark.apache.org/docs/latest/sql-migration-guide.html#upgrading-from-spark-sql-13-to-14)
  * [Upgrading from Spark SQL 1.0-1.2 to 1.3](https://spark.apache.org/docs/latest/sql-migration-guide.html#upgrading-from-spark-sql-10-12-to-13)
  * [Compatibility with Apache Hive](https://spark.apache.org/docs/latest/sql-migration-guide.html#compatibility-with-apache-hive)
...
Note that, for **DecimalType(38,0)*** , the table above intentionally does not cover all other combinations of scales and precisions because currently we only infer decimal type like `BigInteger`/`BigInt`. For example, 1.1 is inferred as double type.
  * Since Spark 2.3, when either broadcast hash join or broadcast nested loop join is applicable, we prefer to broadcasting the table that is explicitly specified in a broadcast hint. For details, see the section [Join Strategy Hints for SQL Queries](https://spark.apache.org/docs/latest/sql-performance-tuning.html#join-strategy-hints-for-sql-queries) and [SPARK-22489](https://issues.apache.org/jira/browse/SPARK-22489).
...
## Upgrading from Spark SQL 1.3 to 1.4[](https://spark.apache.org/docs/latest/sql-migration-guide.html#upgrading-from-spark-sql-13-to-14)
#### DataFrame data reader/writer interface[](https://spark.apache.org/docs/latest/sql-migration-guide.html#dataframe-data-readerwriter-interface)
...
See the API docs for `SQLContext.read` ( [Scala](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/sql/SQLContext.html#read:DataFrameReader), [Java](https://spark.apache.org/docs/latest/api/java/org/apache/spark/sql/SQLContext.html#read\(\)), [Python](https://spark.apache.org/docs/latest/api/python/reference/pyspark.sql/api/pyspark.sql.SparkSession.read.html#pyspark.sql.SparkSession.read) ) and `DataFrame.write` ( [Scala](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/sql/DataFrame.html#write:DataFrameWriter), [Java](https://spark.apache.org/docs/latest/api/java/org/apache/spark/sql/Dataset.html#write\(\)), [Python](https://spark.apache.org/docs/latest/api/python/reference/pyspark.sql/api/pyspark.sql.DataFrame.write.html#pyspark.sql.DataFrame.write) ) more information.
#### DataFrame.groupBy retains grouping columns[](https://spark.apache.org/docs/latest/sql-migration-guide.html#dataframegroupby-retains-grouping-columns)
...
#### Behavior change on DataFrame.withColumn[](https://spark.apache.org/docs/latest/sql-migration-guide.html#behavior-change-on-dataframewithcolumn)
...
#### Rename of SchemaRDD to DataFrame[](https://spark.apache.org/docs/latest/sql-migration-guide.html#rename-of-schemardd-to-dataframe)
...
#### Unification of the Java and Scala APIs[](https://spark.apache.org/docs/latest/sql-migration-guide.html#unification-of-the-java-and-scala-apis)
...
#### Isolation of Implicit Conversions and Removal of dsl Package (Scala-only)[](https://spark.apache.org/docs/latest/sql-migration-guide.html#isolation-of-implicit-conversions-and-removal-of-dsl-package-scala-only)
...
#### Removal of the type aliases in org.apache.spark.sql for DataType (Scala-only)[](https://spark.apache.org/docs/latest/sql-migration-guide.html#removal-of-the-type-aliases-in-orgapachesparksql-for-datatype-scala-only)
...
#### UDF Registration Moved to `sqlContext.udf` (Java & Scala)[](https://spark.apache.org/docs/latest/sql-migration-guide.html#udf-registration-moved-to-sqlcontextudf-java--scala)
...
### Supported Hive Features[](https://spark.apache.org/docs/latest/sql-migration-guide.html#supported-hive-features)
...
### Unsupported Hive Functionality[](https://spark.apache.org/docs/latest/sql-migration-guide.html#unsupported-hive-functionality)
...
### Incompatible Hive UDF[](https://spark.apache.org/docs/latest/sql-migration-guide.html#incompatible-hive-udf)
