[Skip to contents](https://spark.apache.org/docs/latest/api/R/reference/spark.als.html#main)
[ ![](https://spark.apache.org/images/spark-logo-rev.svg)](https://spark.apache.org/) [SparkR](https://spark.apache.org/docs/latest/api/R/index.html) 4.1.2
  ...
  * [Articles](https://spark.apache.org/docs/latest/api/R/reference/spark.als.html)
[SparkR - Practical Guide](https://spark.apache.org/docs/latest/api/R/articles/sparkr-vignettes.html)

  *

![](https://spark.apache.org/docs/latest/api/R/reference/spark.als.html)
...
## Usage[](https://spark.apache.org/docs/latest/api/R/reference/spark.als.html#ref-usage)
...
## Arguments[](https://spark.apache.org/docs/latest/api/R/reference/spark.als.html#arguments)
...
## Value[](https://spark.apache.org/docs/latest/api/R/reference/spark.als.html#value)
`spark.als` returns a fitted ALS model. `summary` returns summary information of the fitted model, which is a list. The list includes `user` (the names of the user column), `item` (the item column), `rating` (the rating column), `userFactors` (the estimated user factors), `itemFactors` (the estimated item factors), and `rank` (rank of the matrix factorization model). `predict` returns a SparkDataFrame containing predicted values.
## Details[](https://spark.apache.org/docs/latest/api/R/reference/spark.als.html#details)
For more details, see [MLlib: Collaborative Filtering](https://spark.apache.org/docs/latest/ml-collaborative-filtering.html).
## Note[](https://spark.apache.org/docs/latest/api/R/reference/spark.als.html#note)
...
## See also[](https://spark.apache.org/docs/latest/api/R/reference/spark.als.html#see-also)
[read.ml](https://spark.apache.org/docs/latest/api/R/reference/read.ml.html)
## Examples[](https://spark.apache.org/docs/latest/api/R/reference/spark.als.html#ref-examples)
...
statsS <- summary[](https://spark.apache.org/docs/latest/api/R/reference/summary.html)(modelS)
}
