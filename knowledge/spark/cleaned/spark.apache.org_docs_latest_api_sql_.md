[ Spark SQL, Built-in Functions ](https://spark.apache.org/docs/latest/api/sql/)
  * [Functions](https://spark.apache.org/docs/latest/api/sql/)
    ...
    * [%](https://spark.apache.org/docs/latest/api/sql/#_3)
    * [&](https://spark.apache.org/docs/latest/api/sql/#_4)
    * [*](https://spark.apache.org/docs/latest/api/sql/#_5)
    * [+](https://spark.apache.org/docs/latest/api/sql/#_6)
    * [-](https://spark.apache.org/docs/latest/api/sql/#-)
    * [/](https://spark.apache.org/docs/latest/api/sql/#_7)
    ...
    * [>=](https://spark.apache.org/docs/latest/api/sql/#_16)
    * [>>](https://spark.apache.org/docs/latest/api/sql/#_17)
    * [>>>](https://spark.apache.org/docs/latest/api/sql/#_18)
    * [^](https://spark.apache.org/docs/latest/api/sql/#_19)
    * [abs](https://spark.apache.org/docs/latest/api/sql/#abs)
    * [acos](https://spark.apache.org/docs/latest/api/sql/#acos)
    * [acosh](https://spark.apache.org/docs/latest/api/sql/#acosh)
    * [add_months](https://spark.apache.org/docs/latest/api/sql/#add_months)
    * [aes_decrypt](https://spark.apache.org/docs/latest/api/sql/#aes_decrypt)
    * [aes_encrypt](https://spark.apache.org/docs/latest/api/sql/#aes_encrypt)
    * [aggregate](https://spark.apache.org/docs/latest/api/sql/#aggregate)
    * [and](https://spark.apache.org/docs/latest/api/sql/#and)
    * [any](https://spark.apache.org/docs/latest/api/sql/#any)
    * [any_value](https://spark.apache.org/docs/latest/api/sql/#any_value)
    * [approx_count_distinct](https://spark.apache.org/docs/latest/api/sql/#approx_count_distinct)
    * [approx_percentile](https://spark.apache.org/docs/latest/api/sql/#approx_percentile)
    * [approx_top_k](https://spark.apache.org/docs/latest/api/sql/#approx_top_k)
    * [approx_top_k_accumulate](https://spark.apache.org/docs/latest/api/sql/#approx_top_k_accumulate)
    * [approx_top_k_combine](https://spark.apache.org/docs/latest/api/sql/#approx_top_k_combine)
    * [approx_top_k_estimate](https://spark.apache.org/docs/latest/api/sql/#approx_top_k_estimate)
    * [array](https://spark.apache.org/docs/latest/api/sql/#array)
    * [array_agg](https://spark.apache.org/docs/latest/api/sql/#array_agg)
    * [array_append](https://spark.apache.org/docs/latest/api/sql/#array_append)
    * [array_compact](https://spark.apache.org/docs/latest/api/sql/#array_compact)
    * [array_contains](https://spark.apache.org/docs/latest/api/sql/#array_contains)
    * [array_distinct](https://spark.apache.org/docs/latest/api/sql/#array_distinct)
    * [array_except](https://spark.apache.org/docs/latest/api/sql/#array_except)
    * [array_insert](https://spark.apache.org/docs/latest/api/sql/#array_insert)
    * [array_intersect](https://spark.apache.org/docs/latest/api/sql/#array_intersect)
    * [array_join](https://spark.apache.org/docs/latest/api/sql/#array_join)
    * [array_max](https://spark.apache.org/docs/latest/api/sql/#array_max)
    * [array_min](https://spark.apache.org/docs/latest/api/sql/#array_min)
    * [array_position](https://spark.apache.org/docs/latest/api/sql/#array_position)
    * [array_prepend](https://spark.apache.org/docs/latest/api/sql/#array_prepend)
    * [array_remove](https://spark.apache.org/docs/latest/api/sql/#array_remove)
    * [array_repeat](https://spark.apache.org/docs/latest/api/sql/#array_repeat)
    * [array_size](https://spark.apache.org/docs/latest/api/sql/#array_size)
    * [array_sort](https://spark.apache.org/docs/latest/api/sql/#array_sort)
    * [array_union](https://spark.apache.org/docs/latest/api/sql/#array_union)
    * [arrays_overlap](https://spark.apache.org/docs/latest/api/sql/#arrays_overlap)
    * [arrays_zip](https://spark.apache.org/docs/latest/api/sql/#arrays_zip)
    * [ascii](https://spark.apache.org/docs/latest/api/sql/#ascii)
    * [asin](https://spark.apache.org/docs/latest/api/sql/#asin)
    * [asinh](https://spark.apache.org/docs/latest/api/sql/#asinh)
    * [assert_true](https://spark.apache.org/docs/latest/api/sql/#assert_true)
    * [atan](https://spark.apache.org/docs/latest/api/sql/#atan)
    * [atan2](https://spark.apache.org/docs/latest/api/sql/#atan2)
    * [atanh](https://spark.apache.org/docs/latest/api/sql/#atanh)
    * [avg](https://spark.apache.org/docs/latest/api/sql/#avg)
    * [base64](https://spark.apache.org/docs/latest/api/sql/#base64)
    * [between](https://spark.apache.org/docs/latest/api/sql/#between)
    * [bigint](https://spark.apache.org/docs/latest/api/sql/#bigint)
    * [bin](https://spark.apache.org/docs/latest/api/sql/#bin)
    * [binary](https://spark.apache.org/docs/latest/api/sql/#binary)
    * [bit_and](https://spark.apache.org/docs/latest/api/sql/#bit_and)
    * [bit_count](https://spark.apache.org/docs/latest/api/sql/#bit_count)
    * [bit_get](https://spark.apache.org/docs/latest/api/sql/#bit_get)
    * [bit_length](https://spark.apache.org/docs/latest/api/sql/#bit_length)
    * [bit_or](https://spark.apache.org/docs/latest/api/sql/#bit_or)
    * [bit_xor](https://spark.apache.org/docs/latest/api/sql/#bit_xor)
    * [bitmap_and_agg](https://spark.apache.org/docs/latest/api/sql/#bitmap_and_agg)
    * [bitmap_bit_position](https://spark.apache.org/docs/latest/api/sql/#bitmap_bit_position)
    * [bitmap_bucket_number](https://spark.apache.org/docs/latest/api/sql/#bitmap_bucket_number)
    * [bitmap_construct_agg](https://spark.apache.org/docs/latest/api/sql/#bitmap_construct_agg)
    * [bitmap_count](https://spark.apache.org/docs/latest/api/sql/#bitmap_count)
    * [bitmap_or_agg](https://spark.apache.org/docs/latest/api/sql/#bitmap_or_agg)
    * [bool_and](https://spark.apache.org/docs/latest/api/sql/#bool_and)
    * [bool_or](https://spark.apache.org/docs/latest/api/sql/#bool_or)
    * [boolean](https://spark.apache.org/docs/latest/api/sql/#boolean)
    * [bround](https://spark.apache.org/docs/latest/api/sql/#bround)
    * [btrim](https://spark.apache.org/docs/latest/api/sql/#btrim)
    * [cardinality](https://spark.apache.org/docs/latest/api/sql/#cardinality)
    * [case](https://spark.apache.org/docs/latest/api/sql/#case)
    * [cast](https://spark.apache.org/docs/latest/api/sql/#cast)
    * [cbrt](https://spark.apache.org/docs/latest/api/sql/#cbrt)
    * [ceil](https://spark.apache.org/docs/latest/api/sql/#ceil)
    * [ceiling](https://spark.apache.org/docs/latest/api/sql/#ceiling)
    * [char](https://spark.apache.org/docs/latest/api/sql/#char)
    * [char_length](https://spark.apache.org/docs/latest/api/sql/#char_length)
    * [character_length](https://spark.apache.org/docs/latest/api/sql/#character_length)
    * [chr](https://spark.apache.org/docs/latest/api/sql/#chr)
    * [coalesce](https://spark.apache.org/docs/latest/api/sql/#coalesce)
    * [collate](https://spark.apache.org/docs/latest/api/sql/#collate)
    * [collation](https://spark.apache.org/docs/latest/api/sql/#collation)
    * [collations](https://spark.apache.org/docs/latest/api/sql/#collations)
    * [collect_list](https://spark.apache.org/docs/latest/api/sql/#collect_list)
    * [collect_set](https://spark.apache.org/docs/latest/api/sql/#collect_set)
    * [concat](https://spark.apache.org/docs/latest/api/sql/#concat)
    * [concat_ws](https://spark.apache.org/docs/latest/api/sql/#concat_ws)
    * [contains](https://spark.apache.org/docs/latest/api/sql/#contains)
    * [conv](https://spark.apache.org/docs/latest/api/sql/#conv)
    * [convert_timezone](https://spark.apache.org/docs/latest/api/sql/#convert_timezone)
    * [corr](https://spark.apache.org/docs/latest/api/sql/#corr)
    * [cos](https://spark.apache.org/docs/latest/api/sql/#cos)
    * [cosh](https://spark.apache.org/docs/latest/api/sql/#cosh)
    * [cot](https://spark.apache.org/docs/latest/api/sql/#cot)
    * [count](https://spark.apache.org/docs/latest/api/sql/#count)
    * [count_if](https://spark.apache.org/docs/latest/api/sql/#count_if)
    * [count_min_sketch](https://spark.apache.org/docs/latest/api/sql/#count_min_sketch)
    * [covar_pop](https://spark.apache.org/docs/latest/api/sql/#covar_pop)
    * [covar_samp](https://spark.apache.org/docs/latest/api/sql/#covar_samp)
    * [crc32](https://spark.apache.org/docs/latest/api/sql/#crc32)
    * [csc](https://spark.apache.org/docs/latest/api/sql/#csc)
    * [cume_dist](https://spark.apache.org/docs/latest/api/sql/#cume_dist)
    * [curdate](https://spark.apache.org/docs/latest/api/sql/#curdate)
    * [current_catalog](https://spark.apache.org/docs/latest/api/sql/#current_catalog)
    * [current_database](https://spark.apache.org/docs/latest/api/sql/#current_database)
    * [current_date](https://spark.apache.org/docs/latest/api/sql/#current_date)
    * [current_schema](https://spark.apache.org/docs/latest/api/sql/#current_schema)
    * [current_time](https://spark.apache.org/docs/latest/api/sql/#current_time)
    * [current_timestamp](https://spark.apache.org/docs/latest/api/sql/#current_timestamp)
    * [current_timezone](https://spark.apache.org/docs/latest/api/sql/#current_timezone)
    * [current_user](https://spark.apache.org/docs/latest/api/sql/#current_user)
    * [date](https://spark.apache.org/docs/latest/api/sql/#date)
    * [date_add](https://spark.apache.org/docs/latest/api/sql/#date_add)
    * [date_diff](https://spark.apache.org/docs/latest/api/sql/#date_diff)
    * [date_format](https://spark.apache.org/docs/latest/api/sql/#date_format)
    * [date_from_unix_date](https://spark.apache.org/docs/latest/api/sql/#date_from_unix_date)
    * [date_part](https://spark.apache.org/docs/latest/api/sql/#date_part)
    * [date_sub](https://spark.apache.org/docs/latest/api/sql/#date_sub)
    * [date_trunc](https://spark.apache.org/docs/latest/api/sql/#date_trunc)
    * [dateadd](https://spark.apache.org/docs/latest/api/sql/#dateadd)
    * [datediff](https://spark.apache.org/docs/latest/api/sql/#datediff)
    * [datepart](https://spark.apache.org/docs/latest/api/sql/#datepart)
    * [day](https://spark.apache.org/docs/latest/api/sql/#day)
    * [dayname](https://spark.apache.org/docs/latest/api/sql/#dayname)
    * [dayofmonth](https://spark.apache.org/docs/latest/api/sql/#dayofmonth)
    * [dayofweek](https://spark.apache.org/docs/latest/api/sql/#dayofweek)
    * [dayofyear](https://spark.apache.org/docs/latest/api/sql/#dayofyear)
    * [decimal](https://spark.apache.org/docs/latest/api/sql/#decimal)
    * [decode](https://spark.apache.org/docs/latest/api/sql/#decode)
    * [degrees](https://spark.apache.org/docs/latest/api/sql/#degrees)
    * [dense_rank](https://spark.apache.org/docs/latest/api/sql/#dense_rank)
    * [div](https://spark.apache.org/docs/latest/api/sql/#div)
    * [double](https://spark.apache.org/docs/latest/api/sql/#double)
    * [e](https://spark.apache.org/docs/latest/api/sql/#e)
    * [element_at](https://spark.apache.org/docs/latest/api/sql/#element_at)
    * [elt](https://spark.apache.org/docs/latest/api/sql/#elt)
    * [encode](https://spark.apache.org/docs/latest/api/sql/#encode)
    * [endswith](https://spark.apache.org/docs/latest/api/sql/#endswith)
    * [equal_null](https://spark.apache.org/docs/latest/api/sql/#equal_null)
    * [every](https://spark.apache.org/docs/latest/api/sql/#every)
    * [exists](https://spark.apache.org/docs/latest/api/sql/#exists)
    * [exp](https://spark.apache.org/docs/latest/api/sql/#exp)
    * [explode](https://spark.apache.org/docs/latest/api/sql/#explode)
    * [explode_outer](https://spark.apache.org/docs/latest/api/sql/#explode_outer)
    * [expm1](https://spark.apache.org/docs/latest/api/sql/#expm1)
    * [extract](https://spark.apache.org/docs/latest/api/sql/#extract)
    * [factorial](https://spark.apache.org/docs/latest/api/sql/#factorial)
    * [filter](https://spark.apache.org/docs/latest/api/sql/#filter)
    * [find_in_set](https://spark.apache.org/docs/latest/api/sql/#find_in_set)
    * [first](https://spark.apache.org/docs/latest/api/sql/#first)
    * [first_value](https://spark.apache.org/docs/latest/api/sql/#first_value)
    * [flatten](https://spark.apache.org/docs/latest/api/sql/#flatten)
    * [float](https://spark.apache.org/docs/latest/api/sql/#float)
    * [floor](https://spark.apache.org/docs/latest/api/sql/#floor)
    * [forall](https://spark.apache.org/docs/latest/api/sql/#forall)
    * [format_number](https://spark.apache.org/docs/latest/api/sql/#format_number)
    * [format_string](https://spark.apache.org/docs/latest/api/sql/#format_string)
    * [from_avro](https://spark.apache.org/docs/latest/api/sql/#from_avro)
    * [from_csv](https://spark.apache.org/docs/latest/api/sql/#from_csv)
    * [from_json](https://spark.apache.org/docs/latest/api/sql/#from_json)
    * [from_protobuf](https://spark.apache.org/docs/latest/api/sql/#from_protobuf)
    * [from_unixtime](https://spark.apache.org/docs/latest/api/sql/#from_unixtime)
    * [from_utc_timestamp](https://spark.apache.org/docs/latest/api/sql/#from_utc_timestamp)
    * [from_xml](https://spark.apache.org/docs/latest/api/sql/#from_xml)
    * [get](https://spark.apache.org/docs/latest/api/sql/#get)
    * [get_json_object](https://spark.apache.org/docs/latest/api/sql/#get_json_object)
    * [getbit](https://spark.apache.org/docs/latest/api/sql/#getbit)
    * [greatest](https://spark.apache.org/docs/latest/api/sql/#greatest)
    * [grouping](https://spark.apache.org/docs/latest/api/sql/#grouping)
    * [grouping_id](https://spark.apache.org/docs/latest/api/sql/#grouping_id)
    * [hash](https://spark.apache.org/docs/latest/api/sql/#hash)
    * [hex](https://spark.apache.org/docs/latest/api/sql/#hex)
    * [histogram_numeric](https://spark.apache.org/docs/latest/api/sql/#histogram_numeric)
    * [hll_sketch_agg](https://spark.apache.org/docs/latest/api/sql/#hll_sketch_agg)
    * [hll_sketch_estimate](https://spark.apache.org/docs/latest/api/sql/#hll_sketch_estimate)
    * [hll_union](https://spark.apache.org/docs/latest/api/sql/#hll_union)
    * [hll_union_agg](https://spark.apache.org/docs/latest/api/sql/#hll_union_agg)
    * [hour](https://spark.apache.org/docs/latest/api/sql/#hour)
    * [hypot](https://spark.apache.org/docs/latest/api/sql/#hypot)
    * [if](https://spark.apache.org/docs/latest/api/sql/#if)
    * [ifnull](https://spark.apache.org/docs/latest/api/sql/#ifnull)
    * [ilike](https://spark.apache.org/docs/latest/api/sql/#ilike)
    * [in](https://spark.apache.org/docs/latest/api/sql/#in)
    * [initcap](https://spark.apache.org/docs/latest/api/sql/#initcap)
    * [inline](https://spark.apache.org/docs/latest/api/sql/#inline)
    * [inline_outer](https://spark.apache.org/docs/latest/api/sql/#inline_outer)
    * [input_file_block_length](https://spark.apache.org/docs/latest/api/sql/#input_file_block_length)
    * [input_file_block_start](https://spark.apache.org/docs/latest/api/sql/#input_file_block_start)
    * [input_file_name](https://spark.apache.org/docs/latest/api/sql/#input_file_name)
    * [instr](https://spark.apache.org/docs/latest/api/sql/#instr)
    * [int](https://spark.apache.org/docs/latest/api/sql/#int)
    * [is_valid_utf8](https://spark.apache.org/docs/latest/api/sql/#is_valid_utf8)
    * [is_variant_null](https://spark.apache.org/docs/latest/api/sql/#is_variant_null)
    * [isnan](https://spark.apache.org/docs/latest/api/sql/#isnan)
    * [isnotnull](https://spark.apache.org/docs/latest/api/sql/#isnotnull)
    * [isnull](https://spark.apache.org/docs/latest/api/sql/#isnull)
    * [java_method](https://spark.apache.org/docs/latest/api/sql/#java_method)
    * [json_array_length](https://spark.apache.org/docs/latest/api/sql/#json_array_length)
    * [json_object_keys](https://spark.apache.org/docs/latest/api/sql/#json_object_keys)
    * [json_tuple](https://spark.apache.org/docs/latest/api/sql/#json_tuple)
    * [kll_merge_agg_bigint](https://spark.apache.org/docs/latest/api/sql/#kll_merge_agg_bigint)
    * [kll_merge_agg_double](https://spark.apache.org/docs/latest/api/sql/#kll_merge_agg_double)
    * [kll_merge_agg_float](https://spark.apache.org/docs/latest/api/sql/#kll_merge_agg_float)
    * [kll_sketch_agg_bigint](https://spark.apache.org/docs/latest/api/sql/#kll_sketch_agg_bigint)
    * [kll_sketch_agg_double](https://spark.apache.org/docs/latest/api/sql/#kll_sketch_agg_double)
    * [kll_sketch_agg_float](https://spark.apache.org/docs/latest/api/sql/#kll_sketch_agg_float)
    * [kll_sketch_get_n_bigint](https://spark.apache.org/docs/latest/api/sql/#kll_sketch_get_n_bigint)
    * [kll_sketch_get_n_double](https://spark.apache.org/docs/latest/api/sql/#kll_sketch_get_n_double)
    * [kll_sketch_get_n_float](https://spark.apache.org/docs/latest/api/sql/#kll_sketch_get_n_float)
    * [kll_sketch_get_quantile_bigint](https://spark.apache.org/docs/latest/api/sql/#kll_sketch_get_quantile_bigint)
    * [kll_sketch_get_quantile_double](https://spark.apache.org/docs/latest/api/sql/#kll_sketch_get_quantile_double)
    * [kll_sketch_get_quantile_float](https://spark.apache.org/docs/latest/api/sql/#kll_sketch_get_quantile_float)
    * [kll_sketch_get_rank_bigint](https://spark.apache.org/docs/latest/api/sql/#kll_sketch_get_rank_bigint)
    * [kll_sketch_get_rank_double](https://spark.apache.org/docs/latest/api/sql/#kll_sketch_get_rank_double)
    * [kll_sketch_get_rank_float](https://spark.apache.org/docs/latest/api/sql/#kll_sketch_get_rank_float)
    * [kll_sketch_merge_bigint](https://spark.apache.org/docs/latest/api/sql/#kll_sketch_merge_bigint)
    * [kll_sketch_merge_double](https://spark.apache.org/docs/latest/api/sql/#kll_sketch_merge_double)
    * [kll_sketch_merge_float](https://spark.apache.org/docs/latest/api/sql/#kll_sketch_merge_float)
    * [kll_sketch_to_string_bigint](https://spark.apache.org/docs/latest/api/sql/#kll_sketch_to_string_bigint)
    * [kll_sketch_to_string_double](https://spark.apache.org/docs/latest/api/sql/#kll_sketch_to_string_double)
    * [kll_sketch_to_string_float](https://spark.apache.org/docs/latest/api/sql/#kll_sketch_to_string_float)
    * [kurtosis](https://spark.apache.org/docs/latest/api/sql/#kurtosis)
    * [lag](https://spark.apache.org/docs/latest/api/sql/#lag)
    * [last](https://spark.apache.org/docs/latest/api/sql/#last)
    * [last_day](https://spark.apache.org/docs/latest/api/sql/#last_day)
    * [last_value](https://spark.apache.org/docs/latest/api/sql/#last_value)
    * [lcase](https://spark.apache.org/docs/latest/api/sql/#lcase)
    * [lead](https://spark.apache.org/docs/latest/api/sql/#lead)
    * [least](https://spark.apache.org/docs/latest/api/sql/#least)
    * [left](https://spark.apache.org/docs/latest/api/sql/#left)
    * [len](https://spark.apache.org/docs/latest/api/sql/#len)
    * [length](https://spark.apache.org/docs/latest/api/sql/#length)
    * [levenshtein](https://spark.apache.org/docs/latest/api/sql/#levenshtein)
    * [like](https://spark.apache.org/docs/latest/api/sql/#like)
    * [listagg](https://spark.apache.org/docs/latest/api/sql/#listagg)
    * [ln](https://spark.apache.org/docs/latest/api/sql/#ln)
    * [localtimestamp](https://spark.apache.org/docs/latest/api/sql/#localtimestamp)
    * [locate](https://spark.apache.org/docs/latest/api/sql/#locate)
    * [log](https://spark.apache.org/docs/latest/api/sql/#log)
    * [log10](https://spark.apache.org/docs/latest/api/sql/#log10)
    * [log1p](https://spark.apache.org/docs/latest/api/sql/#log1p)
    * [log2](https://spark.apache.org/docs/latest/api/sql/#log2)
    * [lower](https://spark.apache.org/docs/latest/api/sql/#lower)
    * [lpad](https://spark.apache.org/docs/latest/api/sql/#lpad)
    * [ltrim](https://spark.apache.org/docs/latest/api/sql/#ltrim)
    * [luhn_check](https://spark.apache.org/docs/latest/api/sql/#luhn_check)
    * [make_date](https://spark.apache.org/docs/latest/api/sql/#make_date)
    * [make_dt_interval](https://spark.apache.org/docs/latest/api/sql/#make_dt_interval)
    * [make_interval](https://spark.apache.org/docs/latest/api/sql/#make_interval)
    * [make_time](https://spark.apache.org/docs/latest/api/sql/#make_time)
    * [make_timestamp](https://spark.apache.org/docs/latest/api/sql/#make_timestamp)
    * [make_timestamp_ltz](https://spark.apache.org/docs/latest/api/sql/#make_timestamp_ltz)
    * [make_timestamp_ntz](https://spark.apache.org/docs/latest/api/sql/#make_timestamp_ntz)
    * [make_valid_utf8](https://spark.apache.org/docs/latest/api/sql/#make_valid_utf8)
    * [make_ym_interval](https://spark.apache.org/docs/latest/api/sql/#make_ym_interval)
    * [map](https://spark.apache.org/docs/latest/api/sql/#map)
    * [map_concat](https://spark.apache.org/docs/latest/api/sql/#map_concat)
    * [map_contains_key](https://spark.apache.org/docs/latest/api/sql/#map_contains_key)
    * [map_entries](https://spark.apache.org/docs/latest/api/sql/#map_entries)
    * [map_filter](https://spark.apache.org/docs/latest/api/sql/#map_filter)
    * [map_from_arrays](https://spark.apache.org/docs/latest/api/sql/#map_from_arrays)
    * [map_from_entries](https://spark.apache.org/docs/latest/api/sql/#map_from_entries)
    * [map_keys](https://spark.apache.org/docs/latest/api/sql/#map_keys)
    * [map_values](https://spark.apache.org/docs/latest/api/sql/#map_values)
    * [map_zip_with](https://spark.apache.org/docs/latest/api/sql/#map_zip_with)
    * [mask](https://spark.apache.org/docs/latest/api/sql/#mask)
    * [max](https://spark.apache.org/docs/latest/api/sql/#max)
    * [max_by](https://spark.apache.org/docs/latest/api/sql/#max_by)
    * [md5](https://spark.apache.org/docs/latest/api/sql/#md5)
    * [mean](https://spark.apache.org/docs/latest/api/sql/#mean)
    * [median](https://spark.apache.org/docs/latest/api/sql/#median)
    * [min](https://spark.apache.org/docs/latest/api/sql/#min)
    * [min_by](https://spark.apache.org/docs/latest/api/sql/#min_by)
    * [minute](https://spark.apache.org/docs/latest/api/sql/#minute)
    * [mod](https://spark.apache.org/docs/latest/api/sql/#mod)
    * [mode](https://spark.apache.org/docs/latest/api/sql/#mode)
    * [monotonically_increasing_id](https://spark.apache.org/docs/latest/api/sql/#monotonically_increasing_id)
    * [month](https://spark.apache.org/docs/latest/api/sql/#month)
    * [monthname](https://spark.apache.org/docs/latest/api/sql/#monthname)
    * [months_between](https://spark.apache.org/docs/latest/api/sql/#months_between)
    * [named_struct](https://spark.apache.org/docs/latest/api/sql/#named_struct)
    * [nanvl](https://spark.apache.org/docs/latest/api/sql/#nanvl)
    * [negative](https://spark.apache.org/docs/latest/api/sql/#negative)
    * [next_day](https://spark.apache.org/docs/latest/api/sql/#next_day)
    * [not](https://spark.apache.org/docs/latest/api/sql/#not)
    * [now](https://spark.apache.org/docs/latest/api/sql/#now)
    * [nth_value](https://spark.apache.org/docs/latest/api/sql/#nth_value)
    * [ntile](https://spark.apache.org/docs/latest/api/sql/#ntile)
    * [nullif](https://spark.apache.org/docs/latest/api/sql/#nullif)
    * [nullifzero](https://spark.apache.org/docs/latest/api/sql/#nullifzero)
    * [nvl](https://spark.apache.org/docs/latest/api/sql/#nvl)
    * [nvl2](https://spark.apache.org/docs/latest/api/sql/#nvl2)
    * [octet_length](https://spark.apache.org/docs/latest/api/sql/#octet_length)
    * [or](https://spark.apache.org/docs/latest/api/sql/#or)
    * [overlay](https://spark.apache.org/docs/latest/api/sql/#overlay)
    * [parse_json](https://spark.apache.org/docs/latest/api/sql/#parse_json)
    * [parse_url](https://spark.apache.org/docs/latest/api/sql/#parse_url)
    * [percent_rank](https://spark.apache.org/docs/latest/api/sql/#percent_rank)
    * [percentile](https://spark.apache.org/docs/latest/api/sql/#percentile)
    * [percentile_approx](https://spark.apache.org/docs/latest/api/sql/#percentile_approx)
    * [percentile_cont](https://spark.apache.org/docs/latest/api/sql/#percentile_cont)
    * [percentile_disc](https://spark.apache.org/docs/latest/api/sql/#percentile_disc)
    * [pi](https://spark.apache.org/docs/latest/api/sql/#pi)
    * [pmod](https://spark.apache.org/docs/latest/api/sql/#pmod)
    * [posexplode](https://spark.apache.org/docs/latest/api/sql/#posexplode)
    * [posexplode_outer](https://spark.apache.org/docs/latest/api/sql/#posexplode_outer)
    * [position](https://spark.apache.org/docs/latest/api/sql/#position)
    * [positive](https://spark.apache.org/docs/latest/api/sql/#positive)
    * [pow](https://spark.apache.org/docs/latest/api/sql/#pow)
    * [power](https://spark.apache.org/docs/latest/api/sql/#power)
    * [printf](https://spark.apache.org/docs/latest/api/sql/#printf)
    * [python_worker_logs](https://spark.apache.org/docs/latest/api/sql/#python_worker_logs)
    * [quarter](https://spark.apache.org/docs/latest/api/sql/#quarter)
    * [quote](https://spark.apache.org/docs/latest/api/sql/#quote)
    * [radians](https://spark.apache.org/docs/latest/api/sql/#radians)
    * [raise_error](https://spark.apache.org/docs/latest/api/sql/#raise_error)
    * [rand](https://spark.apache.org/docs/latest/api/sql/#rand)
    * [randn](https://spark.apache.org/docs/latest/api/sql/#randn)
    * [random](https://spark.apache.org/docs/latest/api/sql/#random)
    * [randstr](https://spark.apache.org/docs/latest/api/sql/#randstr)
    * [range](https://spark.apache.org/docs/latest/api/sql/#range)
    * [rank](https://spark.apache.org/docs/latest/api/sql/#rank)
    * [reduce](https://spark.apache.org/docs/latest/api/sql/#reduce)
    * [reflect](https://spark.apache.org/docs/latest/api/sql/#reflect)
    * [regexp](https://spark.apache.org/docs/latest/api/sql/#regexp)
    * [regexp_count](https://spark.apache.org/docs/latest/api/sql/#regexp_count)
    * [regexp_extract](https://spark.apache.org/docs/latest/api/sql/#regexp_extract)
    * [regexp_extract_all](https://spark.apache.org/docs/latest/api/sql/#regexp_extract_all)
    * [regexp_instr](https://spark.apache.org/docs/latest/api/sql/#regexp_instr)
    * [regexp_like](https://spark.apache.org/docs/latest/api/sql/#regexp_like)
    * [regexp_replace](https://spark.apache.org/docs/latest/api/sql/#regexp_replace)
    * [regexp_substr](https://spark.apache.org/docs/latest/api/sql/#regexp_substr)
    * [regr_avgx](https://spark.apache.org/docs/latest/api/sql/#regr_avgx)
    * [regr_avgy](https://spark.apache.org/docs/latest/api/sql/#regr_avgy)
    * [regr_count](https://spark.apache.org/docs/latest/api/sql/#regr_count)
    * [regr_intercept](https://spark.apache.org/docs/latest/api/sql/#regr_intercept)
    * [regr_r2](https://spark.apache.org/docs/latest/api/sql/#regr_r2)
    * [regr_slope](https://spark.apache.org/docs/latest/api/sql/#regr_slope)
    * [regr_sxx](https://spark.apache.org/docs/latest/api/sql/#regr_sxx)
    * [regr_sxy](https://spark.apache.org/docs/latest/api/sql/#regr_sxy)
    * [regr_syy](https://spark.apache.org/docs/latest/api/sql/#regr_syy)
    * [repeat](https://spark.apache.org/docs/latest/api/sql/#repeat)
    * [replace](https://spark.apache.org/docs/latest/api/sql/#replace)
    * [reverse](https://spark.apache.org/docs/latest/api/sql/#reverse)
    * [right](https://spark.apache.org/docs/latest/api/sql/#right)
    * [rint](https://spark.apache.org/docs/latest/api/sql/#rint)
    * [rlike](https://spark.apache.org/docs/latest/api/sql/#rlike)
    * [round](https://spark.apache.org/docs/latest/api/sql/#round)
    * [row_number](https://spark.apache.org/docs/latest/api/sql/#row_number)
    * [rpad](https://spark.apache.org/docs/latest/api/sql/#rpad)
    * [rtrim](https://spark.apache.org/docs/latest/api/sql/#rtrim)
    * [schema_of_avro](https://spark.apache.org/docs/latest/api/sql/#schema_of_avro)
    * [schema_of_csv](https://spark.apache.org/docs/latest/api/sql/#schema_of_csv)
    * [schema_of_json](https://spark.apache.org/docs/latest/api/sql/#schema_of_json)
    * [schema_of_variant](https://spark.apache.org/docs/latest/api/sql/#schema_of_variant)
    * [schema_of_variant_agg](https://spark.apache.org/docs/latest/api/sql/#schema_of_variant_agg)
    * [schema_of_xml](https://spark.apache.org/docs/latest/api/sql/#schema_of_xml)
    * [sec](https://spark.apache.org/docs/latest/api/sql/#sec)
    * [second](https://spark.apache.org/docs/latest/api/sql/#second)
    * [sentences](https://spark.apache.org/docs/latest/api/sql/#sentences)
    * [sequence](https://spark.apache.org/docs/latest/api/sql/#sequence)
    * [session_user](https://spark.apache.org/docs/latest/api/sql/#session_user)
    * [session_window](https://spark.apache.org/docs/latest/api/sql/#session_window)
    * [sha](https://spark.apache.org/docs/latest/api/sql/#sha)
    * [sha1](https://spark.apache.org/docs/latest/api/sql/#sha1)
    * [sha2](https://spark.apache.org/docs/latest/api/sql/#sha2)
    * [shiftleft](https://spark.apache.org/docs/latest/api/sql/#shiftleft)
    * [shiftright](https://spark.apache.org/docs/latest/api/sql/#shiftright)
    * [shiftrightunsigned](https://spark.apache.org/docs/latest/api/sql/#shiftrightunsigned)
    * [shuffle](https://spark.apache.org/docs/latest/api/sql/#shuffle)
    * [sign](https://spark.apache.org/docs/latest/api/sql/#sign)
    * [signum](https://spark.apache.org/docs/latest/api/sql/#signum)
    * [sin](https://spark.apache.org/docs/latest/api/sql/#sin)
    * [sinh](https://spark.apache.org/docs/latest/api/sql/#sinh)
    * [size](https://spark.apache.org/docs/latest/api/sql/#size)
    * [skewness](https://spark.apache.org/docs/latest/api/sql/#skewness)
    * [slice](https://spark.apache.org/docs/latest/api/sql/#slice)
    * [smallint](https://spark.apache.org/docs/latest/api/sql/#smallint)
    * [some](https://spark.apache.org/docs/latest/api/sql/#some)
    * [sort_array](https://spark.apache.org/docs/latest/api/sql/#sort_array)
    * [soundex](https://spark.apache.org/docs/latest/api/sql/#soundex)
    * [space](https://spark.apache.org/docs/latest/api/sql/#space)
    * [spark_partition_id](https://spark.apache.org/docs/latest/api/sql/#spark_partition_id)
    * [split](https://spark.apache.org/docs/latest/api/sql/#split)
    * [split_part](https://spark.apache.org/docs/latest/api/sql/#split_part)
    * [sql_keywords](https://spark.apache.org/docs/latest/api/sql/#sql_keywords)
    * [sqrt](https://spark.apache.org/docs/latest/api/sql/#sqrt)
    * [st_asbinary](https://spark.apache.org/docs/latest/api/sql/#st_asbinary)
    * [st_geogfromwkb](https://spark.apache.org/docs/latest/api/sql/#st_geogfromwkb)
    * [st_geomfromwkb](https://spark.apache.org/docs/latest/api/sql/#st_geomfromwkb)
    * [st_setsrid](https://spark.apache.org/docs/latest/api/sql/#st_setsrid)
    * [st_srid](https://spark.apache.org/docs/latest/api/sql/#st_srid)
    * [stack](https://spark.apache.org/docs/latest/api/sql/#stack)
    * [startswith](https://spark.apache.org/docs/latest/api/sql/#startswith)
    * [std](https://spark.apache.org/docs/latest/api/sql/#std)
    * [stddev](https://spark.apache.org/docs/latest/api/sql/#stddev)
    * [stddev_pop](https://spark.apache.org/docs/latest/api/sql/#stddev_pop)
    * [stddev_samp](https://spark.apache.org/docs/latest/api/sql/#stddev_samp)
    * [str_to_map](https://spark.apache.org/docs/latest/api/sql/#str_to_map)
    * [string](https://spark.apache.org/docs/latest/api/sql/#string)
    * [string_agg](https://spark.apache.org/docs/latest/api/sql/#string_agg)
    * [struct](https://spark.apache.org/docs/latest/api/sql/#struct)
    * [substr](https://spark.apache.org/docs/latest/api/sql/#substr)
    * [substring](https://spark.apache.org/docs/latest/api/sql/#substring)
    * [substring_index](https://spark.apache.org/docs/latest/api/sql/#substring_index)
    * [sum](https://spark.apache.org/docs/latest/api/sql/#sum)
    * [tan](https://spark.apache.org/docs/latest/api/sql/#tan)
    * [tanh](https://spark.apache.org/docs/latest/api/sql/#tanh)
    * [theta_difference](https://spark.apache.org/docs/latest/api/sql/#theta_difference)
    * [theta_intersection](https://spark.apache.org/docs/latest/api/sql/#theta_intersection)
    * [theta_intersection_agg](https://spark.apache.org/docs/latest/api/sql/#theta_intersection_agg)
    * [theta_sketch_agg](https://spark.apache.org/docs/latest/api/sql/#theta_sketch_agg)
    * [theta_sketch_estimate](https://spark.apache.org/docs/latest/api/sql/#theta_sketch_estimate)
    * [theta_union](https://spark.apache.org/docs/latest/api/sql/#theta_union)
    * [theta_union_agg](https://spark.apache.org/docs/latest/api/sql/#theta_union_agg)
    * [time](https://spark.apache.org/docs/latest/api/sql/#time)
    * [time_diff](https://spark.apache.org/docs/latest/api/sql/#time_diff)
    * [time_trunc](https://spark.apache.org/docs/latest/api/sql/#time_trunc)
    * [timestamp](https://spark.apache.org/docs/latest/api/sql/#timestamp)
    * [timestamp_micros](https://spark.apache.org/docs/latest/api/sql/#timestamp_micros)
    * [timestamp_millis](https://spark.apache.org/docs/latest/api/sql/#timestamp_millis)
    * [timestamp_seconds](https://spark.apache.org/docs/latest/api/sql/#timestamp_seconds)
    * [tinyint](https://spark.apache.org/docs/latest/api/sql/#tinyint)
    * [to_avro](https://spark.apache.org/docs/latest/api/sql/#to_avro)
    * [to_binary](https://spark.apache.org/docs/latest/api/sql/#to_binary)
    * [to_char](https://spark.apache.org/docs/latest/api/sql/#to_char)
    * [to_csv](https://spark.apache.org/docs/latest/api/sql/#to_csv)
    * [to_date](https://spark.apache.org/docs/latest/api/sql/#to_date)
    * [to_json](https://spark.apache.org/docs/latest/api/sql/#to_json)
    * [to_number](https://spark.apache.org/docs/latest/api/sql/#to_number)
    * [to_protobuf](https://spark.apache.org/docs/latest/api/sql/#to_protobuf)
    * [to_time](https://spark.apache.org/docs/latest/api/sql/#to_time)
    * [to_timestamp](https://spark.apache.org/docs/latest/api/sql/#to_timestamp)
    * [to_timestamp_ltz](https://spark.apache.org/docs/latest/api/sql/#to_timestamp_ltz)
    * [to_timestamp_ntz](https://spark.apache.org/docs/latest/api/sql/#to_timestamp_ntz)
    * [to_unix_timestamp](https://spark.apache.org/docs/latest/api/sql/#to_unix_timestamp)
    * [to_utc_timestamp](https://spark.apache.org/docs/latest/api/sql/#to_utc_timestamp)
    * [to_varchar](https://spark.apache.org/docs/latest/api/sql/#to_varchar)
    * [to_variant_object](https://spark.apache.org/docs/latest/api/sql/#to_variant_object)
    * [to_xml](https://spark.apache.org/docs/latest/api/sql/#to_xml)
    * [transform](https://spark.apache.org/docs/latest/api/sql/#transform)
    * [transform_keys](https://spark.apache.org/docs/latest/api/sql/#transform_keys)
    * [transform_values](https://spark.apache.org/docs/latest/api/sql/#transform_values)
    * [translate](https://spark.apache.org/docs/latest/api/sql/#translate)
    * [trim](https://spark.apache.org/docs/latest/api/sql/#trim)
    * [trunc](https://spark.apache.org/docs/latest/api/sql/#trunc)
    * [try_add](https://spark.apache.org/docs/latest/api/sql/#try_add)
    * [try_aes_decrypt](https://spark.apache.org/docs/latest/api/sql/#try_aes_decrypt)
    * [try_avg](https://spark.apache.org/docs/latest/api/sql/#try_avg)
    * [try_divide](https://spark.apache.org/docs/latest/api/sql/#try_divide)
    * [try_element_at](https://spark.apache.org/docs/latest/api/sql/#try_element_at)
    * [try_make_interval](https://spark.apache.org/docs/latest/api/sql/#try_make_interval)
    * [try_make_timestamp](https://spark.apache.org/docs/latest/api/sql/#try_make_timestamp)
    * [try_make_timestamp_ltz](https://spark.apache.org/docs/latest/api/sql/#try_make_timestamp_ltz)
    * [try_make_timestamp_ntz](https://spark.apache.org/docs/latest/api/sql/#try_make_timestamp_ntz)
    * [try_mod](https://spark.apache.org/docs/latest/api/sql/#try_mod)
    * [try_multiply](https://spark.apache.org/docs/latest/api/sql/#try_multiply)
    * [try_parse_json](https://spark.apache.org/docs/latest/api/sql/#try_parse_json)
    * [try_parse_url](https://spark.apache.org/docs/latest/api/sql/#try_parse_url)
    * [try_reflect](https://spark.apache.org/docs/latest/api/sql/#try_reflect)
    * [try_subtract](https://spark.apache.org/docs/latest/api/sql/#try_subtract)
    * [try_sum](https://spark.apache.org/docs/latest/api/sql/#try_sum)
    * [try_to_binary](https://spark.apache.org/docs/latest/api/sql/#try_to_binary)
    * [try_to_date](https://spark.apache.org/docs/latest/api/sql/#try_to_date)
    * [try_to_number](https://spark.apache.org/docs/latest/api/sql/#try_to_number)
    * [try_to_time](https://spark.apache.org/docs/latest/api/sql/#try_to_time)
    * [try_to_timestamp](https://spark.apache.org/docs/latest/api/sql/#try_to_timestamp)
    * [try_url_decode](https://spark.apache.org/docs/latest/api/sql/#try_url_decode)
    * [try_validate_utf8](https://spark.apache.org/docs/latest/api/sql/#try_validate_utf8)
    * [try_variant_get](https://spark.apache.org/docs/latest/api/sql/#try_variant_get)
    * [typeof](https://spark.apache.org/docs/latest/api/sql/#typeof)
    * [ucase](https://spark.apache.org/docs/latest/api/sql/#ucase)
    * [unbase64](https://spark.apache.org/docs/latest/api/sql/#unbase64)
    * [unhex](https://spark.apache.org/docs/latest/api/sql/#unhex)
    * [uniform](https://spark.apache.org/docs/latest/api/sql/#uniform)
    * [unix_date](https://spark.apache.org/docs/latest/api/sql/#unix_date)
    * [unix_micros](https://spark.apache.org/docs/latest/api/sql/#unix_micros)
    * [unix_millis](https://spark.apache.org/docs/latest/api/sql/#unix_millis)
    * [unix_seconds](https://spark.apache.org/docs/latest/api/sql/#unix_seconds)
    * [unix_timestamp](https://spark.apache.org/docs/latest/api/sql/#unix_timestamp)
    * [upper](https://spark.apache.org/docs/latest/api/sql/#upper)
    * [url_decode](https://spark.apache.org/docs/latest/api/sql/#url_decode)
    * [url_encode](https://spark.apache.org/docs/latest/api/sql/#url_encode)
    * [user](https://spark.apache.org/docs/latest/api/sql/#user)
    * [uuid](https://spark.apache.org/docs/latest/api/sql/#uuid)
    * [validate_utf8](https://spark.apache.org/docs/latest/api/sql/#validate_utf8)
    * [var_pop](https://spark.apache.org/docs/latest/api/sql/#var_pop)
    * [var_samp](https://spark.apache.org/docs/latest/api/sql/#var_samp)
    * [variance](https://spark.apache.org/docs/latest/api/sql/#variance)
    * [variant_explode](https://spark.apache.org/docs/latest/api/sql/#variant_explode)
    * [variant_explode_outer](https://spark.apache.org/docs/latest/api/sql/#variant_explode_outer)
    * [variant_get](https://spark.apache.org/docs/latest/api/sql/#variant_get)
    * [version](https://spark.apache.org/docs/latest/api/sql/#version)
    * [weekday](https://spark.apache.org/docs/latest/api/sql/#weekday)
    * [weekofyear](https://spark.apache.org/docs/latest/api/sql/#weekofyear)
    * [when](https://spark.apache.org/docs/latest/api/sql/#when)
    * [width_bucket](https://spark.apache.org/docs/latest/api/sql/#width_bucket)
    * [window](https://spark.apache.org/docs/latest/api/sql/#window)
    * [window_time](https://spark.apache.org/docs/latest/api/sql/#window_time)
    * [xpath](https://spark.apache.org/docs/latest/api/sql/#xpath)
    * [xpath_boolean](https://spark.apache.org/docs/latest/api/sql/#xpath_boolean)
    * [xpath_double](https://spark.apache.org/docs/latest/api/sql/#xpath_double)
    * [xpath_float](https://spark.apache.org/docs/latest/api/sql/#xpath_float)
    * [xpath_int](https://spark.apache.org/docs/latest/api/sql/#xpath_int)
    * [xpath_long](https://spark.apache.org/docs/latest/api/sql/#xpath_long)
    * [xpath_number](https://spark.apache.org/docs/latest/api/sql/#xpath_number)
    * [xpath_short](https://spark.apache.org/docs/latest/api/sql/#xpath_short)
    * [xpath_string](https://spark.apache.org/docs/latest/api/sql/#xpath_string)
    * [xxhash64](https://spark.apache.org/docs/latest/api/sql/#xxhash64)
    * [year](https://spark.apache.org/docs/latest/api/sql/#year)
    * [zeroifnull](https://spark.apache.org/docs/latest/api/sql/#zeroifnull)
    * [zip_with](https://spark.apache.org/docs/latest/api/sql/#zip_with)
    * [|](https://spark.apache.org/docs/latest/api/sql/#_20)
    * [||](https://spark.apache.org/docs/latest/api/sql/#_21)
    * [~](https://spark.apache.org/docs/latest/api/sql/#_22)
...
* * *
# [Built-in Functions](https://spark.apache.org/docs/latest/api/sql/#built-in-functions)
### [!](https://spark.apache.org/docs/latest/api/sql/#_1)
! expr - Logical not.
**Examples:**
...
**Arguments:**
  ...
  * format - Time format pattern to follow. See [Datetime Patterns](https://spark.apache.org/docs/latest/sql-ref-datetime-pattern.html) for valid time format patterns.
