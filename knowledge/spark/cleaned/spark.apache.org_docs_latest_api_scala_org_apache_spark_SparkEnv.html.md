...
[c](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv$.html "See companion object")
...
#  [SparkEnv](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv$.html "See companion object")[ __](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html "Permalink")
###
Companion [object SparkEnv](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv$.html "See companion object")
...
Source
    [SparkEnv.scala](https://github.com/apache/spark/tree/v4.1.2/core/src/main/scala/org/apache/spark/SparkEnv.scala)
Linear Supertypes
Logging, AnyRef, Any
__ __
Ordering
...
### Instance Constructors
  1. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#<init>\(executorId:String,rpcEnv:org.apache.spark.rpc.RpcEnv,serializer:org.apache.spark.serializer.Serializer,closureSerializer:org.apache.spark.serializer.Serializer,serializerManager:org.apache.spark.serializer.SerializerManager,mapOutputTracker:org.apache.spark.MapOutputTracker,broadcastManager:org.apache.spark.broadcast.BroadcastManager,blockManager:org.apache.spark.storage.BlockManager,securityManager:org.apache.spark.SecurityManager,metricsSystem:org.apache.spark.metrics.MetricsSystem,outputCommitCoordinator:org.apache.spark.scheduler.OutputCommitCoordinator,conf:org.apache.spark.SparkConf\):org.apache.spark.SparkEnv "Permalink") new SparkEnv(executorId: String, rpcEnv: RpcEnv, serializer: [Serializer](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/serializer/Serializer.html "org.apache.spark.serializer.Serializer"), closureSerializer: [Serializer](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/serializer/Serializer.html "org.apache.spark.serializer.Serializer"), serializerManager: SerializerManager, mapOutputTracker: MapOutputTracker, broadcastManager: BroadcastManager, blockManager: BlockManager, securityManager: SecurityManager, metricsSystem: MetricsSystem, outputCommitCoordinator: OutputCommitCoordinator, conf: [SparkConf](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkConf.html "org.apache.spark.SparkConf"))

### Type Members
  1. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#LogStringContextextendsAnyRef "Permalink") implicit  class LogStringContext extends AnyRef

Definition Classes
    Logging

### Value Members
  1. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#!=\(x$1:Any\):Boolean "Permalink") final  def !=(arg0: Any): Boolean

Definition Classes
    AnyRef → Any
  2. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html###:Int "Permalink") final  def ##: Int

Definition Classes
    AnyRef → Any
  3. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#==\(x$1:Any\):Boolean "Permalink") final  def ==(arg0: Any): Boolean

Definition Classes
    AnyRef → Any
  4. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#MDC\(key:org.apache.spark.internal.LogKey,value:Any\):org.apache.spark.internal.MDC "Permalink") def MDC(key: LogKey, value: Any): MDC
...
Definition Classes
    Logging
  5. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#asInstanceOf\[T0\]:T0 "Permalink") final  def asInstanceOf[T0]: T0

Definition Classes
    Any
  6. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#blockManager:org.apache.spark.storage.BlockManager "Permalink") val blockManager: BlockManager
  7. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#broadcastManager:org.apache.spark.broadcast.BroadcastManager "Permalink") val broadcastManager: BroadcastManager
  8. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#clone\(\):Object "Permalink") def clone(): AnyRef
...
Annotations
  ...
  9. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#closureSerializer:org.apache.spark.serializer.Serializer "Permalink") val closureSerializer: [Serializer](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/serializer/Serializer.html "org.apache.spark.serializer.Serializer")
  10. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#conf:org.apache.spark.SparkConf "Permalink") val conf: [SparkConf](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkConf.html "org.apache.spark.SparkConf")
  11. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#eq\(x$1:AnyRef\):Boolean "Permalink") final  def eq(arg0: AnyRef): Boolean

Definition Classes
    AnyRef
  12. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#equals\(x$1:Object\):Boolean "Permalink") def equals(arg0: AnyRef): Boolean

Definition Classes
    AnyRef → Any
  13. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#executorId:String "Permalink") val executorId: String
  14. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#getClass\(\):Class\[_\] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Class.html#java.lang.Class "java.lang.Class")[_ <: AnyRef]
...
Annotations
  ...
  15. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#hashCode\(\):Int "Permalink") def hashCode(): Int
...
Annotations
     @IntrinsicCandidate() @native()
  16. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#initializeLogIfNecessary\(isInterpreter:Boolean,silent:Boolean\):Boolean "Permalink") def initializeLogIfNecessary(isInterpreter: Boolean, silent: Boolean): Boolean
...
Definition Classes
    Logging
  17. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#initializeLogIfNecessary\(isInterpreter:Boolean\):Unit "Permalink") def initializeLogIfNecessary(isInterpreter: Boolean): Unit
...
Definition Classes
    Logging
  18. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#isInstanceOf\[T0\]:Boolean "Permalink") final  def isInstanceOf[T0]: Boolean

Definition Classes
    Any
  19. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#isTraceEnabled\(\):Boolean "Permalink") def isTraceEnabled(): Boolean
...
Definition Classes
    Logging
  20. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#log:org.slf4j.Logger "Permalink") def log: Logger
...
Definition Classes
    Logging
  21. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logBasedOnLevel\(level:org.slf4j.event.Level\)\(f:=>org.apache.spark.internal.MessageWithContext\):Unit "Permalink") def logBasedOnLevel(level: Level)(f: => MessageWithContext): Unit
...
Definition Classes
    Logging
  22. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logDebug\(msg:=>String,throwable:Throwable\):Unit "Permalink") def logDebug(msg: => String, throwable: Throwable): Unit
...
Definition Classes
    Logging
  23. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logDebug\(entry:org.apache.spark.internal.LogEntry,throwable:Throwable\):Unit "Permalink") def logDebug(entry: LogEntry, throwable: Throwable): Unit
...
Definition Classes
    Logging
  24. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logDebug\(entry:org.apache.spark.internal.LogEntry\):Unit "Permalink") def logDebug(entry: LogEntry): Unit
...
Definition Classes
    Logging
  25. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logDebug\(msg:=>String\):Unit "Permalink") def logDebug(msg: => String): Unit
...
Definition Classes
    Logging
  26. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logError\(msg:=>String,throwable:Throwable\):Unit "Permalink") def logError(msg: => String, throwable: Throwable): Unit
...
Definition Classes
    Logging
  27. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logError\(entry:org.apache.spark.internal.LogEntry,throwable:Throwable\):Unit "Permalink") def logError(entry: LogEntry, throwable: Throwable): Unit
...
Definition Classes
    Logging
  28. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logError\(entry:org.apache.spark.internal.LogEntry\):Unit "Permalink") def logError(entry: LogEntry): Unit
...
Definition Classes
    Logging
  29. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logError\(msg:=>String\):Unit "Permalink") def logError(msg: => String): Unit
...
Definition Classes
    Logging
  30. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logInfo\(msg:=>String,throwable:Throwable\):Unit "Permalink") def logInfo(msg: => String, throwable: Throwable): Unit
...
Definition Classes
    Logging
  31. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logInfo\(entry:org.apache.spark.internal.LogEntry,throwable:Throwable\):Unit "Permalink") def logInfo(entry: LogEntry, throwable: Throwable): Unit
...
Definition Classes
    Logging
  32. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logInfo\(entry:org.apache.spark.internal.LogEntry\):Unit "Permalink") def logInfo(entry: LogEntry): Unit
...
Definition Classes
    Logging
  33. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logInfo\(msg:=>String\):Unit "Permalink") def logInfo(msg: => String): Unit
...
Definition Classes
    Logging
  34. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logName:String "Permalink") def logName: [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html#java.lang.String "java.lang.String")
...
Definition Classes
    Logging
  35. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logTrace\(msg:=>String,throwable:Throwable\):Unit "Permalink") def logTrace(msg: => String, throwable: Throwable): Unit
...
Definition Classes
    Logging
  36. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logTrace\(entry:org.apache.spark.internal.LogEntry,throwable:Throwable\):Unit "Permalink") def logTrace(entry: LogEntry, throwable: Throwable): Unit
...
Definition Classes
    Logging
  37. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logTrace\(entry:org.apache.spark.internal.LogEntry\):Unit "Permalink") def logTrace(entry: LogEntry): Unit
...
Definition Classes
    Logging
  38. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logTrace\(msg:=>String\):Unit "Permalink") def logTrace(msg: => String): Unit
...
Definition Classes
    Logging
  39. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logWarning\(msg:=>String,throwable:Throwable\):Unit "Permalink") def logWarning(msg: => String, throwable: Throwable): Unit
...
Definition Classes
    Logging
  40. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logWarning\(entry:org.apache.spark.internal.LogEntry,throwable:Throwable\):Unit "Permalink") def logWarning(entry: LogEntry, throwable: Throwable): Unit
...
Definition Classes
    Logging
  41. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logWarning\(entry:org.apache.spark.internal.LogEntry\):Unit "Permalink") def logWarning(entry: LogEntry): Unit
...
Definition Classes
    Logging
  42. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logWarning\(msg:=>String\):Unit "Permalink") def logWarning(msg: => String): Unit
...
Definition Classes
    Logging
  43. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#mapOutputTracker:org.apache.spark.MapOutputTracker "Permalink") val mapOutputTracker: MapOutputTracker
  44. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#memoryManager:org.apache.spark.memory.MemoryManager "Permalink") def memoryManager: MemoryManager
  45. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#metricsSystem:org.apache.spark.metrics.MetricsSystem "Permalink") val metricsSystem: MetricsSystem
  46. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#ne\(x$1:AnyRef\):Boolean "Permalink") final  def ne(arg0: AnyRef): Boolean

Definition Classes
    AnyRef
  47. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#notify\(\):Unit "Permalink") final  def notify(): Unit
...
Annotations
     @IntrinsicCandidate() @native()
  48. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#notifyAll\(\):Unit "Permalink") final  def notifyAll(): Unit
...
Annotations
     @IntrinsicCandidate() @native()
  49. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#outputCommitCoordinator:org.apache.spark.scheduler.OutputCommitCoordinator "Permalink") val outputCommitCoordinator: OutputCommitCoordinator
  50. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#securityManager:org.apache.spark.SecurityManager "Permalink") val securityManager: SecurityManager
  51. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#serializer:org.apache.spark.serializer.Serializer "Permalink") val serializer: [Serializer](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/serializer/Serializer.html "org.apache.spark.serializer.Serializer")
  52. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#serializerManager:org.apache.spark.serializer.SerializerManager "Permalink") val serializerManager: SerializerManager
  53. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#shuffleManager:org.apache.spark.shuffle.ShuffleManager "Permalink") def shuffleManager: ShuffleManager
  54. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#synchronized\[T0\]\(x$1:=>T0\):T0 "Permalink") final  def synchronized[T0](arg0: => T0): T0

Definition Classes
    AnyRef
  55. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#toString\(\):String "Permalink") def toString(): [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html#java.lang.String "java.lang.String")

Definition Classes
    AnyRef → Any
  56. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#wait\(x$1:Long,x$2:Int\):Unit "Permalink") final  def wait(arg0: Long, arg1: Int): Unit
...
Annotations
  ...
  57. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#wait\(x$1:Long\):Unit "Permalink") final  def wait(arg0: Long): Unit
...
Annotations
  ...
  58. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#wait\(\):Unit "Permalink") final  def wait(): Unit
...
### Deprecated Value Members
  1. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#finalize\(\):Unit "Permalink") def finalize(): Unit
...
### Value Members
  1. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#MDC\(key:org.apache.spark.internal.LogKey,value:Any\):org.apache.spark.internal.MDC "Permalink") def MDC(key: LogKey, value: Any): MDC
...
Definition Classes
    Logging
  2. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#initializeLogIfNecessary\(isInterpreter:Boolean,silent:Boolean\):Boolean "Permalink") def initializeLogIfNecessary(isInterpreter: Boolean, silent: Boolean): Boolean
...
Definition Classes
    Logging
  3. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#initializeLogIfNecessary\(isInterpreter:Boolean\):Unit "Permalink") def initializeLogIfNecessary(isInterpreter: Boolean): Unit
...
Definition Classes
    Logging
  4. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#isTraceEnabled\(\):Boolean "Permalink") def isTraceEnabled(): Boolean
...
Definition Classes
    Logging
  5. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#log:org.slf4j.Logger "Permalink") def log: Logger
...
Definition Classes
    Logging
  6. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logBasedOnLevel\(level:org.slf4j.event.Level\)\(f:=>org.apache.spark.internal.MessageWithContext\):Unit "Permalink") def logBasedOnLevel(level: Level)(f: => MessageWithContext): Unit
...
Definition Classes
    Logging
  7. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logDebug\(msg:=>String,throwable:Throwable\):Unit "Permalink") def logDebug(msg: => String, throwable: Throwable): Unit
...
Definition Classes
    Logging
  8. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logDebug\(entry:org.apache.spark.internal.LogEntry,throwable:Throwable\):Unit "Permalink") def logDebug(entry: LogEntry, throwable: Throwable): Unit
...
Definition Classes
    Logging
  9. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logDebug\(entry:org.apache.spark.internal.LogEntry\):Unit "Permalink") def logDebug(entry: LogEntry): Unit
...
Definition Classes
    Logging
  10. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logDebug\(msg:=>String\):Unit "Permalink") def logDebug(msg: => String): Unit
...
Definition Classes
    Logging
  11. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logError\(msg:=>String,throwable:Throwable\):Unit "Permalink") def logError(msg: => String, throwable: Throwable): Unit
...
Definition Classes
    Logging
  12. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logError\(entry:org.apache.spark.internal.LogEntry,throwable:Throwable\):Unit "Permalink") def logError(entry: LogEntry, throwable: Throwable): Unit
...
Definition Classes
    Logging
  13. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logError\(entry:org.apache.spark.internal.LogEntry\):Unit "Permalink") def logError(entry: LogEntry): Unit
...
Definition Classes
    Logging
  14. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logError\(msg:=>String\):Unit "Permalink") def logError(msg: => String): Unit
...
Definition Classes
    Logging
  15. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logInfo\(msg:=>String,throwable:Throwable\):Unit "Permalink") def logInfo(msg: => String, throwable: Throwable): Unit
...
Definition Classes
    Logging
  16. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logInfo\(entry:org.apache.spark.internal.LogEntry,throwable:Throwable\):Unit "Permalink") def logInfo(entry: LogEntry, throwable: Throwable): Unit
...
Definition Classes
    Logging
  17. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logInfo\(entry:org.apache.spark.internal.LogEntry\):Unit "Permalink") def logInfo(entry: LogEntry): Unit
...
Definition Classes
    Logging
  18. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logInfo\(msg:=>String\):Unit "Permalink") def logInfo(msg: => String): Unit
...
Definition Classes
    Logging
  19. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logName:String "Permalink") def logName: [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html#java.lang.String "java.lang.String")
...
Definition Classes
    Logging
  20. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logTrace\(msg:=>String,throwable:Throwable\):Unit "Permalink") def logTrace(msg: => String, throwable: Throwable): Unit
...
Definition Classes
    Logging
  21. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logTrace\(entry:org.apache.spark.internal.LogEntry,throwable:Throwable\):Unit "Permalink") def logTrace(entry: LogEntry, throwable: Throwable): Unit
...
Definition Classes
    Logging
  22. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logTrace\(entry:org.apache.spark.internal.LogEntry\):Unit "Permalink") def logTrace(entry: LogEntry): Unit
...
Definition Classes
    Logging
  23. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logTrace\(msg:=>String\):Unit "Permalink") def logTrace(msg: => String): Unit
...
Definition Classes
    Logging
  24. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logWarning\(msg:=>String,throwable:Throwable\):Unit "Permalink") def logWarning(msg: => String, throwable: Throwable): Unit
...
Definition Classes
    Logging
  25. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logWarning\(entry:org.apache.spark.internal.LogEntry,throwable:Throwable\):Unit "Permalink") def logWarning(entry: LogEntry, throwable: Throwable): Unit
...
Definition Classes
    Logging
  26. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logWarning\(entry:org.apache.spark.internal.LogEntry\):Unit "Permalink") def logWarning(entry: LogEntry): Unit
...
Definition Classes
    Logging
  27. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#logWarning\(msg:=>String\):Unit "Permalink") def logWarning(msg: => String): Unit
...
Definition Classes
    AnyRef → Any
  4. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#clone\(\):Object "Permalink") def clone(): AnyRef
...
Annotations
     @throws(classOf[java.lang.CloneNotSupportedException]) @IntrinsicCandidate() @native()
  5. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#eq\(x$1:AnyRef\):Boolean "Permalink") final  def eq(arg0: AnyRef): Boolean

Definition Classes
    AnyRef
  6. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#equals\(x$1:Object\):Boolean "Permalink") def equals(arg0: AnyRef): Boolean

Definition Classes
    AnyRef → Any
  7. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#getClass\(\):Class\[_\] "Permalink") final  def getClass(): [Class](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Class.html#java.lang.Class "java.lang.Class")[_ <: AnyRef]
...
Annotations
     @IntrinsicCandidate() @native()
  8. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#hashCode\(\):Int "Permalink") def hashCode(): Int
...
Annotations
     @IntrinsicCandidate() @native()
  9. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#ne\(x$1:AnyRef\):Boolean "Permalink") final  def ne(arg0: AnyRef): Boolean

Definition Classes
    AnyRef
  10. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#notify\(\):Unit "Permalink") final  def notify(): Unit
...
Annotations
     @IntrinsicCandidate() @native()
  11. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#notifyAll\(\):Unit "Permalink") final  def notifyAll(): Unit
...
Annotations
     @IntrinsicCandidate() @native()
  12. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#synchronized\[T0\]\(x$1:=>T0\):T0 "Permalink") final  def synchronized[T0](arg0: => T0): T0

Definition Classes
    AnyRef
  13. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#toString\(\):String "Permalink") def toString(): [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html#java.lang.String "java.lang.String")

Definition Classes
    AnyRef → Any
  14. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#wait\(x$1:Long,x$2:Int\):Unit "Permalink") final  def wait(arg0: Long, arg1: Int): Unit
...
Annotations
     @throws(classOf[java.lang.InterruptedException])
  15. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#wait\(x$1:Long\):Unit "Permalink") final  def wait(arg0: Long): Unit
...
Annotations
     @throws(classOf[java.lang.InterruptedException]) @native()
  16. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#wait\(\):Unit "Permalink") final  def wait(): Unit
...
Annotations
     @throws(classOf[java.lang.InterruptedException])
  17. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#finalize\(\):Unit "Permalink") def finalize(): Unit
...
### Inherited from Any
### Value Members
  1. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#asInstanceOf\[T0\]:T0 "Permalink") final  def asInstanceOf[T0]: T0

Definition Classes
    Any
  2. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#isInstanceOf\[T0\]:Boolean "Permalink") final  def isInstanceOf[T0]: Boolean
...
Definition Classes
    Logging
  60. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/SparkEnv.html#finalize\(\):Unit "Permalink") def finalize(): Unit
