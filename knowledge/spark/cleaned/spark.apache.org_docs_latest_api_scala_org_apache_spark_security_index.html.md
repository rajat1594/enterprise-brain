...
Definition Classes
    [spark](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/index.html "org.apache.spark")
  * [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/security/index.html "Permalink") package security

Definition Classes
    [spark](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/index.html "org.apache.spark")
  * [](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/security/GroupMappingServiceProvider.html "This Spark trait is used for mapping a given userName to a set of groups which it belongs to.")[GroupMappingServiceProvider](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/security/GroupMappingServiceProvider.html "This Spark trait is used for mapping a given userName to a set of groups which it belongs to.")
  * [](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/security/HadoopDelegationTokenProvider.html "::DeveloperApi:: Hadoop delegation token provider.")[HadoopDelegationTokenProvider](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/security/HadoopDelegationTokenProvider.html "::DeveloperApi:: Hadoop delegation token provider.")
...
# security[ __](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/security/index.html "Permalink")
####  package security
### Type Members
  1. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/security/GroupMappingServiceProvider.html "Permalink") trait [GroupMappingServiceProvider](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/security/GroupMappingServiceProvider.html "This Spark trait is used for mapping a given userName to a set of groups which it belongs to.") extends AnyRef
...
This Spark trait is used for mapping a given userName to a set of groups which it belongs to. This is useful for specifying a common group of admins/developers to provide them admin, modify and/or view access rights. Based on whether access control checks are enabled using spark.acls.enable, every time a user tries to access or modify the application, the SecurityManager gets the corresponding groups a user belongs to from the instance of the groups mapping provider specified by the entry spark.user.groups.mapping.
  2. [__](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/security/HadoopDelegationTokenProvider.html "Permalink") trait [HadoopDelegationTokenProvider](https://spark.apache.org/docs/latest/api/scala/org/apache/spark/security/HadoopDelegationTokenProvider.html "::DeveloperApi:: Hadoop delegation token provider.") extends AnyRef
