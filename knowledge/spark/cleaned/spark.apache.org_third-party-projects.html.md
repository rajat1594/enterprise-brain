[ ![](https://spark.apache.org/images/spark-logo-rev.svg) ](https://spark.apache.org/)
  ...
  * [ Libraries ](https://spark.apache.org/third-party-projects.html)
  ...
  * [ Documentation ](https://spark.apache.org/third-party-projects.html)
  ...
  * [ Community ](https://spark.apache.org/third-party-projects.html)
  ...
  * [ Developers ](https://spark.apache.org/third-party-projects.html)
  ...
  * [ GitHub ](https://spark.apache.org/third-party-projects.html)
  ...
  * [ Apache Software Foundation ](https://spark.apache.org/third-party-projects.html)
...
## Applications using Spark
  ...
  * [Lightning Catalog](https://github.com/zetaris/lightning-catalog) - A data catalog for running ad-hoc queries, wrangling data by federating enterprise data assets, and building a unified semantic layer with data quality checks.

## Performance, monitoring, and debugging tools for Spark
  * [Data Mechanics Delight](https://www.datamechanics.co/delight) - Delight is a free, hosted, cross-platform Spark UI alternative backed by an open-source Spark agent. It features new metrics and visualizations to simplify Spark monitoring and performance tuning.
  * [DataFlint](https://github.com/dataflint/spark) - DataFlint is A Spark UI replacement installed via an open-source library, which updates in real-time and alerts on performance issues

## Additional language bindings
### C# / .NET
  * [Mobius](https://github.com/Microsoft/Mobius): C# and F# language binding and extensions to Apache Spark

### Clojure
  * [Geni](https://github.com/zero-one-group/geni) - A Clojure dataframe library that runs on Apache Spark with a focus on optimizing the REPL experience.
...
Note that all project and product names should follow [trademark guidelines](https://spark.apache.org/trademarks.html).
##### Latest News
